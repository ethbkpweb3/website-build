...
for (let W = 0, q = H, z = 1, J = 0; W < 24; W++) {
    ...
    for (let e = 0; e < 7; e++)
        q = (q << H ^ (q >> m) * S) % F,
        q & O && (t ^= H << (H << BigInt(e)) - H);
    A.push(t)
}
const [C,N] = f(A, !0)
  , v = (t, e, s) => s > 32 ? c(t, e, s) : u(t, e, s)
  , D = (t, e, s) => s > 32 ? l(t, e, s) : a(t, e, s);
class G extends B {
    ...
    writeInto(t) {
        ...
        for (let e = 0, n = t.length; e < n; ) {
            ...
            t.set(s.subarray(this.posOut, this.posOut + r), e),
            this.posOut += r,
            e += r
        }
        return t
    ...
    _cloneInto(t) {
        const {blockLen: e, suffix: s, outputLen: n, rounds: i, enableXOF: r} = this;
        return t || (t = new G(e,s,n,r,i)),
...
class X extends B {
    constructor(t, e, s, n) {
        ...
        this.view = w(this.buffer)
    }
    update(t) {
        n(this);
        const {view: e, buffer: s, blockLen: i} = this
          , r = (t = y(t)).length;
        for (let n = 0; n < r; ) {
    ...
    digestInto(t) {
        ...
        i(t, this),
        this.finished = !0;
        const {buffer: e, view: s, blockLen: r, isLE: o} = this;
        let {pos: h} = this;
        e[h++] = 128,
        this.buffer.subarray(h).fill(0),
        this.padOffset > r - h && (this.process(s, 0),
        h = 0);
        for (let n = h; n < r; n++)
            e[n] = 0;
        !function(t, e, s, n) {
...
class R extends X {
    ...
    process(t, e) {
        ...
        let {A: s, B: n, C: i, D: r, E: o, F: h, G: f, H: u} = this;
        for (let c = 0; c < 64; c++) {
...
const j = E(( () => new R));
export {B as H, X as S, e as b, L as c, n as e, s as h, T as k, I as r, j as s, y as t, d as u, E as w};
