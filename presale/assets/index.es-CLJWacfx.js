const __vite__mapDeps = (i, m = __vite__mapDeps, d = (m.f || (m.f = ["assets/index-D9byNngK.js", "assets/index-CQfCy4Xm.js", "assets/index-st4cR-qp.css", "assets/index.modern-ChJ35hAh.js"]))) => i.map(i => d[i]);
import {
    dl as t,
    H as e,
    _ as r
        ...
        if (this.rpc = this.getRpcConfig(t), this.chainId = this.rpc.chains.length ? sf(this.rpc.chains) : sf(this.rpc.optionalChains), this.signer = await Hl.init({
            ...
            try {
                const {
                    ...
                    import ("./index-D9byNngK.js").then((t => t.i))), __vite__mapDeps([0, 1, 2, 3]));
                t = e
            } catch {
