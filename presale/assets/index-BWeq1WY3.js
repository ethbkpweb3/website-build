import {a as e} from "./index-Dwv4qbXN.js";
import {I as t, z as n, C as o} from "./index-jdACH0Rc.js";
const s = (s, u, a, m) => {
    let l = {
        offsetX: 0,
        offsetY: 0
    ...
    const i = t => {
        const n = t.clientX
          ...
          , Y = t => {
            let i = u + t.clientX - n
              , v = a + t.clientY - o;
            (null == m ? void 0 : m.value) || (i = Math.min(Math.max(i, E), L),
            v = Math.min(Math.max(v, p), X)),
            l = {
                offsetX: i,
                offsetY: v
            },
