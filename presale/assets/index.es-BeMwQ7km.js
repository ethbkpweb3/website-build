const __vite__mapDeps = (i, m = __vite__mapDeps, d = (m.f || (m.f = ["assets/index-Cgdd8ERt.js", "assets/index-CQfCy4Xm.js", "assets/index-st4cR-qp.css", "assets/index.modern-ChJ35hAh.js"]))) => i.map(i => d[i]);
import {
    dl as e,
    _ as t
        ...
        if (this.rpc = this.getRpcConfig(e), this.chainId = this.rpc.chains.length ? ea(this.rpc.chains) : ea(this.rpc.optionalChains), this.signer = await Lo.init({
            ...
            try {
                const {
                    ...
                    import ("./index-Cgdd8ERt.js").then((e => e.i))), __vite__mapDeps([0, 1, 2, 3]));
                e = r
            } catch {
