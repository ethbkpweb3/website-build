...
function D(e, t, r) {
    ...
    switch (t) {
        ...
        case "[object String]":
            return new c(e);
        case "[object RegExp]":
            return (o = new(n = e).constructor(n.source, h.exec(n))).lastIndex = n.lastIndex, o;
        case "[object Symbol]":
            return a = e, M ? Object(M.call(a)) : {}
    }
}
var E = o && o.isMap,
    B = E ? c(E) : function(e) {
...
function R(r, a, o, c, u, j) {
    var f, d = 1 & a,
        m = 2 & a,
        g = 4 & a;
    if (o && (f = u ? o(r, c, u, j) : o(r)), void 0 !== f) return f;
    if (!y(r)) return r;
    var h = l(r);
    if (h) {
        if (f = function(e) {
                ...
                return t && "string" == typeof e[0] && U.call(e, "index") && (r.index = e.index, r.input = e.input), r
            }(r), !d) return w(r, f)
    } else {
        var F = n(r),
        ...
        if (s(r)) return x(r, d);
        if (F == k || F == N || M && !u) {
            if (f = m || M ? {} : O(r), !d) return m ? function(e, t) {
                return A(e, S(e), t)
            }(r, function(e, t) {
                return e && A(t, v(t), e)
            }(f, r)) : function(e, r) {
    ...
    var E = j.get(r);
    if (E) return E;
    j.set(r, f), C(r) ? r.forEach((function(e) {
        f.add(R(e, a, o, e, r, j))
    ...
    return function(e, t) {
        ...
        G && (e = r[t = e]), p(f, t, R(e, a, o, t, r, j))
    })), f
}
L[N] = L["[object Array]"] = L["[object ArrayBuffer]"] = L["[object DataView]"] = L["[object Boolean]"] = L["[object Date]"] = L["[object Float32Array]"] = L["[object Float64Array]"] = L["[object Int8Array]"] = L["[object Int16Array]"] = L["[object Int32Array]"] = L["[object Map]"] = L["[object Number]"] = L[k] = L["[object RegExp]"] = L["[object Set]"] = L["[object String]"] = L["[object Symbol]"] = L["[object Uint8Array]"] = L["[object Uint8ClampedArray]"] = L["[object Uint16Array]"] = L["[object Uint32Array]"] = !0, L["[object Error]"] = L[P] = L["[object WeakMap]"] = !1;
export {
    R as b, I as g
};