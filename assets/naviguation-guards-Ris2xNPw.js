...
const r = e((({
    ...
    e.beforeEach((async (e, r) => {
        ...
        if (r === i && v.isLoggedIn) try {
            ...
            if (v.logoutUser(), m.error("Please Login"), (null == (d = window.location) ? void 0 : d.mobile) && e.fullPath.toLowerCase().includes("user-center")) window.ReactNativeWebView.postMessage(JSON.stringify({
                opzkey: "checkLogin"
            }));
            else if (e.meta.requiresAuth) return {
                name: "auth",
                query: {
                    redirect: e.fullPath
                }
            ...
            if (m.error("Please Login"), "undefined" == typeof window || !(null == (f = window.location) ? void 0 : f.mobile) || !e.fullPath.toLowerCase().includes("user-center")) return {
                name: "auth",
                query: {
                    redirect: e.fullPath
                }
