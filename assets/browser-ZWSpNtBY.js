...
I.prototype.initialize = function(t) {
    this.degree = t,
    this.genPoly = B.generateECPolynomial(this.degree)
}
,
...
F.getEncodedBits = function(t, e) {
    const n = t.bit << 3 | e;
    let r = n << 10;
    for (; z.getBCHDigit(r) - D >= 0; )
        r ^= 1335 << z.getBCHDigit(r) - D;
    return 21522 ^ (n << 10 | r)
}
;
var H = {};
...
var tt, et = G, nt = {
    ...
    single_source_shortest_paths: function(t, e, n) {
        ...
        for (h.push(e, 0); !h.empty(); )
            ...
            u = i.cost,
            c = t[s] || {})
                c.hasOwnProperty(a) && (l = u + c[a],
                f = o[a],
                (void 0 === o[a] || f > l) && (o[a] = l,
                h.push(a, l),
                r[a] = s));
...
!function(t) {
    ...
    function h(t) {
        ...
        let o, i;
        u.isKanjiModeEnabled() ? (o = f(a.BYTE, e.BYTE, t),
        i = f(a.KANJI, e.KANJI, t)) : (o = f(a.BYTE_KANJI, e.BYTE, t),
        i = []);
    ...
    function d(t, n) {
        ...
        if (a = e.from(n, c),
        a !== e.BYTE && a.bit < c.bit)
            throw new Error('"' + t + '" cannot be encoded with mode ' + e.toString(a) + ".\n Suggested mode is: " + e.toString(c));
        switch (a !== e.KANJI || u.isKanjiModeEnabled() || (a = e.BYTE),
        a) {
        case e.NUMERIC:
            return new r(t);
        case e.ALPHANUMERIC:
    ...
    t.fromArray = function(t) {
        return t.reduce((function(t, e) {
            return "string" == typeof e ? t.push(d(e, null)) : e.data && t.push(d(e.data, e.mode)),
            t
        }
        ), [])
    }
            ...
            for (let s = 0; s < t.length; s++) {
                ...
                for (let t = 0; t < a.length; t++) {
                    ...
                    for (let t = 0; t < i.length; t++) {
                        const s = i[t];
                        r[s] && r[s].node.mode === c.mode ? (o[s][l] = g(r[s].lastCount + c.length, c.mode) - g(r[s].lastCount, c.mode),
                        r[s].lastCount += c.length) : (r[s] && (r[s].lastCount = c.length),
                        o[s][l] = g(c.length, c.mode) + 4 + e.getCharCountIndicator(c.mode, n))
                    }
                }
                i = u
            }
...
function mt(t, e, n) {
    ...
    for (i = 0; i < 15; i++)
        s = 1 == (o >> i & 1),
        i < 6 ? t.set(i, 8, s, !0) : i < 8 ? t.set(i + 1, 8, s, !0) : t.set(r - 15 + i, 8, s, !0),
...
function Et(t, e, n) {
    ...
    n.forEach((function(e) {
        r.put(e.mode.bit, 4),
        r.put(e.getLength(), pt.getCharCountIndicator(e.mode, t)),
        e.write(r)
    }
    ));
...
function yt(t, e, n, r) {
    ...
    return function(t, e) {
        ...
        for (let o = 0; o < r.length; o++) {
            ...
            for (let r = -1; r <= 7; r++)
                if (!(e + r <= -1 || n <= e + r))
                    for (let o = -1; o <= 7; o++)
                        i + o <= -1 || n <= i + o || (r >= 0 && r <= 6 && (0 === o || 6 === o) || o >= 0 && o <= 6 && (0 === r || 6 === r) || r >= 2 && r <= 4 && o >= 2 && o <= 4 ? t.set(e + r, i + o, !0, !0) : t.set(e + r, i + o, !1, !0))
        }
    }(u, e),
    function(t) {
        const e = t.size;
    ...
    isNaN(r) && (r = lt.getBestMask(u, mt.bind(null, u, n))),
    lt.applyMask(r, u),
    mt(u, n, r),
    {
        modules: u,
...
e.create = function(t, e) {
    ...
    let n, r, o = it.M;
    return void 0 !== e && (o = it.from(e.errorCorrectionLevel, it.M),
    n = gt.from(e.version),
    r = lt.from(e.maskPattern),
    e.toSJISFunc && ot.setToSJISFunction(e.toSJISFunc)),
    yt(t, n, o, r)
}
;
var At = {}
...
Ct.render = function(t, e, n) {
    const r = Bt.getOptions(e)
      ...
      , u = "<path " + It(r.color.dark, "stroke") + ' d="' + function(t, e, n) {
        ...
        for (let a = 0; a < t.length; a++) {
            ...
            u || i || (i = !0),
            t[a] ? (s++,
            a > 0 && u > 0 && t[a - 1] || (r += i ? Mt("M", u + n, .5 + c + n) : Mt("m", o, 0),
            o = 0,
            i = !1),
            u + 1 < e && t[a + 1] || (r += Mt("h", s),
            s = 0)) : o++
        }
        return r
    }(i, o, r.margin) + '"/>'
    ...
    return "function" == typeof n && n(null, l),
    l
}
;
const Tt = function() {
...
function Rt(t, e, n, r, o) {
    ...
    2 === s ? (o = n,
    n = e,
    e = r = void 0) : 3 === s && (e.getContext && void 0 === o ? (o = r,
    r = void 0) : (o = r,
    r = n,
    n = e,
    e = void 0));
...
export {Ut as a, Lt as b, t as c, St as t};
