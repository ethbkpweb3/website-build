...
const h = {
    ...
    m = u(a({
        ...
        setup(a) {
            ...
            return (a, o) => (s(), l("svg", h, [o[0] || (o[0] = e("defs", null, [e("path", {
                id: "a-slant-mask",
    ...
    g = u(a({
        ...
        setup(a) {
            const r = a,
                n = o((() => [r.color && `mask-${r.color}`]));
            return (a, o) => (s(), l("svg", w, [e("g", _, [e("path", {
                id: "XMLID_30_",
                class: t(n.value),
    ...
    I = a({
        ...
        setup(a) {
            ...
            return (a, o) => {
                ...
                }, [h.starfall ? (s(), l("div", y, [(s(), l(n, null, i(40, (a => e("div", {
                    key: a,
                    class: "falling-star"
                }))), 64))])) : c("", !0), "circle" === h.mask ? (s(), l("div", b, [v(g, {
                    color: h.color
                }, null, 8, ["color"])])) : c("", !0), "wave" === h.mask ? (s(), l("div", x, [v(r, {
                    color: h.color
                }, null, 8, ["color"])])) : c("", !0), "slant" === h.mask ? (s(), l("div", M, [v(w, {
                    color: h.color
                }, null, 8, ["color"])])) : c("", !0), h.overlay ? (s(), l("div", $)) : c("", !0), d(a.$slots, "background"), "body" in p(u) ? (s(), l("div", z, [e("div", B, [d(a.$slots, "body")])])) : c("", !0), "footer" in p(u) ? (s(), l("div", H, [d(a.$slots, "footer")])) : c("", !0)], 2)
            }
        }
    });
export {
