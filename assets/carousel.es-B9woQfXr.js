import {m as e, y as t, K as a, L as n, I as i, M as l, N as o, h as r, B as s, O as u, i as c, P as d, Q as v} from "./index-N2rhOp93.js";
/**
...
function h({val: e, max: t, min: a=0}) {
    return e > t ? h({
        val: e - (t + 1),
        max: t,
        min: a
...
var b, x, y = e({
    ...
    name: "Carousel",
    props: p,
    setup(e, {slots: d, emit: v, expose: w}) {
        var b;
        const x = t(null)
          , S = t([])
          , T = t(0)
        ...
        let D, I;
        function L() {
            _ = Object.assign({}, e.breakpoints),
            O = Object.assign(Object.assign(Object.assign({}, O), e), {
        ...
        function B() {
            ...
            e.some((e => {
                ...
                return a && (t = Object.assign(Object.assign({}, t), _[e])),
                a
            }
            )),
            X(t)
        ...
        function P() {
            A.value <= 0 || (N.value = Math.ceil((A.value - 1) / 2),
            M.value = function({config: e, slidesCount: t}) {
                const {snapAlign: a, wrapAround: n, itemsToShow: i=1} = e;
                if (n)
            ...
            E.value = function({config: e, slidesCount: t}) {
                const {wrapAround: a, snapAlign: n, itemsToShow: i=1} = e;
                let l = 0;
                if (a || i > t)
                    return l;
                switch (n) {
        ...
        ;
        function Q(e) {
            ["INPUT", "TEXTAREA", "SELECT"].includes(e.target.tagName) || (R = "touchstart" === e.type,
            R || e.preventDefault(),
            !R && 0 !== e.button || ee.value || (Y.x = R ? e.touches[0].clientX : e.clientX,
            Y.y = R ? e.touches[0].clientY : e.clientY,
            document.addEventListener(R ? "touchmove" : "mousemove", q, !0),
            document.addEventListener(R ? "touchend" : "mouseup", F, !0)))
        }
        const q = function(e, t) {
            ...
            W.value = !0,
            H.x = R ? e.touches[0].clientX : e.clientX,
            H.y = R ? e.touches[0].clientY : e.clientY;
            const t = H.x - Y.x
              , a = H.y - Y.y;
            U.y = a,
            U.x = t
        ...
        function F() {
            ...
            U.y = 0,
            W.value = !1,
            document.removeEventListener(R ? "touchmove" : "mousemove", q, !0),
            document.removeEventListener(R ? "touchend" : "mouseup", F, !0)
        }
        function J() {
        ...
        n("nav", ie),
        n("isSliding", ee);
        const le = r(( () => function({config: e, currentSlide: t, slidesCount: a}) {
            const {snapAlign: n, wrapAround: i, itemsToShow: l=1} = e;
            let o = t;
            switch (n) {
            case "center":
            case "center-odd":
    ...
    for (let t = i.value; t < n.value + 1; t++) {
        const a = c("button", {
            ...
            class: {
                ...
                "carousel__pagination-button--active": r(t)
            },
