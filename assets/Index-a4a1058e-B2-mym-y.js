import {dE as e, dF as n, dG as t, dH as o, dI as r, dJ as a, dK as i, dL as c, dM as l, dN as s, dO as d, dP as u, dQ as p, dR as v, dS as f, ag as m, ah as g, ai as h, aj as b, av as w, az as x, aw as y, al as $, aC as k, aD as C, am as z, an as T, ao as A, ap as M, aq as L, ar as j, as as q, at as _, au as H, a_ as P, ay as V, aB as I, aM as S, dT as D, b1 as E, ak as B, aX as F, aY as N, dU as Z, dV as W, dW as G, dX as O, b8 as U, b3 as R, dY as X, aV as J, dZ as K, aE as Y, aS as Q, ax as ee, d_ as ne, b4 as te, aI as oe, d$ as re, e0 as ae, aK as ie, aW as ce, e1 as le, e2 as se, e3 as de, e4 as ue, e5 as pe, e6 as ve, aN as fe, e7 as me, e8 as ge, aO as he, e9 as be, ea as we, aJ as xe, aR as ye, aL as $e, b9 as ke, eb as Ce, ec as ze, ed as Te, ee as Ae, ef as Me, eg as Le, ab as je, eh as qe, ei as _e, ej as He, ek as Pe, aA as Ve, el as Ie, em as Se, en as De, eo as Ee, ep as Be, eq as Fe, er as Ne, es as Ze} from "./index-N2rhOp93.js";
var We = function(n) {
    function t(e, t) {
  ...
  , Ue = function(n) {
    ...
    t.prototype.schedule = function(e, n) {
        ...
        var o = this.id
          , r = this.scheduler;
        return null != o && (this.id = this.recycleAsyncId(r, o, n)),
        this.pending = !0,
        this.delay = n,
        this.id = null !== (t = this.id) && void 0 !== t ? t : this.requestAsyncId(r, this.id, n),
        this
    }
    ,
    t.prototype.requestAsyncId = function(e, n, t) {
        return void 0 === t && (t = 0),
        Ge(e.flush.bind(e, this), t)
    }
    ,
    ...
    t.prototype._execute = function(e, n) {
        ...
        try {
            ...
            o = !0,
            t = r || new Error("Scheduled action threw falsy error")
        }
        if (o)
...
function nn(e) {
    let n, t, o, r, a, i, c, l = !Pe(e[6].chains[0], e[2]), s = [], d = new Map, u = l && on(e), p = e[2];
    const v = e => e[15].id;
    ...
    return {
        c() {
            ...
            for (let e = 0; e < s.length; e += 1)
                s[e].c();
            y(n, "class", o = Ve(`flex justify-center items-center pointer ${e[4]}`) + " svelte-1uqued6"),
        ...
        p(e, i) {
            ...
            u = null),
            4 & i && (p = e[2],
            s = ee(s, i, v, 1, e, p, d, n, Se, rn, null, Qe)),
            16 & i && o !== (o = Ve(`flex justify-center items-center pointer ${e[4]}`) + " svelte-1uqued6") && y(n, "class", o),
            64 & i && r !== (r = e[6].chains[0].id) && Ie(n, e[6].chains[0].id),
...
function tn(e) {
    ...
    return {
        c() {
            n = w("span"),
            t = R("switching..."),
            y(n, "class", o = Ve(`switching-placeholder ${e[4]}`) + " svelte-1uqued6"),
            y(n, "style", r = `\n        color: var(${e[1]},\n        var(--account-center-network-selector-color, var(--gray-500)));\n      `)
        },
        m(e, o) {
            $(e, n, o),
        ...
        p(e, t) {
            16 & t && o !== (o = Ve(`switching-placeholder ${e[4]}`) + " svelte-1uqued6") && y(n, "class", o),
            2 & t && r !== (r = `\n        color: var(${e[1]},\n        var(--account-center-network-selector-color, var(--gray-500)));\n      `) && y(n, "style", r)
        },
        d(e) {
            e && L(n)
...
function on(e) {
    ...
    return {
        ...
        p(e, a) {
            64 & a && r !== (r = (De[e[6].chains[0].id] || "unrecognized") + "") && te(t, r),
            64 & a && o !== (o = e[6].chains[0].id) && (n.__value = o,
            n.value = n.__value)
        },
        d(e) {
            e && L(n)
...
function rn(e, n) {
    ...
    return {
        ...
        p(e, i) {
            n = e,
            4 & i && a !== (a = (n[15].label || De[n[15].id] || n[15].id) + "") && te(o, a),
            4 & i && r !== (r = n[15].id) && (t.__value = r,
            t.value = t.__value)
        },
        d(e) {
            e && L(t)
...
function an(e) {
    ...
    return {
        ...
        p(e, [o]) {
            e[6] ? t ? t.p(e, o) : (t = en(e),
            t.c(),
            t.m(n.parentNode, n)) : t && (t.d(1),
            t = null)
        },
        i: E,
        o: E,
    ...
    p((function(e, n) {
        ...
        function i() {
            var e = r + C
              , o = z.now();
            if (o < e)
                return t = this.schedule(void 0, e - o),
                void n.add(t);
            a()
        }
...
function pn(e) {
    ...
    return {
        c() {
            n = w("div"),
            t = R(r),
            y(n, "class", "balance svelte-hb2n95")
        },
        m(e, o) {
            $(e, n, o),
            k(n, t)
...
function vn(e) {
    ...
    }) + "", g = e[2].accountCenter.copyAddress + "", h = !(e[1] && 0 === e[19]) && fn(e);
    function b() {
    ...
    return {
        ...
        m(u, f) {
            ...
            k(n, s),
            k(s, d),
            p || (v = [C(t, "click", Y(e[10])), C(i, "click", Y(e[12])), C(s, "click", Y(b))],
            p = !0)
        },
        p(t, r) {
            e = t,
            20 & r && f !== (f = e[4]("accountCenter.addAccount", {
                default: e[2].accountCenter.addAccount
            }) + "") && te(o, f),
            e[1] && 0 === e[19] ? h && (h.d(1),
            h = null) : h ? h.p(e, r) : (h = fn(e),
            h.c(),
            h.m(n, a)),
            20 & r && m !== (m = e[4]("accountCenter.disconnectWallet", {
                default: e[2].accountCenter.disconnectWallet
            }) + "") && te(c, m),
...
function fn(e) {
    ...
    return {
        ...
        p(n, o) {
            e = n,
            20 & o && a !== (a = e[4]("accountCenter.setPrimaryAccount", {
                default: e[2].accountCenter.setPrimaryAccount
            }) + "") && te(t, a)
        },
        d(e) {
...
function mn(e) {
    ...
    return {
        c() {
            ...
            y(v, "class", "elipsis pointer flex items-center justify-center relative svelte-hb2n95"),
        ...
        m(e, w) {
            ...
            k(n, m),
            g = !0,
            h || (b = [C(v, "click", Y(H)), C(t, "click", P)],
            h = !0)
        },
        p(a, i) {
            e = a;
            const l = {};
            2 & i && (l.customBackgroundColor = e[1] && 0 === e[19] ? "rgba(24, 206, 102, 0.2)" : "rgba(235, 235, 237, 0.1)"),
            2 & i && (l.border = e[1] && 0 === e[19] ? "green" : "gray"),
            1 & i && (l.icon = e[0].icon),
            r.$set(l),
            e[1] && 0 === e[19] ? q ? 2 & i && z(q, 1) : (q = un(),
            q.c(),
            z(q, 1),
            q.m(o, null)) : q && (T(),
            A(q, 1, 1, ( () => {
            ...
            M()),
            (!g || 1 & i) && j !== (j = (e[15] ? we(e[15].name) : e[16] ? we(e[16].name) : ke(e[14])) + "") && te(s, j),
            e[17] ? _ ? (_.p(e, i),
            1 & i && z(_, 1)) : (_ = pn(e),
            _.c(),
            z(_, 1),
...
function Cn(e) {
    ...
    }) + "", z = e[2]("modals.confirmDisconnectAll.description") + "", T = e[2]("modals.confirmDisconnectAll.cancel", {
    ...
    return {
        c() {
            ...
            f = w("button"),
            m = R(A),
            y(t, "class", "icon-container flex justify-center items-center svelte-1ubxcdp"),
        ...
        p(n, t) {
            e = n,
            4 & t && b !== (b = e[2]("modals.confirmDisconnectAll.heading", {
                default: G.modals.confirmDisconnectAll.heading
            }) + "") && te(a, b),
            4 & t && z !== (z = e[2]("modals.confirmDisconnectAll.description") + "") && te(l, z),
            4 & t && T !== (T = e[2]("modals.confirmDisconnectAll.cancel", {
                default: G.modals.confirmDisconnectAll.cancel
            }) + "") && te(p, T),
            4 & t && A !== (A = e[2]("modals.confirmDisconnectAll.confirm", {
                default: G.modals.confirmDisconnectAll.confirm
            }) + "") && te(m, A)
        },
        d(e) {
...
function Ln(e) {
    ...
    }) + "", j = e[3]("modals.confirmTransactionProtection.description") + "", q = e[3]("modals.confirmTransactionProtection.link", {
    ...
    return {
        c() {
            ...
            b = w("button"),
            z = R(H),
            y(t, "class", "icon-container flex justify-center items-center svelte-ruodf3"),
        ...
        p(n, t) {
            e = n,
            8 & t && M !== (M = e[3]("modals.confirmTransactionProtection.heading", {
                default: G.modals.confirmTransactionProtection.heading
            }) + "") && te(i, M),
            8 & t && j !== (j = e[3]("modals.confirmTransactionProtection.description") + "") && te(s, j),
            8 & t && q !== (q = e[3]("modals.confirmTransactionProtection.link", {
                default: G.modals.confirmTransactionProtection.link
            }) + "") && te(p, q),
            4 & t && y(u, "href", e[2]),
            8 & t && _ !== (_ = e[3]("modals.confirmTransactionProtection.dismiss", {
                default: G.modals.confirmTransactionProtection.dismiss
            }) + "") && te(g, _),
            8 & t && H !== (H = e[3]("modals.confirmTransactionProtection.enable", {
                default: G.modals.confirmTransactionProtection.enable
            }) + "") && te(z, H)
        },
        d(e) {
...
function Vn(e) {
    let n, t, o, r, a, i, c, l, s, d = e[1].name.toUpperCase() + "", u = (e[1].balance.length > 7 ? e[1].balance.slice(0, 7) : e[1].balance) + "";
    function p(e, n) {
    ...
    return {
        ...
        p(e, n) {
            v === (v = p(e)) && f ? f.p(e, n) : (f.d(1),
            f = v(e),
            f && (f.c(),
            f.m(o, r))),
            1 & n && d !== (d = e[1].name.toUpperCase() + "") && te(a, d),
            1 & n && u !== (u = (e[1].balance.length > 7 ? e[1].balance.slice(0, 7) : e[1].balance) + "") && te(l, u)
        },
        d(e) {
            e && L(n),
            f.d()
...
function Sn(e) {
    ...
    return Ee(t = e[1].icon, o),
    {
        ...
        p(n, r) {
            e = n,
            o.ctx = e,
            1 & r && t !== (t = e[1].icon) && Ee(t, o) || Be(o, e, r)
        },
        d(e) {
            e && L(n),
            o.block.d(e),
...
function Zn(e) {
    ...
    return {
        ...
        p(e, o) {
            e[1] && e[1].name && e[1].balance ? t ? t.p(e, o) : (t = Vn(e),
            t.c(),
            t.m(n.parentNode, n)) : t && (t.d(1),
            t = null)
        },
...
function Wn(e) {
    ...
    return {
        c() {
            ...
            t = w("table"),
            o = w("thead"),
            o.innerHTML = '<tr class="svelte-b848yl"><th colspan="3" class="secondary-token-table-header svelte-b848yl">Token Balances:</th></tr>',
            r = x(),
            a = w("tbody");
...
function Kn(e) {
    let n, t, o, r, a, i, c, l, s, d, u, p, v, f, m, g, h, b, j, q, _, H, P, D, E, B, F, N, Z, W, le = [], se = new Map, de = e[10]("accountCenter.currentNetwork", {
    ...
    let ve = "desktop" === e[17].type && function(e) {
        ...
        return {
            c() {
                ...
                d = w("span"),
                u = R(m),
                y(t, "class", "plus-icon flex items-center justify-center svelte-177u10y"),
                y(r, "class", "action-text svelte-177u10y"),
                y(n, "class", "action-container flex items-center pointer svelte-177u10y"),
                y(l, "class", "arrow-forward flex items-center justify-center svelte-177u10y"),
                y(d, "class", "action-text svelte-177u10y"),
                y(c, "class", "action-container flex items-center mt pointer svelte-177u10y")
            },
            m(f, m) {
                $(f, n, m),
                k(n, t),
                ...
                k(c, d),
                k(d, u),
                p || (v = [C(n, "click", e[26]), C(c, "click", e[27])],
                p = !0)
            },
            p(e, n) {
                ...
                1024 & n[0] && m !== (m = e[10]("accountCenter.disconnectAllWallets", {
                    default: G.accountCenter.disconnectAllWallets
                }) + "") && te(u, m)
            },
            d(e) {
    ...
    return {
        c() {
            ...
            y(B, "href", "https://blocknative.com"),
            y(B, "target", "_blank"),
            y(B, "rel", "noopener noreferrer"),
            y(B, "class", "flex justify-center items-center powered-by-container svelte-177u10y"),
            y(E, "class", "w100 svelte-177u10y"),
        ...
        m(w, x) {
            ...
            B.innerHTML = K,
            N = !0,
            Z || (W = [C(b, "click", e[21]), C(n, "click", Y((function() {
        ...
        p(n, t) {
            ...
            10 & t[0] && (ue = e[1],
            T(),
            le = ee(le, t, pe, 1, e, ue, se, r, ne, Yn, null, Rn),
            M()),
            "desktop" === e[17].type && ve.p(e, t);
            const o = {};
            32 & t[0] && (o.color = e[5] ? e[5].icon ? void 0 : "#EFF1FC" : "#FFAF00"),
            160 & t[0] && (o.customBackgroundColor = e[5] ? e[5].color || e[7] && e[7].color || U.color : "#FFE7B3"),
            160 & t[0] && (o.icon = e[5] ? e[5].icon || e[7] && e[7].icon || U.icon : Ke),
            u.$set(o),
            e[5] ? fe ? 32 & t[0] && z(fe, 1) : (fe = Qn(),
            fe.c(),
            z(fe, 1),
            fe.m(d, null)) : fe && (T(),
            A(fe, 1, 1, ( () => {
            ...
            M()),
            (!N || 1024 & t[0]) && de !== (de = e[10]("accountCenter.currentNetwork", {
                default: G.accountCenter.currentNetwork
            }) + "") && te(g, de),
            !e[9].hideTransactionProtectionBtn && (e[6] || e[5] && e[5].protectedRpcUrl) ? me ? me.p(e, t) : (me = et(e),
            me.c(),
            me.m(l, null)) : me && (me.d(1),
            me = null),
            (!N || 160 & t[0]) && J(l, "background-blue", e[5] && e[5].icon || e[7]),
            (!N || 32 & t[0]) && J(l, "background-yellow", !e[5]),
            (!N || 160 & t[0]) && J(l, "background-gray", e[5] && !e[7]),
            e[11] ? ge ? (ge.p(e, t),
            2048 & t[0] && z(ge, 1)) : (ge = nt(e),
            ge.c(),
            z(ge, 1),
            ge.m(H, P)) : ge && (T(),
            A(ge, 1, 1, ( () => {
            ...
            M()),
            e[8] && e[8].length ? he ? (he.p(e, t),
            256 & t[0] && z(he, 1)) : (he = at(e),
            he.c(),
            z(he, 1),
            he.m(H, D)) : he && (T(),
            A(he, 1, 1, ( () => {
...
function Yn(e, n) {
    ...
    return void 0 !== n[3] && (c.hideMenu = n[3]),
    o = new wn({
        props: c
    }),
...
function et(e) {
    ...
    return {
        c() {
            ...
            y(n, "class", "protect action-container flex items-center pointer svelte-177u10y")
        },
        m(l, s) {
            $(l, n, s),
            k(n, t),
...
function nt(e) {
    let n, t, o, r, a, i, c, l, s, d, u, p, v = (e[11] && e[11].name || "App Name") + "", f = (e[11] && e[11].description || "This app has not added a description.") + "";
    o = new O({
        props: {
            size: 32,
            padding: 4,
    ...
    return {
        ...
        p(e, n) {
            ...
            o.$set(t),
            (!p || 2048 & n[0]) && v !== (v = (e[11] && e[11].name || "App Name") + "") && te(i, v),
            (!p || 2048 & n[0]) && f !== (f = (e[11] && e[11].description || "This app has not added a description.") + "") && te(s, f),
            e[11].gettingStartedGuide || e[11].explore ? m ? m.p(e, n) : (m = tt(e),
            m.c(),
            m.m(u.parentNode, u)) : m && (m.d(1),
            m = null)
        },
        i(e) {
            p || (z(o.$$.fragment, e),
...
function tt(e) {
    ...
    }) + "", c = e[11].gettingStartedGuide && ot(e), l = e[11].explore && rt(e);
    return {
        c() {
            n = w("div"),
            t = w("div"),
        ...
        p(e, t) {
            ...
            e[11].gettingStartedGuide ? c ? c.p(e, t) : (c = ot(e),
            c.c(),
            c.m(n, a)) : c && (c.d(1),
            c = null),
            e[11].explore ? l ? l.p(e, t) : (l = rt(e),
            l.c(),
            l.m(n, null)) : l && (l.d(1),
            l = null)
        },
...
function ot(e) {
    ...
    return {
        ...
        p(e, n) {
            ...
            1024 & n[0] && s !== (s = e[10]("accountCenter.gettingStartedGuide", {
                default: G.accountCenter.gettingStartedGuide
            }) + "") && te(i, s),
...
function rt(e) {
    ...
    return {
        ...
        p(e, n) {
            ...
            1024 & n[0] && s !== (s = e[10]("accountCenter.explore", {
                default: G.accountCenter.explore
            }) + "") && te(i, s),
...
function it(e) {
    let n, t, o, r, a = e[2] && Xn(e), i = e[4] && Jn(e), c = e[0] && Kn(e);
    return {
        c() {
            a && a.c(),
            n = x(),
...
function ct(e, n, t) {
    ...
    const {position: x} = j.get().accountCenter
      ...
      , $ = async () => {
        if (i)
            try {
                await me(o.provider, i, i.protectedRpcUrl || ge),
                t(4, b = !1)
            } catch (e) {
                const {code: n} = e;
                console.log(e, n)
    ...
    e.$$.update = () => {
        ...
        524288 & e.$$.dirty[0] && t(8, a = o && o.accounts.length && o.accounts[0].secondaryTokens),
        1048576 & e.$$.dirty[0] && t(5, i = m.find(( ({id: e, namespace: n}) => !!r && (e === r.id && n === r.namespace)))),
        1048576 & e.$$.dirty[0] && t(7, c = Z(r && r.id)),
        1048576 & e.$$.dirty[0] && t(6, l = r && "0x1" === r.id)
    }
    ,
    [v, s, h, g, b, i, l, c, a, d, u, p, f, function() {
        s.forEach(( ({label: e}) => ve({
            label: e
        })))
    }
...
function dt(e) {
    ...
    return {
        ...
        p(e, n) {
            32 & n && i !== (i = (e[5].length > 7 ? e[5].slice(0, 7) : e[5]) + "") && te(t, i),
            4 & n && te(r, e[2])
        },
        i(e) {
            e && (a || oe(( () => {
...
function ut(e) {
    ...
    }),
    {
        c() {
            ...
            y(T, "style", P = `border-color: var(${e[4] ? "--onboard-primary-200, var(--primary-200)" : "--onboard-warning-500, var(--warning-500)"}); background-color: var(${e[4] ? "--account-center-minimized-chain-select-background, var(--primary-100)" : "--account-center-minimized-chain-select-background-warning, var(--warning-100)"})`),
            y(b, "class", "network"),
        ...
        m(w, x) {
            ...
            I(H, M, null),
            B = !0,
            F || (N = [C(T, "click", Y(e[15])), C(n, "click", Y((function() {
                Q(e[0]) && e[0].apply(this, arguments)
            }
            )))],
            F = !0)
        ...
        p(n, [t]) {
            e = n;
            const o = {};
            512 & t && (o.icon = e[9] && e[9].icon || pe),
            a.$set(o);
            const r = {};
            2 & t && (r.icon = e[1] ? e[1].icon : ""),
            l.$set(r),
            (!B || 448 & t) && Z !== (Z = (e[8] ? we(e[8]) : e[7] ? we(e[7]) : e[6]) + "") && te(m, Z),
            e[5] ? W ? (W.p(e, t),
            32 & t && z(W, 1)) : (W = dt(e),
            W.c(),
            z(W, 1),
            ...
            24 & t && (i.customBackgroundColor = e[4] ? e[4].color || e[3] && e[3].color || U.color : "var(--onboard-warning-200, var(--warning-200))"),
            24 & t && (i.icon = e[4] ? e[4].icon || e[3] && e[3].icon || U.icon : Ke),
            q.$set(i),
            (!B || 16 & t && P !== (P = `border-color: var(${e[4] ? "--onboard-primary-200, var(--primary-200)" : "--onboard-warning-500, var(--warning-500)"}); background-color: var(${e[4] ? "--account-center-minimized-chain-select-background, var(--primary-100)" : "--account-center-minimized-chain-select-background-warning, var(--warning-100)"})`)) && y(T, "style", P)
        },
        i(e) {
            B || (z(a.$$.fragment, e),
            z(l.$$.fragment, e),
...
function pt(e, n, t) {
    ...
    e.$$.update = () => {
        ...
        8192 & e.$$.dirty && t(2, [l] = r && r.balance ? Object.keys(r.balance) : [], l),
        8196 & e.$$.dirty && t(5, s = r && r.balance ? r.balance[l] : null),
        2 & e.$$.dirty && t(12, d = o && o.chains[0]),
        4096 & e.$$.dirty && t(4, u = h.find(( ({id: e, namespace: n}) => !!d && (e === d.id && n === d.namespace)))),
...
function mt(e) {
    ...
    }),
    {
        c() {
            ...
            y(n, "style", p = e[2].position.includes("Left") ? "align-self: flex-start" : null)
        },
        m(p, g) {
            $(p, n, g),
            k(n, t),
        ...
        p(t, [o]) {
            e = t;
            const a = {};
            8 & o && (a.icon = e[3] && e[3].icon || pe),
            r.$set(a);
            const i = {};
            2 & o && (i.icon = e[1] ? e[1].icon : ""),
            l.$set(i),
            (!v || 4 & o && p !== (p = e[2].position.includes("Left") ? "align-self: flex-start" : null)) && y(n, "style", p)
        },
        i(e) {
            v || (z(r.$$.fragment, e),
            z(l.$$.fragment, e),
...
function kt(e) {
    let n, t, o, r, a, i, c, l, s = e[1].position.includes("bottom"), d = e[1].position.includes("top"), u = s && wt(e);
    const p = [yt, xt]
      , v = [];
    function f(e, n) {
