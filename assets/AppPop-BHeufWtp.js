    ...
    H = a({
        ...
        setup(a) {
            ...
            const {
                ...
                Api: J
            } = l(), K = t("locale", (null == (S = n.find((a => a.lang === (null == navigator ? void 0 : navigator.language)))) ? void 0 : S.lang) || "en-US"), Q = a => {
                if ("USD" == a) return void(C.currencyRate = "1");
                const e = new b;
                e.append("name", a), J.getCurrencyRate(e).then((a => {
                    if (200 == a.status) {
                        const e = a.data;
                        0 == e.code && e.data && (a => {
                            let e = "number" == typeof a ? a : parseFloat(a);
                            return !isNaN(e) && e > 0
                        })(e.data) ? (C.currencyRate = e.data, C.currencyRateTime = Date.now().toString()) : C.currency = "USD"
                    } else C.currency = "USD"
                }))
            };
            return "USD" != C.currencyRate && Date.now() > Number(C.currencyRateTime.toString()) + 1e4 && Q(C.currency.toString()), o(U, (() => {
                K.value = U.value
            })), (a, e) => (r(), i(p(k), {
                ...
                default: c((() => [d("div", F, [d("div", P, [d("span", z, u(p(D)("pga.language")) + ":", 1), g(p(j), {
                    ...
                    default: c((() => [d("div", A, [(r(!0), m(x, null, v(p(n), ((a, s) => (r(), m("div", {
                        key: s,
                        class: "item-cur-lang"
                    ...
                    default: c((() => [d("div", L, [(r(!0), m(x, null, v(p(_), ((a, s) => {
                        var l;
                        return r(), m("div", {
                            key: s,
                            class: "item-cur-lang"
