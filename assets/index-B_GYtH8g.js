...
var e = (t => (t[t.TEXT = 1] = "TEXT", t[t.CLASS = 2] = "CLASS", t[t.STYLE = 4] = "STYLE", t[t.PROPS = 8] = "PROPS", t[t.FULL_PROPS = 16] = "FULL_PROPS", t[t.HYDRATE_EVENTS = 32] = "HYDRATE_EVENTS", t[t.STABLE_FRAGMENT = 64] = "STABLE_FRAGMENT", t[t.KEYED_FRAGMENT = 128] = "KEYED_FRAGMENT", t[t.UNKEYED_FRAGMENT = 256] = "UNKEYED_FRAGMENT", t[t.NEED_PATCH = 512] = "NEED_PATCH", t[t.DYNAMIC_SLOTS = 1024] = "DYNAMIC_SLOTS", t[t.HOISTED = -1] = "HOISTED", t[t.BAIL = -2] = "BAIL", t))(e || {});
const n = e => {
    const a = t(e) ? e : [e],
        o = [];
    return a.forEach((e => {
        var a;
        t(e) ? o.push(...n(e)) : r(e) && t(e.children) ? o.push(...n(e.children)) : (o.push(e), r(e) && (null == (a = e.component) ? void 0 : a.subTree) && o.push(...n(e.component.subTree)))
    })), o
};
...
function a(t, r) {
    ...
    return t = 360 === r ? t : Math.min(r, Math.max(0, parseFloat(t))), e && (t = parseInt(String(t * r), 10) / 100), Math.abs(t - r) < 1e-6 ? 1 : t = 360 === r ? (t < 0 ? t % r + r : t % r) / parseFloat(String(r)) : t % r / parseFloat(String(r))
}
...
function c(t, r, e) {
    return e < 0 && (e += 1), e > 1 && (e -= 1), e < 1 / 6 ? t + 6 * e * (r - t) : e < .5 ? r : e < 2 / 3 ? t + (r - t) * (2 / 3 - e) * 6 : t
}
...
function p(t) {
    ...
    return "string" == typeof t && (t = function(t) {
        ...
        if (e = M.rgba.exec(t), e) return {
            r: e[1],
            g: e[2],
            b: e[3],
            a: e[4]
        };
        if (e = M.hsl.exec(t), e) return {
            h: e[1],
            s: e[2],
            l: e[3]
        };
        if (e = M.hsla.exec(t), e) return {
            h: e[1],
            s: e[2],
            l: e[3],
            a: e[4]
        };
        if (e = M.hsv.exec(t), e) return {
            h: e[1],
            s: e[2],
            v: e[3]
        };
        if (e = M.hsva.exec(t), e) return {
            h: e[1],
            s: e[2],
            v: e[3],
            a: e[4]
        };
        if (e = M.hex8.exec(t), e) return {
            r: l(e[1]),
            g: l(e[2]),
            b: l(e[3]),
            a: d(e[4]),
        ...
        if (e = M.hex6.exec(t), e) return {
            r: l(e[1]),
            g: l(e[2]),
            b: l(e[3]),
            format: r ? "name" : "hex"
        };
        if (e = M.hex4.exec(t), e) return {
            r: l(e[1] + e[1]),
            g: l(e[2] + e[2]),
            b: l(e[3] + e[3]),
            a: d(e[4] + e[4]),
        ...
        return !1
    }(t)), "object" == typeof t && (x(t.r) && x(t.g) && x(t.b) ? (r = t.r, e = t.g, n = t.b, o = {
        r: 255 * a(r, 255),
        g: 255 * a(e, 255),
        b: 255 * a(n, 255)
    }, p = !0, v = "%" === String(t.r).substr(-1) ? "prgb" : "rgb") : x(t.h) && x(t.s) && x(t.v) ? (f = h(t.s), u = h(t.v), o = function(t, r, e) {
    ...
    }(t.h, f, u), p = !0, v = "hsv") : x(t.h) && x(t.s) && x(t.l) && (f = h(t.s), g = h(t.l), o = function(t, r, e) {
        var n, o, i;
        if (t = a(t, 360), r = a(r, 100), e = a(e, 100), 0 === r) o = e, i = e, n = e;
        else {
            var h = e < .5 ? e * (1 + r) : e + r - e * r,
                s = 2 * e - h;
            n = c(s, h, t + 1 / 3), o = c(s, h, t), i = c(s, h, t - 1 / 3)
        }
        return {
            r: 255 * n,
            g: 255 * o,
    ...
    }(t.h, f, g), p = !0, v = "hsl"), Object.prototype.hasOwnProperty.call(t, "a") && (s = t.a)), s = i(s), {
        ok: p,
        format: t.format || v,
...
var S = function() {
    function t(r, e) {
        var n;
        if (void 0 === r && (r = ""), void 0 === e && (e = {}), r instanceof t) return r;
    ...
    return t.prototype.isDark = function() {
        ...
        return void 0 === t && (t = !1),
            function(t, r, e, n, a) {
                var o, i = [s(Math.round(t).toString(16)), s(Math.round(r).toString(16)), s(Math.round(e).toString(16)), s((o = n, Math.round(255 * parseFloat(o)).toString(16)))];
        ...
        void 0 === r && (r = 10);
        var e = this.toRgb();
        return e.r = Math.max(0, Math.min(255, e.r - Math.round(-r / 100 * 255))), e.g = Math.max(0, Math.min(255, e.g - Math.round(-r / 100 * 255))), e.b = Math.max(0, Math.min(255, e.b - Math.round(-r / 100 * 255))), new t(e)
        ...
        void 0 === r && (r = 6), void 0 === e && (e = 30);
        var n = this.toHsl(),
            a = 360 / e,
            o = [this];
        for (n.h = (n.h - (a * r >> 1) + 720) % 360; --r;) n.h = (n.h + a) % 360, o.push(new t(n));
        return o
        ...
        void 0 === r && (r = 6);
        for (var e = this.toHsv(), n = e.h, a = e.s, o = e.v, i = [], h = 1 / r; r--;) i.push(new t({
            h: n,
            s: a,
            v: o
        })), o = (o + h) % 1;
        ...
        for (var e = this.toHsl(), n = e.h, a = [this], o = 360 / r, i = 1; i < r; i++) a.push(new t({
            h: (n + i * o) % 360,
            s: e.s,
            l: e.l
        }));
