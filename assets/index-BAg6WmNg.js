import {
    ...
    b as s,
    c as l
} from "./AiTradeItems2-DLQN8Tx_.js";
import {
    _ as i,
    f as n
} from "./index-DeR4cFNp.js";
import {
    _ as o
} from "./CaseStudy-zYbG7cTm.js";
import {
    _ as r
} from "./Blob-Dcjc2zVm.js";
import {
    _ as c
...
import {
    V as p
} from "./vue3-lottie.es-CkQlzgJ-.js";
import {
    m,
    h as v,
    o as h,
...
import {
    E as J
} from "./index-CIx51WGd.js";
import {
    _ as Y
} from "./SectionTitle.vue_vue_type_script_setup_true_lang-Bx8x6dDW.js";
import {
    _ as Q
} from "./Hero.vue_vue_type_style_index_0_lang-Dq1xKyUL.js";
import {
    _ as X
} from "./AvatarSimple-BSG0UtmT.js";
import {
    _ as ee
} from "./Section-BDPTfy_V.js";
import {
    _ as ae
} from "./DarkImage-CFyB68bs.js";
import {
    _ as te
} from "./Navbar2-Dgac0h4w.js";
import {
    _ as se,
    a as le
...
import {
    C as me,
    S as ve
} from "./carousel.es-B9woQfXr.js";
import {
    i as he
} from "./vue-qrcode.esm-D8esohdp.js";
import {
    E as ge,
    a as fe
...
import {
    a as xe,
    E as we
} from "./index-DcoSTKM8.js";
import {
    E as ke
} from "./index-BPcizNiM.js";
import {
    E as qe
} from "./index-D8Bawvwf.js";
import {
    u as je
} from "./useSeoMeta-BjtwoFIa.js";
import {
    s as _e
...
import {
    a as Te,
    E as Be
} from "./index-q0XwZ89p.js";
import {
    E as Se,
    a as Ee
} from "./index-ip9MERa1.js";
import {
    E as Ie
} from "./index-D6vpbuah.js";
import {
    B as De,
    C as Oe
        ...
        setup(e, {
            ...
            const s = (e, a) => {
                    void 0 !== window.gtag ? (a ? window.gtag("event", e, {
                        ...
                        value: a
                    }) : window.gtag("event", e), window.LOQ = window.LOQ || [], window.LOQ.push(["ready", async t => {
                        await t.$internal.ready("events"), t.events.track(e, a ? {
                            amount: a
                        } : {
                            value: !0
                        })
                ...
                l = async e => {
                    if (e.tx_id) {
                        const a = me.coinTo.replaceAll(",", ""),
                            ...
                            l = new ue;
                        l.append("amount", Number(a).toFixed(0)), X.isLoggedIn && l.append("memberId", Number(X.userData.id)), o.adId && Number(o.adId) > 0 ? l.append("adId", Number(o.adId)) : Le.value && "" != Le.value && X.userData.id.toString() !== Le.value.toString() && l.append("adId", Number(Le.value)), l.append("hash", e.tx_id), l.append("ethChain", !0), l.append("isNative", !0), l.append("to", t.sc_address), l.append("isCard", !0), p.value > 0 && l.append("timeTr", ua(p.value + Number(a))), "success" === e.status ? (await n.setCoinOrder(l).then((({
                            data: e
                        }) => {
                            const t = e;
                            "1" == t ? (m.success(i("dash.success-purchased").replace(":xxxBTC", Number(a).toFixed(0) + " OPZ").replace(":xxx BTC", Number(a).toFixed(0) + " OPZ")), me.coinFrom = "", me.coinTo = "", za(), Re(), pa()) : "0" == t ? m.error("Error occured") : "2" == t ? m.info("Pending transaction") : "3" == t ? m.info("Quote Expired: Please contact support") : m.error(e.message)
                        })).catch((e => {
            ...
            const Fe = [{
                ...
                Le = I("");
            M((async () => {
                await new Promise((e => setTimeout(e, 1e3))), Le.value = localStorage.getItem("referral") ? ? ""
            }));
            const Ue = I("0x1"),
                Ze = I("0x1"),
                Ve = e => {
            ...
            const ha = I(!0),
                ...
                za = async () => {
                    if ("CARD" === Ue.value || "BTC" === Ue.value) return !0;
            ...
            W(P, (e => {
                ...
                (null == e ? void 0 : e.id) && (Ue.value = null == e ? void 0 : e.id, Ze.value = null == e ? void 0 : e.id, "0x1" === (null == e ? void 0 : e.id) && "BNB" == P.value ? P.value = "ETH" : "0x38" === (null == e ? void 0 : e.id) && "ETH" == P.value && (P.value = "BNB"), Re())
            }));
            const Da = I(!1);
            W(be, (e => {
            ...
            return (async () => {
                ...
                return h(), g(S, null, [f("div", St, [f("div", Et, [f("div", It, [f("div", Dt, [f("div", Ot, [f("div", Nt, [f("div", Ft, [f("div", At, [a[23] || (a[23] = f("p", {
                    ...
                    onChange: a[17] || (a[17] = e => (async e => {
                        ...
                        if (be.value) {
                            if ("CARD" === e) return P.value = "USD", Ue.value = "CARD", !0;
                            if ("BTC" === e) return P.value = "BTC", Ue.value = "BTC", !0;
                            "USD" != P.value && "BTC" != P.value || (P.value = "0x1" == Ze.value ? "ETH" : "BNB"), Ue.value = Ze.value;
                            try {
                                await ye({
                                    chainId: e
                                })
                ...
                }, null, 8, ["modelValue", "address", "amount", "amountOPZ", "memberId", "adId"])) : _("", !0), ja.value ? (h(), g("noscript", Ls, a[39] || (a[39] = [f("img", {
                    height: "1",
                    width: "1",
                    style: {
                        display: "none"
                ...
                }, null, -1)]))) : _("", !0), qa.value ? (h(), g("noscript", Us, a[40] || (a[40] = [f("img", {
                    height: "1",
                    width: "1",
                    style: {
                        display: "none"
