...
const k = (a, d = {}) => {
        ...
        if (!i || m(document.body, r.value)) return;
        let c = 0,
            f = !1,
            b = "0";
        const M = () => {
            setTimeout((() => {
                v(null == document ? void 0 : document.body, r.value), f && document && (document.body.style.width = b)
            }), 200)
        };
        s(a, (e => {
            if (!e) return void M();
            f = !m(document.body, r.value), f && (b = document.body.style.width), c = x(u.namespace.value);
            const o = document.documentElement.clientHeight < document.body.scrollHeight,
                t = p(document.body, "overflowY");
            c > 0 && (o || "scroll" === t) && f && (document.body.style.width = `calc(100% - ${c}px)`), y(document.body, r.value)
        })), n((() => M()))
    },
    g = e => {
        if (!e) return {
