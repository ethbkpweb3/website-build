...
var U = M(o({ ...Q,
    ...
    setup(o, {
        ...
        return m({
            ...
            class: i(d(x).e("title"))
        }, c(e.title), 11, ["aria-level"])])), e.showClose ? (l(), t("button", {
            key: 0,
            ...
            default: u((() => [(l(), p(v(e.closeIcon || d(C))))])),
            _: 1
        }, 8, ["class"])], 10, ["aria-label", "onClick"])) : b("v-if", !0)], 2), r("div", {
            id: d(R),
            class: i(d(x).e("body"))
        }, [n(e.$slots, "default")], 10, ["id"]), e.$slots.footer ? (l(), t("footer", {
            key: 0,
