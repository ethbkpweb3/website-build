import {bh as n, H as e, d as t} from "./index-jdACH0Rc.js";
var r = {
    exports: {}
};
...
const i = e(r.exports = function() {
    ...
    t.promise = function(r) {
        return r && "resolved" !== r.state() ? (0 === e && t.start(),
        n++,
        e++,
        r.always((function() {
            0 == --e ? (n = 0,
    ...
    t.render = function(n) {
        ...
        var i, o = e.querySelector(r.barSelector), a = n ? "-100" : s(t.status || 0), c = document.querySelector(r.parent);
        return u(o, {
            transition: "all 0 linear",
            transform: "translate3d(" + a + "%,0,0)"
        }),
        r.showSpinner || (i = e.querySelector(r.spinnerSelector)) && m(i),
