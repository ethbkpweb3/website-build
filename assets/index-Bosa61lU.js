...
let se = class {
    ...
    ue = class {
        ...
        init(e) {
            ...
            t && (this.submenu = new se(this, t)), this.addListeners()
        }
        addListeners() {
            this.domNode.addEventListener("keydown", (t => {
                ...
                switch (t.code) {
                    case e.down:
                        y(t.currentTarget, "mouseenter"), this.submenu && this.submenu.gotoSubIndex(0), l = !0;
                        break;
                    case e.up:
                        y(t.currentTarget, "mouseenter"), this.submenu && this.submenu.gotoSubIndex(this.submenu.subMenuItems.length - 1), l = !0;
                        break;
                    case e.tab:
    ...
    setup() {
        ...
        return {
            listeners: {
                ...
                onEnter(t, l) {
                    r(t, `${e.namespace.value}-opacity-transition`), t.style.opacity = "1", l()
                },
                onAfterEnter(t) {
                    i(t, `${e.namespace.value}-opacity-transition`), t.style.opacity = ""
                },
                onBeforeLeave(t) {
                    t.dataset || (t.dataset = {}), d(t, e.m("collapse")) ? (i(t, e.m("collapse")), t.dataset.oldOverflow = t.style.overflow, t.dataset.scrollWidth = t.clientWidth.toString(), r(t, e.m("collapse"))) : (r(t, e.m("collapse")), t.dataset.oldOverflow = t.style.overflow, t.dataset.scrollWidth = t.clientWidth.toString(), i(t, e.m("collapse"))), t.style.width = `${t.scrollWidth}px`, t.style.overflow = "hidden"
                },
                onLeave(e) {
                    r(e, "horizontal-collapse-transition"), e.style.width = `${e.dataset.scrollWidth}px`
                }
            }
        }
    }
...
function de(e, t) {
    const l = $((() => {
        ...
        const o = [t.value];
        for (;
            "ElMenu" !== l.type.name;) l.props.index && o.unshift(l.props.index), l = l.parent;
        return o
    }));
    return {
        parentMenu: $((() => {
...
var he = M({
    ...
    setup(e, {
        ...
        const x = N(!1),
            ...
            ee = (t, l = Z.value) => {
                var o;
                "focus" !== t.type && ("click" === d.props.menuTrigger && "horizontal" === d.props.mode || !d.props.collapse && "vertical" === d.props.mode || e.disabled ? p.mouseInChild.value = !0 : (p.mouseInChild.value = !0, null == g || g(), ({
                    stop: g
                } = h((() => {
                    d.openMenu(e.index, s.value)
                }), l)), k.value && (null == (o = u.value.vnode.el) || o.dispatchEvent(new MouseEvent("mouseenter")))))
            },
            te = (t = !1) => {
                var l;
                "click" === d.props.menuTrigger && "horizontal" === d.props.mode || !d.props.collapse && "vertical" === d.props.mode ? p.mouseInChild.value = !1 : (null == g || g(), p.mouseInChild.value = !1, ({
                    stop: g
                } = h((() => !x.value && d.closeMenu(e.index, s.value)), J.value)), k.value && t && (null == (l = p.handleMouseleave) || l.call(p, !0)))
            };
        ...
        return a({
            ...
            d.addSubMenu(Q), p.addSubMenu(Q)
        })), L((() => {
            p.removeSubMenu(Q), d.removeSubMenu(Q)
        })), () => {
            var l;
...
var ge = M({
    ...
    setup(e, {
        ...
        const s = D(),
            ...
            x = (l, o) => {
                c.value.includes(l) || (e.uniqueOpened && (c.value = c.value.filter((e => o.includes(e)))), c.value.push(l), t("open", l, o))
            },
            y = e => {
                const t = c.value.indexOf(e); - 1 !== t && c.value.splice(t, 1)
            },
            M = (e, l) => {
                y(e), t("close", e, l)
            },
            ...
            S = l => {
                ...
                if (!g(o) && !g(a))
                    if (e.router && u) {
                        const e = l.route || o,
                            n = u.push(e).then((e => (e || (v.value = o), e)));
                        t("select", o, a, {
                            index: o,
                            indexPath: a,
                            route: e
                        }, n)
                    } else v.value = o, t("select", o, a, {
                        index: o,
                        indexPath: a
                    })
            },
        ...
        return () => {
            ...
            if ("horizontal" === e.mode && r.value) {
                ...
                (null == o ? void 0 : o.length) && e.ellipsis && (s = l, u.push(_(he, {
                    index: "sub-menu-more",
            ...
            const v = e.closeOnClickOutside ? [
                    [n, () => {
                        c.value.length && (O.value || (c.value.forEach((e => {
                            return t("close", e, (l = e, f.value[l].indexPath));
                            var l
                        })), c.value = []))
                    }]
                ] : [],
...
var Me = s(M({
    ...
    setup(e, {
        ...
        const {
            parentMenu: u,
            indexPath: r
        } = de(o, K(e, "index")), i = B(`subMenu:${u.value.uid}`);
        ...
        return j((() => {
            i.addSubMenu(p), a.addMenuItem(p)
        })), L((() => {
            i.removeSubMenu(p), a.removeMenuItem(p)
        })), {
            parentMenu: u,
            rootMenu: a,
            active: d,
    ...
    ["render", function(e, t, l, o, a, n) {
        ...
        }, ["ElMenu" === e.parentMenu.type.name && e.rootMenu.props.collapse && e.$slots.title ? (C(), S(s, {
            key: 0,
