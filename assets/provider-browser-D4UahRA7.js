var t, e, n, r, s, i, a, o, c, l, u, h, f, p, d, g, m, y, w, A, b, v, E, k, P, x, N, C, O, R, B, T, I, M, F, D, S, U, L, G, Q, H, j, W, J, V, z, K, Y, Z, q, X, _, $, tt, et, nt, rt, st, it, at, ot, ct, lt, ut, ht, ft, pt, dt, gt, mt, yt, wt, At, bt, vt, Et, kt, Pt, xt, Nt, Ct, Ot, Rt, Bt, Tt, It, Mt, Ft, Dt, St, Ut, Lt, Gt, Qt, Ht, jt, Wt, Jt, Vt, zt, Kt, Yt, Zt, qt, Xt, _t, $t, te, ee, ne, re, se, ie, ae, oe, ce, le, ue, he, fe, pe, de, ge, me, ye, we, Ae, be, ve, Ee, ke, Pe, xe, Ne, Ce, Oe, Re, Be, Te, Ie, Me, Fe, De, Se, Ue, Le, Ge, Qe, He, je, We, Je, Ve, ze, Ke, Ye, Ze, qe, Xe, _e, $e, tn = Object.defineProperty, en = t => {
    throw TypeError(t)
}
, nn = (t, e, n) => ( (t, e, n) => e in t ? tn(t, e, {
    ...
    writable: !0,
    value: n
}) : t[e] = n)(t, "symbol" != typeof e ? e + "" : e, n), rn = (t, e, n) => e.has(t) || en("Cannot " + n), sn = (t, e, n) => (rn(t, e, "read from private field"),
n ? n.call(t) : e.get(t)), an = (t, e, n) => e.has(t) ? en("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, n), on = (t, e, n, r) => (rn(t, e, "write to private field"),
r ? r.call(t, n) : e.set(t, n),
n), cn = (t, e, n) => (rn(t, e, "access private method"),
n), ln = (t, e, n, r) => ({
    set _(r) {
        on(t, e, r, n)
    },
...
import {w as un, S as hn, u as fn, s as pn, k as dn} from "./sha256-o0pdH_sn.js";
import {s as gn} from "./secp256k1-LeYlzbB0.js";
function mn(t, e, n) {
    ...
    let r, s = t;
    {
        ...
        if (n) {
            if ("message"in n || "code"in n || "name"in n)
                throw new Error(`value will overwrite populated values: ${An(n)}`);
            for (const t in n) {
                if ("shortMessage" === t)
                    continue;
                const e = n[t];
...
function xn(t, e, n) {
    null == n && (n = ""),
    n && (n = ": " + n),
    kn(t >= e, "missing arguemnt" + n, "MISSING_ARGUMENT", {
        count: t,
        expectedCount: e
    }),
...
function Nn(t, e, n) {
    ...
    t !== e) {
        ...
        n && (t += ".",
        e += " " + n),
        kn(!1, `private constructor; use ${t}from* methods`, "UNSUPPORTED_OPERATION", {
            operation: e
        })
    }
}
...
function Vn(t, e) {
    ...
    case "bigint":
        return t;
    case "number":
        return Pn(Number.isInteger(t), "underflow", e || "value", t),
        Pn(t >= -Hn && t <= Hn, "overflow", e || "value", t),
        BigInt(t);
    case "string":
        try {
            if ("" === t)
...
function Zn(t, e) {
    switch (typeof t) {
    case "bigint":
        return Pn(t >= -Hn && t <= Hn, "overflow", e || "value", t),
        Number(t);
    case "number":
        return Pn(Number.isInteger(t), "underflow", e || "value", t),
        Pn(t >= -Hn && t <= Hn, "overflow", e || "value", t),
...
function nr(t, e, n, r, s) {
    if ("BAD_PREFIX" === t || "UNEXPECTED_CONTINUE" === t) {
        let t = 0;
        for (let r = e + 1; r < n.length && n[r] >> 6 == 2; r++)
            t++;
        return t
    }
...
const rr = Object.freeze({
    ...
    replace: function(t, e, n, r, s) {
        return "OVERLONG" === t ? (Pn("number" == typeof s, "invalid bad code point for replacement", "badCodepoint", s),
        r.push(s),
        0) : (r.push(65533),
        nr(t, e, n))
    }
...
function ir(t, e) {
    ...
    n.map((t => t <= 65535 ? String.fromCharCode(t) : (t -= 65536,
    String.fromCharCode(55296 + (t >> 10 & 1023), 56320 + (1023 & t))))).join("");
    var n
}
function ar(t) {
    return async function(t, e) {
        ...
        const s = new AbortController
          , i = setTimeout(( () => {
            r = En("request timeout", "TIMEOUT"),
            s.abort()
        }
        ), t.timeout);
        e && e.addListener(( () => {
            r = En("request cancelled", "CANCELLED"),
            s.abort()
        }
        ));
        const a = {
...
const yr = class t {
    ...
    set body(t) {
        if (null == t)
            ...
            on(this, l, sr(t)),
            on(this, u, "text/plain");
        else if (t instanceof Uint8Array)
            on(this, l, t),
            on(this, u, "application/octet-stream");
        else {
            if ("object" != typeof t)
                throw new Error("invalid body");
            on(this, l, sr(JSON.stringify(t))),
            on(this, u, "application/json")
        }
    }
    hasBody() {
    ...
    set method(t) {
        null == t && (t = ""),
        on(this, a, String(t).toUpperCase())
    }
    get headers() {
        const t = Object.assign({}, sn(this, i));
        return sn(this, h) && (t.authorization = `Basic ${function(t) {
            const e = On(t);
            letn = "";
        ...
        null == t["content-type"] && sn(this, u) && (t["content-type"] = sn(this, u)),
    ...
    setCredentials(t, e) {
        Pn(!t.match(/:/), "invalid basic authentication username", "username", "[REDACTED]"),
        on(this, h, `${t}:${e}`)
    }
    get allowGzip() {
        return sn(this, s)
    ...
    set timeout(t) {
        Pn(t >= 0, "timeout must be non-zero", "timeout", t),
        on(this, o, t)
    }
    get preflightFunc() {
    ...
    setThrottleParams(t) {
        null != t.slotInterval && (sn(this, m).slotInterval = t.slotInterval),
        null != t.maxAttempts && (sn(this, m).maxAttempts = t.maxAttempts)
    }
    send() {
        return kn(null == sn(this, g), "request already sent", "UNSUPPORTED_OPERATION", {
            operation: "fetchRequest.send"
        }),
        on(this, g, new gr(this)),
        cn(this, w, A).call(this, 0, vr() + this.timeout, 0, this, new br(0,"",{},null,this))
    }
    cancel() {
    ...
    redirect(e) {
        ...
        on(s, i, Object.assign({}, sn(this, i))),
        sn(this, l) && on(s, l, new Uint8Array(sn(this, l))),
        on(s, u, sn(this, u)),
        s
    }
    clone() {
        const e = new t(this.url);
        return on(e, a, sn(this, a)),
        sn(this, l) && on(e, l, sn(this, l)),
        on(e, u, sn(this, u)),
        on(e, i, Object.assign({}, sn(this, i))),
        on(e, h, sn(this, h)),
        ...
        on(e, p, sn(this, p)),
        on(e, d, sn(this, d)),
        on(e, m, Object.assign({}, sn(this, m))),
        on(e, y, sn(this, y)),
        e
    }
    static lockConfig() {
...
y = new WeakMap,
w = new WeakSet,
A = async function(t, e, n, r, s) {
    var i, a, o;
    if (t >= sn(this, m).maxAttempts)
    ...
    if (429 === h.statusCode && (null == this.retryFunc || await this.retryFunc(c, h, t))) {
        ...
        return "string" == typeof n && n.match(/^[1-9][0-9]*$/) && (s = parseInt(n)),
        cn(a = c.clone(), w, A).call(a, t + 1, e, s, r, h)
    }
    if (this.processFunc) {
        mr(sn(r, g));
        try {
            ...
            return f.stall >= 0 && (n = f.stall),
            cn(o = c.clone(), w, A).call(o, t + 1, e, n, r, h)
        }
    }
    return h
}
...
const Ar = class t {
    constructor(t, e, n, r, s) {
        ...
        on(this, b, t),
        on(this, v, e),
        on(this, E, Object.keys(n).reduce(( (t, e) => (t[e.toLowerCase()] = String(n[e]),
        t)), {})),
        on(this, k, null == r ? null : new Uint8Array(r)),
        on(this, P, s || null),
        on(this, x, {
            message: ""
        })
    ...
    assertOk() {
        if (this.ok())
            return;
        let {message: t, error: e} = sn(this, x);
...
function Pr(t, e, n, r) {
    ...
    for (; n < e + 1 + r; ) {
        const i = xr(t, n);
        s.push(i.result),
        kn((n += i.consumed) <= e + 1 + r, "child data too short", "BUFFER_OVERRUN", {
            buffer: t,
            length: r,
            offset: e
        })
...
function Nr(t) {
    const e = On(t, "data")
      , n = xr(e, 0);
    return Pn(n.consumed === e.length, "unexpected junk after rlp payload", "data", t),
    n.result
}
function Cr(t) {
    const e = [];
...
function Gr(t, e, n) {
    return t.indexOf(null) >= 0 ? e.map(( (t, e) => t instanceof Qr ? Gr(Sr(t), t, n) : t)) : t.reduce(( (t, r, s) => {
        let i = e.getValue(r);
        return r in t || (n && i instanceof Qr && (i = Gr(Sr(i), i, n)),
        t[r] = i),
        t
    }
    ), {})
...
let Qr = class t extends Array {
            ...
            get: (t, e, n) => {
                if ("string" == typeof e) {
                    if (e.match(/^[0-9]+$/)) {
                        ...
                        const r = t[n];
                        return r instanceof Error && Lr(`index ${n}`, r),
                        r
                    }
                    if (Mr.indexOf(e) >= 0)
    ...
    toArray(e) {
        ...
        return this.forEach(( (r, s) => {
            r instanceof Error && Lr(`index ${s}`, r),
            e && r instanceof t && (r = r.toArray(e)),
            n.push(r)
        }
        )),
        n
    ...
    slice(e, n) {
        ...
        null == n && (n = this.length),
        n < 0 && (n += this.length) < 0 && (n = 0),
    ...
    filter(e, n) {
        ...
        for (let t = 0; t < this.length; t++) {
            const a = this[t];
            a instanceof Error && Lr(`index ${t}`, a),
            e.call(n, a, t, this) && (s.push(a),
            i.push(r[t]))
        }
        return new t(Fr,s,i)
    }
    map(t, e) {
        ...
        for (let r = 0; r < this.length; r++) {
            const s = this[r];
            s instanceof Error && Lr(`index ${r}`, s),
    ...
    getValue(t) {
        ...
        if (-1 === e)
            return;
        const n = this[e];
        return n instanceof Error && Lr(`property ${JSON.stringify(t)}`, n.error),
        n
    }
...
function Hr(t) {
    ...
    e.length !== Tr && (e = Rn(Fn([Ir.slice(e.length % Tr), e]))),
    e
}
class jr {
    constructor(t, e, n, r) {
...
class Wr {
    ...
    writeBytes(t) {
        let e = Rn(t);
        const n = e.length % Tr;
        return n && (e = Rn(Fn([e, Ir.slice(n)]))),
        cn(this, R, B).call(this, e)
    }
    writeValue(t) {
    ...
    writeUpdatableValue() {
        ...
        return sn(this, C).push(Ir),
        on(this, O, sn(this, O) + Tr),
        e => {
            sn(this, C)[t] = Hr(e)
        }
    }
...
R = new WeakSet,
B = function(t) {
    return sn(this, C).push(t),
    on(this, O, sn(this, O) + t.length),
    t.length
}
;
T = new WeakMap,
...
U = function(t) {
    var e;
    if (sn(this, F))
        return cn(e = sn(this, F), S, U).call(e, t);
    on(this, M, sn(this, M) + t),
    kn(sn(this, D) < 1 || sn(this, M) <= sn(this, D) * this.dataLength, `compressed ABI data exceeds inflation ratio of ${sn(this, D)} ( see: https://github.com/ethers-io/ethers.js/issues/4537 )`, "BUFFER_OVERRUN", {
        buffer: Rn(sn(this, T)),
        offset: sn(this, I),
        length: t,
        info: {
...
let Jr = class t {
    ...
    readBytes(t, e) {
        ...
        return cn(this, S, U).call(this, t),
        on(this, I, sn(this, I) + n.length),
        n.slice(0, t)
    }
    readValue() {
...
class Zr extends hn {
    ...
    get() {
        const {Ah: t, Al: e, Bh: n, Bl: r, Ch: s, Cl: i, Dh: a, Dl: o, Eh: c, El: l, Fh: u, Fl: h, Gh: f, Gl: p, Hh: d, Hl: g} = this;
    ...
    process(t, e) {
        ...
        let {Ah: n, Al: r, Bh: s, Bl: i, Ch: a, Cl: o, Dh: c, Dl: l, Eh: u, El: h, Fh: f, Fl: p, Gh: d, Gl: g, Hh: m, Hl: y} = this;
        for (let w = 0; w < 80; w++) {
            ...
            f = 0 | u,
            p = 0 | h,
            ({h: u, l: h} = fn.add(0 | c, 0 | l, 0 | E, 0 | k)),
            c = 0 | a,
            l = 0 | o,
            a = 0 | s,
            o = 0 | i,
        ...
        ({h: n, l: r} = fn.add(0 | this.Ah, 0 | this.Al, 0 | n, 0 | r)),
        ({h: s, l: i} = fn.add(0 | this.Bh, 0 | this.Bl, 0 | s, 0 | i)),
        ({h: a, l: o} = fn.add(0 | this.Ch, 0 | this.Cl, 0 | a, 0 | o)),
        ({h: c, l: l} = fn.add(0 | this.Dh, 0 | this.Dl, 0 | c, 0 | l)),
        ({h: u, l: h} = fn.add(0 | this.Eh, 0 | this.El, 0 | u, 0 | h)),
        ({h: f, l: p} = fn.add(0 | this.Fh, 0 | this.Fl, 0 | f, 0 | p)),
        ({h: d, l: g} = fn.add(0 | this.Gh, 0 | this.Gl, 0 | d, 0 | g)),
        ({h: m, l: y} = fn.add(0 | this.Hh, 0 | this.Hl, 0 | m, 0 | y)),
        this.set(n, r, s, i, a, o, c, l, u, h, f, p, d, g, m, y)
    }
    roundClean() {
        Kr.fill(0),
        Yr.fill(0)
...
const ms = class t {
    ...
    set s(t) {
        ...
        const e = Mn(t);
        Pn(parseInt(e.substring(0, 3)) < 8, "non-canonical s", "value", e),
        on(this, Q, e)
    }
    get v() {
        return sn(this, H)
    ...
    clone() {
        ...
        return this.networkV && on(e, j, this.networkV),
        e
    }
    toJSON() {
    ...
    static getChainId(t) {
        const e = Vn(t, "v");
        return e == hs || e == fs ? cs : (Pn(e >= ps, "invalid EIP-155 v", "v", t),
        (e - ps) / us)
    }
    ...
    static getNormalizedV(t) {
        const e = Vn(t);
        return e === cs || e === hs ? 27 : e === ls || e === fs ? 28 : (Pn(e >= ps, "invalid v", "v", t),
        e & ls ? 27 : 28)
    }
    static from(e) {
        function n(t, n) {
        ...
        const {networkV: a, v: o} = function(e, r, s) {
            if (null != e) {
                const n = Vn(e);
                return {
            ...
            if (null != r)
                return n(Bn(r, 32), "invalid yParityAndS"),
                {
                    v: 128 & On(r)[0] ? 28 : 27
                };
            if (null != s) {
          ...
          , c = new t(ds,s,i,o);
        return a && on(c, j, a),
        n(null == e.yParity || Zn(e.yParity, "sig.yParity") === c.yParity, "yParity mismatch"),
        n(null == e.yParityAndS || e.yParityAndS === c.yParityAndS, "yParityAndS mismatch"),
        c
    }
}
;
...
let ws = class t {
    constructor(t) {
        an(this, W),
        Pn(32 === Dn(t), "invalid private key", "privateKey", "[REDACTED]"),
        on(this, W, Mn(t))
    }
    get privateKey() {
        return sn(this, W)
    ...
    static recoverPublicKey(t, e) {
        ...
        return Pn(null != s, "invalid signautre for digest", "signature", e),
        "0x" + s.toHex(!1)
    }
...
function vs(t) {
    ...
    for (let s = 0; s < 40; s += 2)
        ...
        (15 & r[s >> 1]) >= 8 && (e[s + 1] = e[s + 1].toUpperCase());
    return "0x" + e.join("")
}
const Es = {};
for (let Vl = 0; Vl < 10; Vl++)
    Es[String(Vl)] = String(Vl);
for (let Vl = 0; Vl < 26; Vl++)
    Es[String.fromCharCode(65 + Vl)] = String(10 + Vl);
const ks = function() {
    const t = {};
    for (let e = 0; e < 36; e++) {
...
function Ps(t) {
    if (Pn("string" == typeof t, "invalid address", "address", t),
    t.match(/^(0x)?[0-9a-fA-F]{40}$/)) {
        t.startsWith("0x") || (t = "0x" + t);
        const e = vs(t);
        return Pn(!t.match(/([A-F].*[a-f])|([a-f].*[A-F])/) || e === t, "bad address checksum", "address", t),
        e
    }
...
async function Ns(t, e) {
    ...
    Pn(!1, "invalid AddressLike value; did not resolve to a value address", "target", t)),
    Ps(n)
}
function Cs(t, e) {
...
function Ds(t, e, n) {
    ...
    if (Array.isArray(n))
        ...
        Pn(!1, "invalid tuple value", "tuple", n);
...
class Us extends jr {
    ...
    encode(t, e) {
        ...
        let r = this.length;
        -1 === r && (r = n.length,
        t.writeValue(n.length)),
        xn(n.length, r, "coder array" + (this.localName ? " " + this.localName : ""));
        let s = [];
    ...
    decode(t) {
        let e = this.length;
        -1 === e && (e = t.readIndex(),
        kn(e * Tr <= t.dataLength, "insufficient data length", "BUFFER_OVERRUN", {
            buffer: t.bytes,
            offset: e * Tr,
            length: t.dataLength
        }));
...
class Hs extends jr {
    ...
    encode(t, e) {
        ...
        return n.length !== this.size && this._throwError("incorrect data length", e),
        t.writeBytes(n)
    }
    decode(t) {
...
class Ks extends jr {
    ...
    encode(t, e) {
        ...
        if (this.signed) {
            ...
            (n > t || n < -(t + Vs)) && this._throwError("value out-of-bounds", e),
            n = Wn(n, 256)
        } else
            (n < Js || n > Jn(r, 8 * this.size)) && this._throwError("value out-of-bounds", e);
        return t.writeValue(n)
    }
    decode(t) {
        let e = Jn(t.readValue(), 8 * this.size);
        return this.signed && (e = jn(e, 8 * this.size)),
        e
    }
}
class Ys extends Gs {
...
const Xs = new Map([[8217, "apostrophe"], [8260, "fraction slash"], [12539, "middle dot"]]);
function _s(t) {
    return function(t) {
        let e = 0;
        return () => t[e++]
...
function Pi(t, e) {
    if (t >= fi && t < 4371 && e >= pi && e < 4470)
        return hi + (t - fi) * mi + (e - pi) * gi;
    if (ki(t) && e > di && e < 4547 && (t - hi) % gi == 0)
        return t + (e - di);
    {
        let n = Ei.get(t);
        return n && (n = n.get(e),
...
function xi(t) {
    Ai || function() {
        ...
        Ai = new Map(ni(t).flatMap(( (t, e) => t.map((t => [t, e + 1 << 24]))))),
        bi = new Set(ei(t)),
        vi = new Map,
        Ei = new Map;
        for (let[e,n] of ri(t)) {
...
function Wi() {
    ...
    for (let {V: u, M: h} of new Set(Gi.values())) {
        let t = [];
        for (let n of u) {
            let e = Ui.filter((t => Bi(t, n)))
              , s = t.find(( ({G: t}) => e.some((e => t.has(e)))));
            s || (s = {
                G: new Set,
                V: []
            },
...
function zi(t, e=1 / 0, n=ci) {
    ...
    for (let o = 0; o < a; o++) {
        let e = t[o];
        Ki(e) && (r.push(li(t.slice(i, o))),
        r.push(n(e)),
        i = o + 1)
    }
    return r.push(li(t.slice(i, a))),
    r.join("")
}
function Ki(t) {
    return Wi(),
...
function Yi(t) {
    return e = function(t, e, n) {
        ...
        return t.split(Oi).map((t => {
            ...
            try {
                ...
                !(i.emoji = a > 1 || r[0].is_emoji) && o.every((t => t < 128)))
                    !function(t) {
                        if (t.length >= 4 && 45 == t[2] && 45 == t[3])
                            throw new Error(`invalid label extension: "${li(t.slice(0, 4))}"`)
                    }(o),
                    t = "ASCII";
                else {
                    ...
                    if (e.length) {
                        if (Fi.has(o[0]))
                            throw Xi("leading combining mark");
                        for (let t = 1; t < a; t++) {
                            let e = r[t];
                            if (!e.is_emoji && Fi.has(e[0]))
                                throw Xi(`emoji + combining mark: "${li(r[t - 1])} + ${zi([e[0]])}"`)
                        }
                        !function(t) {
                            let e = t[0]
                              , n = Xs.get(e);
                        ...
                        let n = Ri(new Set(e))
                          , [s] = function(t) {
                            ...
                            for (let n of t) {
                                ...
                                if (!t.length)
                                    throw Ui.some((t => Bi(t, n))) ? qi(e[0], n) : Zi(n);
                                if (e = t,
                                1 == t.length)
                                    break
                            }
                                ...
                                for (let e = 1, n = t.length; e < n; e++)
                                    if (Di.has(t[e])) {
                                        ...
                                        for (let s; r < n && Di.has(s = t[r]); r++)
                                            for (let n = e; n < r; n++)
                                                if (t[n] == s)
                                                    throw new Error(`duplicate non-spacing marks: ${Ji(s)}`);
                                        if (r - e > 4)
                                            throw new Error(`excessive non-spacing marks: ${Vi(zi(t.slice(e - 1, r)))} (${r - e}/4)`);
                                        e = r
                                    }
                            }
                        }(s, e),
                        function(t, e) {
                            ...
                            for (let s of e) {
                                ...
                                if (t) {
                                    let e = t.M.get(s);
                                    if (n = n ? n.filter((t => e.has(t))) : Ri(e),
                                    !n.length)
                                        return
                                } else
                                    r.push(s)
    ...
    e.map(( ({input: t, error: n, output: r}) => {
        if (n) {
            let r = n.message;
...
function ea(t) {
    return Pn(0 !== t.length, "invalid ENS name; empty component", "comp", t),
    t
}
function na(t) {
    ...
    for (let s = 0; s < e.length; s++) {
        46 === e[s] && (n.push(ea(e.slice(r, s))),
        r = s + 1)
    }
    return Pn(r < e.length, "invalid ENS name; empty component", "name", t),
    n.push(ea(e.slice(r))),
    n
}
function ra(t) {
    Pn("string" == typeof t, "invalid ENS name; not a string", "name", t),
    Pn(t.length, "invalid ENS name (empty label)", "name", t);
    let e = ta;
    const n = na(t);
    for (; n.length; )
        e = es(Fn([e, es(n.pop())]));
...
function sa(t, e) {
    const n = e;
    return Pn(n <= 255, "DNS encoded label cannot exceed 255", "length", n),
    Mn(Fn(na(t).map((e => {
...
function ia(t, e) {
    return {
        address: Ps(t),
        storageKeys: e.map(( (t, e) => (Pn(Bn(t, 32), "invalid slot", `storageKeys[${e}]`, t),
        t.toLowerCase())))
    }
}
function aa(t) {
    if (Array.isArray(t))
        return t.map(( (e, n) => Array.isArray(e) ? (Pn(2 === e.length, "invalid slot set", `value[${n}]`, e),
        ia(e[0], e[1])) : (Pn(null != e && "object" == typeof e, "invalid address-slot set", "value", t),
        ia(e.address, e.storageKeys))));
    Pn(null != t && "object" == typeof t, "invalid access list", "value", t);
    const e = Object.keys(t).map((e => {
        const n = t[e].reduce(( (t, e) => (t[e] = !0,
        t)), {});
...
function oa(t, e) {
    return function(t) {
        let e;
        return e = "string" == typeof t ? ws.computePublicKey(t, !1) : t.publicKey,
        Ps(es("0x" + e.substring(4)).substring(26))
...
function Aa(t, e) {
    if ("0x" === t)
        return ca;
    const n = Vn(t, e);
    return Pn(n <= pa, "value exceeds uint size", e, n),
    n
}
function ba(t, e) {
    const n = Vn(t, "value")
      , r = Xn(n);
    return Pn(r.length <= 32, "value too large", `tx.${e}`, n),
    r
}
function va(t) {
...
function Ea(t, e) {
    ...
    for (let n = 0; n < t.length; n++)
        Pn(Bn(t[n], 32), "invalid ${ param } hash", `value[${n}]`, t[n]);
    return t
}
function ka(t, e) {
    let n;
...
ct = function(t, e) {
    ...
    case 0:
        return function(t, e) {
            ...
            let r = ca;
            if (t.chainId != ca)
                r = Vn(t.chainId, "tx.chainId"),
                Pn(!e || null == e.networkV || e.legacyChainId === r, "tx.chainId/sig.v mismatch", "sig", e);
            else if (t.signature) {
                const e = t.signature.legacyChainId;
                null != e && (r = e)
            }
            if (!e)
                return r !== ca && (n.push(Xn(r)),
                n.push("0x"),
                n.push("0x")),
                Br(n);
            let s = BigInt(27 + e.yParity);
            return r !== ca ? s = ys.getChainIdV(r, e.v) : BigInt(e.v) !== s && Pn(!1, "tx.chainId/sig.v mismatch", "sig", e),
            n.push(Xn(s)),
            n.push(Xn(e.r)),
            n.push(Xn(e.s)),
            Br(n)
    ...
    case 1:
        return function(t, e) {
            ...
            return e && (n.push(ba(e.yParity, "recoveryParam")),
            n.push(Xn(e.r)),
            n.push(Xn(e.s))),
            Fn(["0x01", Br(n)])
        }(this, n);
    case 2:
        return function(t, e) {
            ...
            return e && (n.push(ba(e.yParity, "yParity")),
            n.push(Xn(e.r)),
            n.push(Xn(e.s))),
            Fn(["0x02", Br(n)])
        }(this, n);
    case 3:
        return function(t, e, n) {
            ...
            return e && (r.push(ba(e.yParity, "yParity")),
            r.push(Xn(e.r)),
            r.push(Xn(e.s)),
            n) ? Fn(["0x03", Br([r, n.map((t => t.data)), n.map((t => t.commitment)), n.map((t => t.proof))])]) : Fn(["0x03", Br(r)])
...
let Pa = class t {
    ...
    set blobVersionedHashes(t) {
        if (null != t) {
            Pn(Array.isArray(t), "blobVersionedHashes must be an Array", "value", t),
            t = t.slice();
            for (let e = 0; e < t.length; e++)
                Pn(Bn(t[e], 32), "invalid blobVersionedHash", `value[${e}]`, t[e])
        }
        on(this, st, t)
    }
    get blobs() {
    ...
    set blobs(t) {
        ...
        for (let r = 0; r < t.length; r++) {
            ...
            if (Tn(s)) {
                ...
                let t = On(s);
                if (Pn(t.length <= da, "blob is too large", `blobs[${r}]`, s),
                t.length !== da) {
    ...
    inferTypes() {
        ...
        const s = [];
        return null != this.type ? s.push(this.type) : e ? s.push(2) : t ? (s.push(1),
        n || s.push(0)) : n ? (s.push(1),
        s.push(2)) : (r && this.to || (s.push(0),
        s.push(1),
        s.push(2)),
        s.push(3)),
        s.sort(),
    ...
    static from(e) {
        ...
        if ("string" == typeof e) {
            ...
            if (n[0] >= 127)
                return t.from(function(t) {
                    ...
                    if (s === ca && i === ca)
                        ...
                        t < ca && (t = ca),
                        n.chainId = t,
                        Pn(t !== ca || r === ua || r === ha, "non-canonical legacy v", "v", e[6]),
                        n.signature = ys.from({
                            r: Ln(e[7], 32),
                            s: Ln(e[8], 32),
                            v: r
            ...
            case 1:
                return t.from(function(t) {
                    ...
                    return 8 === e.length || ka(n, e.slice(8)),
                    n
                }(n));
            case 2:
                return t.from(function(t) {
                    ...
                    return 9 === e.length || ka(n, e.slice(9)),
                    n
                }(n));
            case 3:
                return t.from(function(t) {
                    ...
                    if (4 === e.length && Array.isArray(e[0])) {
                        ...
                        const t = e[1]
                          , s = e[2]
                          , i = e[3];
                        Pn(Array.isArray(t), "invalid network format: blobs not an array", "fields[1]", t),
                        Pn(Array.isArray(s), "invalid network format: commitments not an array", "fields[2]", s),
                        Pn(Array.isArray(i), "invalid network format: proofs not an array", "fields[3]", i),
                        Pn(t.length === s.length, "invalid network format: blobs/commitments length mismatch", "fields", e),
                        Pn(t.length === i.length, "invalid network format: blobs/proofs length mismatch", "fields", e),
                        r = [];
                    ...
                    r && (s.blobs = r),
                    Pn(null != s.to, `invalid address for transaction type: ${n}`, "data", t),
                    Pn(Array.isArray(s.blobVersionedHashes), "invalid blobVersionedHashes: must be an array", "data", t);
                    for (let i = 0; i < s.blobVersionedHashes.length; i++)
                        Pn(Bn(s.blobVersionedHashes[i], 32), `invalid blobVersionedHash at index ${i}: must be length 32`, "data", t);
                    return 11 === e.length || ka(s, e.slice(11)),
                    s
                }(n))
            }
            kn(!1, "unsupported transaction type", "UNSUPPORTED_OPERATION", {
        ...
        const n = new t;
        return null != e.type && (n.type = e.type),
        null != e.to && (n.to = e.to),
        null != e.nonce && (n.nonce = e.nonce),
        null != e.gasLimit && (n.gasLimit = e.gasLimit),
        null != e.gasPrice && (n.gasPrice = e.gasPrice),
        null != e.maxPriorityFeePerGas && (n.maxPriorityFeePerGas = e.maxPriorityFeePerGas),
        null != e.maxFeePerGas && (n.maxFeePerGas = e.maxFeePerGas),
        null != e.maxFeePerBlobGas && (n.maxFeePerBlobGas = e.maxFeePerBlobGas),
        null != e.data && (n.data = e.data),
        null != e.value && (n.value = e.value),
        null != e.chainId && (n.chainId = e.chainId),
        null != e.signature && (n.signature = ys.from(e.signature)),
        null != e.accessList && (n.accessList = e.accessList),
        null != e.blobVersionedHashes && (n.blobVersionedHashes = e.blobVersionedHashes),
        null != e.kzg && (n.kzg = e.kzg),
        null != e.blobs && (n.blobs = e.blobs),
        null != e.hash && (Pn(n.isSigned(), "unsigned transaction cannot define '.hash'", "tx", e),
        Pn(n.hash === e.hash, "hash mismatch", "tx", e)),
        null != e.from && (Pn(n.isSigned(), "unsigned transaction cannot define '.from'", "tx", e),
        Pn(n.from.toLowerCase() === (e.from || "").toLowerCase(), "from mismatch", "tx", e)),
        n
    }
}
;
...
function Fa(t) {
    return function(e) {
        return Pn("string" == typeof e, `invalid domain value for ${JSON.stringify(t)}`, `domain.${t}`, e),
        e
    }
}
const Da = {
    ...
    chainId: function(t) {
        ...
        return Pn(e >= 0, "invalid chain ID", "domain.chainId", t),
        Number.isSafeInteger(e) ? Number(e) : _n(e)
    },
    ...
    salt: function(t) {
        ...
        return Pn(32 === e.length, 'invalid domain value "salt"', "domain.salt", t),
        Mn(e)
    }
};
function Sa(t) {
    {
        ...
        if (e) {
            ...
            return function(e) {
                const r = Vn(e, "value");
                return Pn(r >= i && r <= s, `value out-of-bounds for ${t}`, "value", r),
                qn(n ? Wn(r, 256) : r, 32)
            }
        }
    }
...
pt = function(t) {
    ...
    if (e) {
        ...
        return r => {
            ...
            let s = r.map(n);
            return sn(this, ut).has(t) && (s = s.map(es)),
            es(Fn(s))
        }
    }
...
let Ga = class t {
    constructor(t) {
        ...
        Object.keys(t).forEach((i => {
            s[i] = t[i].map(( ({name: e, type: n}) => {
                let {base: r, index: s} = La(n);
                return "int" !== r || t.int || (r = "int256"),
        ...
        for (const a in s) {
            const r = new Set;
            for (const i of s[a]) {
                Pn(!r.has(i.name), `duplicate variable name ${JSON.stringify(i.name)} in ${JSON.stringify(a)}`, "types", t),
                r.add(i.name);
                const s = La(i.type).base;
                Pn(s !== a, `circular type reference to ${JSON.stringify(s)}`, "types", t);
                Sa(s) || (Pn(n.has(s), `unknown type ${JSON.stringify(s)}`, "types", t),
                n.get(s).push(a),
                e.get(a).add(s))
            }
        }
        const i = Array.from(n.keys()).filter((t => 0 === n.get(t).length));
        Pn(0 !== i.length, "missing primary type", "types", t),
        Pn(1 === i.length, `ambiguous primary types or unused types: ${i.map((t => JSON.stringify(t))).join(", ")}`, "types", t),
        wn(this, {
            primaryType: i[0]
        }),
        function s(i, a) {
            Pn(!a.has(i), `circular type reference to ${JSON.stringify(i)}`, "types", t),
            a.add(i);
        ...
        for (const [a,o] of r) {
            ...
            t.sort(),
            sn(this, ut).set(a, Ua(a, s[a]) + t.map((t => Ua(t, s[t]))).join(""))
        }
    }
    get types() {
    ...
    getEncoder(t) {
        ...
        return e || (e = cn(this, ft, pt).call(this, t),
        sn(this, ht).set(t, e)),
        e
    }
    encodeType(t) {
        const e = sn(this, ut).get(t);
        return Pn(e, `unknown type: ${JSON.stringify(t)}`, "name", t),
        e
    }
    encodeData(t, e) {
    ...
    _visit(t, e, n) {
        ...
        const r = La(t).array;
        if (r)
            return Pn(-1 === r.count || r.count === e.length, `array length mismatch; expected length ${r.count}`, "value", e),
            e.map((t => this._visit(r.prefix, t, n)));
        const s = this.types[t];
        if (s)
            return s.reduce(( (t, {name: r, type: s}) => (t[r] = this._visit(s, e[r], n),
            t)), {});
        Pn(!1, `unknown type: ${t}`, "type", t)
    }
    visit(t, e) {
    ...
    static hashDomain(e) {
        ...
        for (const t in e) {
            if (null == e[t])
                continue;
            const r = Ia[t];
            Pn(r, `invalid typed-data domain key: ${JSON.stringify(t)}`, "domain", e),
            n.push({
                name: t,
                type: r
            })
        }
        return n.sort(( (t, e) => Ma.indexOf(t.name) - Ma.indexOf(e.name))),
    ...
    static async resolveNames(e, n, r, s) {
        ...
        const a = t.from(n);
        a.visit(r, ( (t, e) => ("address" !== t || Bn(e, 20) || (i[e] = "0x"),
        e)));
        for (const t in i)
            i[t] = await s(t);
    ...
    static getPayload(e, n, r) {
        ...
        return Pn(null == o.EIP712Domain, "types must not contain EIP712Domain type", "types.EIP712Domain", n),
        o.EIP712Domain = i,
        a.encode(r),
        {
            types: o,
            ...
            message: a.visit(r, ( (t, e) => {
                ...
                case "bool":
                    return !!e;
                case "string":
                    return Pn("string" == typeof e, "invalid string", "value", e),
                    e
                }
  ...
  , eo = class t {
    ...
    popParams() {
        ...
        for (; sn(this, dt) < t.match - 1; ) {
            ...
            e.push(cn(this, mt, yt).call(this, sn(this, dt) + 1, t)),
            on(this, dt, t)
        }
        return on(this, dt, t.match + 1),
        e
    ...
    peek() {
        if (sn(this, dt) >= sn(this, gt).length)
...
function oo(t) {
    let e = ao(t, Wa);
    return so(e, Qa("constant payable nonpayable".split(" "))),
    so(e, Qa("pure view payable nonpayable".split(" "))),
...
let ko = class t {
    ...
    format(t) {
        ...
        "json" === t) {
            ...
            return "boolean" == typeof this.indexed && (n.indexed = this.indexed),
            this.isTuple() && (n.components = this.components.map((e => JSON.parse(e.format(t))))),
            JSON.stringify(n)
        }
        let e = "";
        return this.isArray() ? (e += this.arrayChildren.format(t),
        e += `[${this.arrayLength < 0 ? "" : String(this.arrayLength)}]`) : this.isTuple() ? e += "(" + this.components.map((e => e.format(t))).join("full" === t ? ", " : ",") + ")" : e += this.type,
        "sighash" !== t && (!0 === this.indexed && (e += " indexed"),
    ...
    static from(e, n) {
        ...
        if ("string" == typeof e)
            ...
            let r = ""
              , s = ""
              , i = null;
            ao(e, Qa(["tuple"])).has("tuple") || e.peekType("OPEN_PAREN") ? (s = "tuple",
            i = e.popParams().map((e => t.from(e))),
            r = `tuple(${i.map((t => t.format())).join(",")})`) : (r = fo(e.popType("TYPE")),
            s = r);
            let a = null
              , o = null;
            for (; e.length && e.peekType("BRACKET"); ) {
                const n = e.pop();
                a = new t(po,"",r,s,null,i,o,a),
                o = n.value,
                r += n.text,
                s = "array",
                i = null
        ...
        let s = e.indexed;
        null != s && (Pn(n, "parameter cannot be indexed", "obj.indexed", e.indexed),
        s = !!s);
        let i = e.type
          , a = i.match(ho);
        if (a) {
        ...
        return i = fo(e.type),
        new t(po,r || "",i,i,s,null,null,null)
    }
...
class xo extends Po {
    constructor(t, e, n, r) {
        super(t, e, r),
        nn(this, "name"),
        Pn("string" == typeof n && n.match($a), "invalid identifier", "name", n),
...
class Co extends xo {
    ...
    format(t) {
        ...
        const e = [];
        return "sighash" !== t && e.push("error"),
        e.push(this.name + No(t, this.inputs)),
        e.join(" ")
    }
    static from(t) {
        if (Co.isFragment(t))
...
class Ro extends Po {
    ...
    format(t) {
        ...
        return this.payable && e.push("payable"),
    ...
    static from(t) {
        ...
        if ("string" == typeof t)
            ...
            if ("receive" === t.popKeyword(Qa(["fallback", "receive"]))) {
                const e = co(t);
                return Pn(0 === e.length, "receive cannot have arguments", "obj.inputs", e),
                ao(t, Qa(["payable"])),
                uo(t),
                new Bo(po,[],!0)
            }
            ...
            const r = oo(t);
            if (Pn("nonpayable" === r || "payable" === r, "fallback cannot be constants", "obj.stateMutability", r),
            ao(t, Qa(["returns"])).has("returns")) {
                const e = co(t);
                Pn(1 === e.length && "bytes" === e[0].type, "invalid fallback outputs", "obj.outputs", e.map((t => t.format("minimal"))).join(", "))
            }
            return uo(t),
            new Bo(po,n,"payable" === r)
        }
        if ("receive" === t.type)
            return new Bo(po,[],!0);
        if ("fallback" === t.type) {
...
class To extends xo {
    ...
    format(t) {
        ...
        const e = [];
        return "sighash" !== t && e.push("function"),
        e.push(this.name + No(t, this.inputs)),
        "sighash" !== t && ("nonpayable" !== this.stateMutability && e.push(this.stateMutability),
        this.outputs && this.outputs.length && (e.push("returns"),
        e.push(No(t, this.outputs))),
        null != this.gas && e.push(`@${this.gas.toString()}`)),
        e.join(" ")
    }
    ...
    static from(t) {
        ...
        return null == e && (e = "payable",
        "boolean" == typeof t.constant ? (e = "view",
        t.constant || (e = "payable",
        "boolean" != typeof t.payable || t.payable || (e = "nonpayable"))) : "boolean" != typeof t.payable || t.payable || (e = "nonpayable")),
        new To(po,t.name,e,t.inputs ? t.inputs.map(ko.from) : [],t.outputs ? t.outputs.map(ko.from) : [],null != t.gas ? t.gas : null)
    }
    static isFragment(t) {
        return t && t[go] === vo
    }
...
const Mo = new Map;
Mo.set(0, "GENERIC_PANIC"),
Mo.set(1, "ASSERT_FALSE"),
Mo.set(17, "OVERFLOW"),
Mo.set(18, "DIVIDE_BY_ZERO"),
Mo.set(33, "ENUM_RANGE_ERROR"),
Mo.set(34, "BAD_STORAGE_DATA"),
Mo.set(49, "STACK_UNDERFLOW"),
Mo.set(50, "ARRAY_RANGE_ERROR"),
Mo.set(65, "OUT_OF_MEMORY"),
Mo.set(81, "UNINITIALIZED_FUNCTION_CALL");
...
vt = function(t) {
    if (t.isArray())
        return new Us(cn(this, bt, vt).call(this, t.arrayChildren),t.arrayLength,t.name);
    if (t.isTuple())
        return new Zs(t.components.map((t => cn(this, bt, vt).call(this, t))),t.name);
    switch (t.baseType) {
    case "address":
    ...
    if (e) {
        ...
        return Pn(0 !== n && n <= 256 && n % 8 == 0, "invalid " + e[1] + " bit length", "param", t),
        new Ks(n / 8,"int" === e[1],t.name)
    }
    if (e = t.type.match(Fo),
    e) {
        let n = parseInt(e[1]);
        return Pn(0 !== n && n <= 32, "invalid bytes length", "param", t),
        new Hs(n,t.name)
    }
...
let Lo = class t {
    ...
    static _setDefaultMaxInflation(t) {
        Pn("number" == typeof t && Number.isInteger(t), "invalid defaultMaxInflation factor", "value", t),
        Uo = t
    }
    static defaultAbiCoder() {
        return null == So && (So = new t),
        So
    }
    static getBuiltinCallException(e, n, r) {
        return function(t, e, n, r) {
            ...
            if (n) {
                ...
                else if ("0x08c379a0" === Mn(t.slice(0, 4)))
                    try {
                ...
                else if ("0x4e487b71" === Mn(t.slice(0, 4)))
                    try {
                        ...
                        i = `Panic due to ${Mo.get(e) || "UNKNOWN"}(${e})`,
                        s += `: ${i}`
                    } catch (c) {
            ...
            return e.from && (o.from = Ps(e.from)),
            En(s, "CALL_EXCEPTION", {
                action: t,
                data: n,
                reason: i,
  ...
  , Jo = {
    ...
    "0x4e487b71": {
        ...
        reason: t => {
            ...
            return t >= 0 && t <= 255 && Wo[t.toString()] && (e = Wo[t.toString()]),
...
Ct = function(t, e, n) {
    ...
    if (-1 === t.indexOf("(")) {
        const r = [];
        for (const [e,n] of sn(this, Pt))
            e.split("(")[0] === t && r.push(n);
        if (e) {
            const t = e.length > 0 ? e[e.length - 1] : null;
            let n = e.length
              , s = !0;
            Is.isTyped(t) && "overrides" === t.type && (s = !1,
            n--);
...
let Vo = class t {
    constructor(t) {
        ...
        this.fragments.forEach(( (t, e) => {
            ...
            case "fallback":
                return void (0 === t.inputs.length ? s = !0 : (Pn(!r || t.payable !== r.payable, "conflicting fallback fragments", `fragments[${e}]`, t),
                r = t,
                s = r.payable));
            case "function":
                n = sn(this, Pt);
    ...
    getFunctionName(t) {
        ...
        return Pn(e, "no matching function", "key", t),
        e.name
    }
    hasFunction(t) {
    ...
    getEventName(t) {
        ...
        return Pn(e, "no matching event", "key", t),
        e.name
    }
    hasEvent(t) {
    ...
    getError(t, e) {
        ...
        if (-1 === t.indexOf("(")) {
            const e = [];
            for (const [n,r] of sn(this, Et))
                n.split("(")[0] === t && e.push(r);
            if (0 === e.length)
                return "Error" === t ? Co.from("error Error(string)") : "Panic" === t ? Co.from("error Panic(uint256)") : null;
            if (e.length > 1) {
                Pn(!1, `ambiguous error description (i.e. ${e.map((t => JSON.stringify(t.format()))).join(", ")})`, "name", t)
            }
            return e[0]
        }
        if ("Error(string)" === (t = Co.from(t).format()))
            return Co.from("error Error(string)");
        if ("Panic(uint256)" === t)
            return Co.from("error Panic(uint256)");
    ...
    decodeErrorResult(t, e) {
        if ("string" == typeof t) {
            ...
            Pn(e, "unknown error", "fragment", t),
            t = e
        }
        return Pn(Sn(e, 0, 4) === t.selector, `data signature does not match error ${t.name}.`, "data", e),
        this._decodeParams(t.inputs, Sn(e, 4))
    }
    ...
    decodeFunctionData(t, e) {
        if ("string" == typeof t) {
            ...
            Pn(e, "unknown function", "fragment", t),
            t = e
        }
        return Pn(Sn(e, 0, 4) === t.selector, `data signature does not match function ${t.name}.`, "data", e),
        this._decodeParams(t.inputs, Sn(e, 4))
    }
    ...
    encodeFilterTopics(t, e) {
        if ("string" == typeof t) {
            ...
            Pn(e, "unknown event", "eventFragment", t),
            t = e
        }
        ...
        const r = (t, e) => "string" === t.type ? qs(e) : "bytes" === t.type ? es(Mn(e)) : ("bool" === t.type && "boolean" == typeof e ? e = e ? "0x01" : "0x00" : t.type.match(/^u?int/) ? e = qn(e) : t.type.match(/^bytes/) ? e = Un(e, 32, !1) : "address" === t.type && sn(this, xt).encode(["address"], [e]),
        Ln(Mn(e), 32));
        for (e.forEach(( (e, s) => {
            const i = t.inputs[s];
    ...
    encodeEventLog(t, e) {
        ...
        Pn(e.length === t.inputs.length, "event arguments/values mismatch", "values", e),
    ...
    decodeEventLog(t, e, n) {
        ...
        if (null != n && !t.anonymous) {
            const e = t.topicHash;
            Pn(Bn(n[0], 32) && n[0].toLowerCase() === e, "fragment/topic mismatch", "topics[0]", n[0]),
            n = n.slice(1)
        }
        const r = []
          , s = []
...
class Zo {
    constructor(t, e, n) {
        nn(this, "gasPrice"),
        nn(this, "maxFeePerGas"),
        nn(this, "maxPriorityFeePerGas"),
        wn(this, {
            gasPrice: Ko(t),
            maxFeePerGas: Ko(e),
...
function qo(t) {
    ...
    t.data && (e.data = Mn(t.data));
    const n = "chainId,gasLimit,gasPrice,maxFeePerBlobGas,maxFeePerGas,maxPriorityFeePerGas,value".split(/,/);
    for (const s of n)
        s in t && null != t[s] && (e[s] = Vn(t[s], `request.${s}`));
    const r = "type,nonce".split(/,/);
    for (const s of r)
        s in t && null != t[s] && (e[s] = Zn(t[s], `request.${s}`));
    return t.accessList && (e.accessList = aa(t.accessList)),
    ...
    "blobVersionedHashes"in t && t.blobVersionedHashes && (e.blobVersionedHashes = t.blobVersionedHashes.slice()),
    "kzg"in t && (e.kzg = t.kzg),
    "blobs"in t && t.blobs && (e.blobs = t.blobs.map((t => Tn(t) ? Mn(t) : Object.assign({}, t)))),
    e
}
class Xo {
    constructor(t, e) {
        ...
        nn(this, "timestamp"),
        nn(this, "parentHash"),
        nn(this, "parentBeaconBlockRoot"),
        nn(this, "nonce"),
        nn(this, "difficulty"),
        nn(this, "gasLimit"),
        nn(this, "gasUsed"),
        nn(this, "stateRoot"),
        nn(this, "receiptsRoot"),
        nn(this, "blobGasUsed"),
        nn(this, "excessBlobGas"),
        nn(this, "miner"),
        nn(this, "prevRandao"),
        nn(this, "extraData"),
        nn(this, "baseFeePerGas"),
        an(this, Rt),
        on(this, Rt, t.transactions.map((t => "string" != typeof t ? new tc(t,e) : t))),
        wn(this, {
            provider: e,
            hash: Ko(t.hash),
            number: t.number,
    ...
    toJSON() {
        const {baseFeePerGas: t, difficulty: e, extraData: n, gasLimit: r, gasUsed: s, hash: i, miner: a, prevRandao: o, nonce: c, number: l, parentHash: u, parentBeaconBlockRoot: h, stateRoot: f, receiptsRoot: p, timestamp: d, transactions: g} = this;
        return {
            _type: "Block",
            baseFeePerGas: Yo(t),
            difficulty: Yo(e),
...
class _o {
    ...
    toJSON() {
        const {address: t, blockHash: e, blockNumber: n, data: r, index: s, removed: i, topics: a, transactionHash: o, transactionIndex: c} = this;
        return {
            _type: "log",
            address: t,
            blockHash: e,
    ...
    async getBlock() {
        ...
        return kn(!!t, "failed to find transaction", "UNKNOWN_ERROR", {}),
        t
    }
    ...
    async getTransactionReceipt() {
        ...
        return kn(!!t, "failed to find transaction receipt", "UNKNOWN_ERROR", {}),
        t
    }
    removedEvent() {
        return {
...
class $o {
    constructor(t, e) {
        ...
        nn(this, "gasUsed"),
        nn(this, "blobGasUsed"),
        nn(this, "cumulativeGasUsed"),
        nn(this, "gasPrice"),
        nn(this, "blobGasPrice"),
        nn(this, "type"),
        nn(this, "status"),
        nn(this, "root"),
        an(this, Bt),
        on(this, Bt, Object.freeze(t.logs.map((t => new _o(t,e)))));
        let n = zo;
    ...
    toJSON() {
        const {to: t, from: e, contractAddress: n, hash: r, index: s, blockHash: i, blockNumber: a, logsBloom: o, logs: c, status: l, root: u} = this;
        return {
...
let tc = class t {
    constructor(t, e) {
        ...
        nn(this, "maxPriorityFeePerGas"),
        nn(this, "maxFeePerGas"),
        nn(this, "maxFeePerBlobGas"),
        nn(this, "data"),
        nn(this, "value"),
        nn(this, "chainId"),
        nn(this, "signature"),
        nn(this, "accessList"),
        nn(this, "blobVersionedHashes"),
        an(this, Tt),
        this.provider = e,
        ...
        this.maxFeePerGas = null != t.maxFeePerGas ? t.maxFeePerGas : null,
        this.maxFeePerBlobGas = null != t.maxFeePerBlobGas ? t.maxFeePerBlobGas : null,
    ...
    toJSON() {
        const {blockNumber: t, blockHash: e, index: n, hash: r, type: s, to: i, from: a, nonce: o, data: c, signature: l, accessList: u, blobVersionedHashes: h} = this;
        return {
    ...
    async wait(t, e) {
                ...
                i < sn(this, Tt) && (i = sn(this, Tt))); i <= t; ) {
                    ...
                    for (let r = 0; r < e.length; r++) {
                        ...
                        if (i.from === this.from && i.nonce === this.nonce) {
                            ...
                            if (null == e)
                                return;
                            if (t - e.blockNumber + 1 < n)
                                return;
                            let r = "replaced";
                            i.data === this.data && i.to === this.to && i.value === this.value ? r = "repriced" : "0x" === i.data && i.from === i.to && i.value === zo && (r = "cancelled"),
                            kn(!1, "transaction was replaced", "TRANSACTION_REPLACED", {
        ...
        const u = new Promise(( (t, e) => {
            ...
            r > 0) {
                const t = setTimeout(( () => {
                    l(),
                    e(En("wait for transaction timeout", "TIMEOUT"))
                }
                ), r);
                i.push(( () => {
                    clearTimeout(t)
...
async function wc(t, e) {
    ...
    const r = qo(n);
    return Pn(null == r.to || (e || []).indexOf("to") >= 0, "cannot override to", "overrides.to", r.to),
    Pn(null == r.data || (e || []).indexOf("data") >= 0, "cannot override data", "overrides.data", r.data),
...
function Ac(t) {
    const e = async function(e) {
        ...
        n.from && (n.from = await Cs(n.from, dc(t.runner)));
        const r = t.interface
          , s = Vn(n.value || lc, "overrides.value") === lc
          , i = "0x" === (n.data || "0x");
        !r.fallback || r.fallback.payable || !r.receive || i || s || Pn(!1, "cannot send data to receive or send value to non-payable fallback", "overrides", e),
        Pn(r.fallback || i, "cannot send data to receive-only contract", "overrides.data", n.data);
        return Pn(r.receive || r.fallback && r.fallback.payable || s, "cannot send value to non-payable fallback", "overrides.value", n.value),
        Pn(r.fallback || i, "cannot send data to receive-only contract", "overrides.data", n.data),
        n
    }
      , n = async function(n) {
...
function bc(t, e) {
    const n = function(...n) {
      ...
      , r = async function(...e) {
        const r = n(...e);
        let s = {};
        if (r.inputs.length + 1 === e.length && (s = await wc(e.pop()),
        s.from && (s.from = await Cs(s.from, dc(t.runner)))),
        r.inputs.length !== e.length)
            throw new Error("internal error: fragment inputs doesn't match arguments; should not happen");
        const i = await async function(t, e, n) {
            const r = mc(t, "resolveName")
              , s = fc(r) ? r : null;
            return await Promise.all(e.map(( (t, e) => t.walkAsync(n[e], ( (t, e) => (e = Is.dereference(e, t),
            "address" === t ? Cs(e, s) : e))))))
        }(t.runner, r.inputs, e);
...
async function Pc(t, e) {
    ...
    if (Array.isArray(e)) {
        const r = function(e) {
            ...
            return Pn(n, "unknown fragment", "name", e),
            n.topicHash
        };
        n = e.map((t => null == t ? null : Array.isArray(t) ? t.map(r) : r(t)))
    } else
        "*" === e ? n = [null] : "string" == typeof e ? Bn(e, 32) ? n = [e] : (r = t.interface.getEvent(e),
        Pn(r, "unknown fragment", "event", e),
        n = [r.topicHash]) : (s = e) && "object" == typeof s && "getTopicFilter"in s && "function" == typeof s.getTopicFilter && s.fragment ? n = await e.getTopicFilter() : "fragment"in e ? (r = e.fragment,
        n = [r.topicHash]) : Pn(!1, "unknown event name", "event", e);
    var s;
    n = n.map((t => {
        if (null == t)
            return null;
...
async function Nc(t, e, n) {
    ...
    const {fragment: s, tag: i, topics: a} = await Pc(t, n)
      , {addr: o, subs: c} = kc(t);
    let l = c.get(i);
    if (!l) {
        const e = {
...
async function Oc(t, e, n, r) {
    ...
    const s = async function(t, e, n, r) {
        ...
        0 === s.listeners.length && (s.stop(),
        kc(t).subs.delete(s.tag)),
        a > 0
    }(t, e, n, r);
    return Cc = s,
    await s
...
let Bc = class t {
    constructor(t, e, n, r) {
        ...
        nn(this, Dt),
        nn(this, "fallback"),
        Pn("string" == typeof t || xs(t), "invalid value for Contract target", "target", t),
        null == n && (n = null);
        const s = Vo.from(e);
        let i;
        wn(this, {
        ...
        return wn(this, {
            filters: new Proxy({},{
                get: (t, e, n) => {
                    if ("symbol" == typeof e || Rc.indexOf(e) >= 0)
                        return Reflect.get(t, e, n);
                    try {
                        return this.getEvent(e)
                    } catch (r) {
                        if (!bn(r, "INVALID_ARGUMENT") || "key" !== r.argument)
                            throw r
                    }
                }
                ,
        ...
        new Proxy(this,{
            get: (t, e, n) => {
                if ("symbol" == typeof e || e in t || Rc.indexOf(e) >= 0)
                    return Reflect.get(t, e, n);
                try {
    ...
    async queryFilter(t, e, n) {
        null == e && (e = 0),
        null == n && (n = "latest");
        const {addr: r, addrPromise: s} = kc(this)
          , i = r || await s
          , {fragment: a, topics: o} = await Pc(this, t)
          , c = {
            address: i,
            topics: o,
            fromBlock: e,
    ...
    async off(t, e) {
        ...
        return null != e && 0 !== n.listeners.length || (n.stop(),
        kc(this).subs.delete(n.tag)),
        this
    }
    async removeAllListeners(t) {
        if (t) {
            ...
            if (!e)
                return this;
            e.stop(),
            kc(this).subs.delete(e.tag)
        } else {
            const {subs: t} = kc(this);
            for (const {tag: e, stop: n} of t.values())
                n(),
                t.delete(e)
        }
        return this
...
function Ic(t) {
    return t.match(/^ipfs:\/\/ipfs\//i) ? t = t.substring(12) : t.match(/^ipfs:\/\//i) ? t = t.substring(7) : Pn(!1, "unsupported IPFS format", "link", t),
...
const Fc = new RegExp("^(ipfs)://(.*)$","i")
  ...
  , Sc = class t {
    constructor(t, e, n) {
        ...
        on(this, St, null),
        on(this, Ut, new Tc(e,["function supportsInterface(bytes4) view returns (bool)", "function resolve(bytes, bytes) view returns (bytes)", "function addr(bytes32) view returns (address)", "function addr(bytes32, uint) view returns (bytes)", "function text(bytes32, string) view returns (string)", "function contenthash(bytes32) view returns (bytes)"],t))
    }
    async supportsWildcard() {
        return null == sn(this, St) && on(this, St, (async () => {
            try {
                ...
                if (bn(t, "CALL_EXCEPTION"))
                    return !1;
                throw on(this, St, null),
                t
            }
        }
        )()),
    ...
    async _getAvatar() {
        ...
        try {
            ...
            for (let s = 0; s < Dc.length; s++) {
                ...
                case "erc1155":
                    {
                        const s = "erc721" === a ? "tokenURI(uint256)" : "uri(uint256)";
                        t.push({
                            type: a,
                            value: r
                        });
                        ...
                        "erc1155" === a && (h = h.replace("{id}", qn(l, 32).substring(2)),
                        t.push({
...
Gt = async function(t, e) {
    ...
    let r = null;
    await this.supportsWildcard() && (r = n.getFunction(t),
    kn(r, "missing fragment", "UNKNOWN_ERROR", {
        info: {
            funcName: t
        }
    }),
    e = [sa(this.name, 255), n.encodeFunctionData(r, e)],
    ...
    return n => {
        ...
        for (const i in t) {
            ...
            try {
                ...
                kn(!1, `invalid value for value.${i} (${sinstanceof Error ? s.message : "not-an-error"})`, "BAD_DATA", {
                    value: n
                })
            }
        }
...
function jc(t) {
    return Pn(Bn(t, !0), "invalid data", "value", t),
    t
}
function Wc(t) {
    return Pn(Bn(t, 32), "invalid hash", "value", t),
    t
}
const Jc = Hc({
    address: Ps,
...
function Yc(t) {
    ...
    if (null == e.to && null == e.creates && (e.creates = function(t) {
        ...
        return n = "0" === n ? "0x" : n.length % 2 ? "0x0" + n : "0x" + n,
        Ps(Sn(es(Br([e, n])), 12))
    }(e)),
    1 !== t.type && 2 !== t.type || null != t.accessList || (e.accessList = []),
    t.signature ? e.signature = ys.from(t.signature) : e.signature = ys.from(t),
    null == e.chainId) {
        const t = e.signature.legacyChainId;
        null != t && (e.chainId = t)
    }
    return e.blockHash && Vn(e.blockHash) === Lc && (e.blockHash = null),
    e
}
class Zc {
    constructor(t) {
...
class qc extends Zc {
    constructor(t, e) {
        ...
        nn(this, "effectiveBlock"),
        nn(this, "txBase"),
        nn(this, "txCreate"),
        nn(this, "txDataZero"),
        nn(this, "txDataNonzero"),
        nn(this, "txAccessListStorageKey"),
        nn(this, "txAccessListAddress");
        const n = {
            effectiveBlock: t
        };
        function r(t, r) {
            let s = (e || {})[t];
            null == s && (s = r),
            Pn("number" == typeof s, `invalud value for ${t}`, "costs", e),
            n[t] = s
        }
        r("txBase", 21e3),
        r("txCreate", 32e3),
...
let tl = class t {
    ...
    attachPlugin(t) {
        if (sn(this, zt).get(t.name))
            throw new Error(`cannot replace existing plugin: ${t.name} `);
        return sn(this, zt).set(t.name, t.clone()),
        this
    }
    getPlugin(t) {
    ...
    computeIntrinsicGas(t) {
        ...
        let n = e.txBase;
        if (null == t.to && (n += e.txCreate),
        t.data)
            for (let r = 2; r < t.data.length; r += 2)
                "00" === t.data.substring(r, r + 2) ? n += e.txDataZero : n += e.txDataNonzero;
        if (t.accessList) {
            const r = aa(t.accessList);
            for (const t in r)
                n += e.txAccessListAddress + e.txAccessListStorageKey * r[t].storageKeys.length
        }
        return n
    }
    static from(e) {
        if (function() {
            ...
            function t(t, e, n) {
                const r = function() {
                    const r = new tl(t,e);
                    return null != n.ensNetwork && r.attachPlugin(new Xc(null,n.ensNetwork)),
                    r.attachPlugin(new qc),
                    (n.plugins || []).forEach((t => {
                        r.attachPlugin(t)
                    }
                    )),
                ...
                tl.register(t, r),
                tl.register(e, r),
                n.altNames && n.altNames.forEach((t => {
                    tl.register(t, r)
                }
                ))
            }
        ...
        null == e)
            return t.from("mainnet");
        if ("number" == typeof e && (e = BigInt(e)),
        "string" == typeof e || "bigint" == typeof e) {
            const n = $c.get(e);
            if (n)
                return n();
            if ("bigint" == typeof e)
                return new t("unknown",e);
        ...
        if ("object" == typeof e) {
            ...
            return (e.ensAddress || null != e.ensNetwork) && n.attachPlugin(new Xc(e.ensAddress,e.ensNetwork)),
            n
        }
    ...
    static register(t, e) {
        ...
        const n = $c.get(t);
        n && Pn(!1, `conflicting network for ${JSON.stringify(n.name)}`, "nameOrChainId", t),
        $c.set(t, e)
    }
}
;
...
class il {
    ...
    start() {
        sn(this, Yt) || (on(this, Yt, sn(this, Kt)._setTimeout(cn(this, Xt, _t).bind(this), sn(this, Zt))),
        cn(this, Xt, _t).call(this))
    }
    stop() {
        sn(this, Yt) && (sn(this, Kt)._clearTimeout(sn(this, Yt)),
        on(this, Yt, null))
    }
    pause(t) {
        this.stop(),
...
class al {
    ...
    start() {
        sn(this, ee) || (on(this, ee, !0),
        sn(this, te).call(this, -2),
        sn(this, $t).on("block", sn(this, te)))
    }
    stop() {
        sn(this, ee) && (on(this, ee, !1),
        sn(this, $t).off("block", sn(this, te)))
    }
    pause(t) {
        this.stop()
    }
...
class ol extends al {
    ...
    async _poll(t, e) {
        ...
        null != n && (-2 === sn(this, re) ? on(this, re, n.number) : n.number > sn(this, re) && (e.emit(sn(this, ne), n.number),
        on(this, re, n.number)))
    }
}
ne = new WeakMap,
...
class ul {
    constructor(t, e) {
        ...
        on(this, ae, t),
        on(this, oe, sl(e)),
        on(this, ce, cn(this, he, fe).bind(this)),
        on(this, le, !1),
        on(this, ue, -2)
    }
    start() {
        sn(this, le) || (on(this, le, !0),
        -2 === sn(this, ue) && sn(this, ae).getBlockNumber().then((t => {
            on(this, ue, t)
        }
        )),
    ...
    stop() {
        sn(this, le) && (on(this, le, !1),
        sn(this, ae).off("block", sn(this, ce)))
    }
    pause(t) {
        this.stop(),
        t && on(this, ue, -2)
...
fe = async function(t) {
    ...
    e.fromBlock = sn(this, ue) + 1,
    e.toBlock = t;
    const n = await sn(this, ae).getLogs(e);
    if (0 !== n.length)
        for (const r of n)
            sn(this, ae).emit(sn(this, oe), r),
            on(this, ue, r.blockNumber);
    else
        sn(this, ue) < t - 60 && on(this, ue, t - 60)
}
;
const hl = BigInt(2);
function fl(t) {
...
function gl(t) {
    return (t = Array.from(new Set(t).values())).sort(),
    t
}
async function ml(t, e) {
    ...
    if (t.address || t.topics) {
        ...
        if (n.address) {
            ...
            r.address = gl(t.map((t => t.toLowerCase())))
        }
        return {
            filter: r,
            tag: pl("event", r),
...
class Al {
    ...
    attachPlugin(t) {
        if (sn(this, de).get(t.name))
            throw new Error(`cannot replace existing plugin: ${t.name} `);
        return sn(this, de).set(t.name, t.connect(this)),
        this
    }
    getPlugin(t) {
    ...
    _wrapBlock(t, e) {
        return new Xo(function(t) {
            const e = Vc(t);
            return e.transactions = t.transactions.map((t => "string" == typeof t ? t : Yc(t))),
            e
        }(t),this)
    }
    _wrapLog(t, e) {
    ...
    async getBlockNumber() {
        ...
        return sn(this, be) >= 0 && on(this, be, t),
        t
    }
    _getAddress(t) {
        return Cs(t, this)
    ...
    _getBlockTag(t) {
        ...
        return Bn(t) ? Bn(t, 32) ? t : _n(t) : ("bigint" == typeof t && (t = Zn(t, "blockTag")),
        "number" == typeof t ? t >= 0 ? _n(t) : sn(this, be) >= 0 ? _n(sn(this, be) + t) : this.getBlockNumber().then((e => _n(e + t))) : void Pn(!1, "invalid blockTag", "blockTag", t))
    }
    _getFilter(t) {
        ...
        if (t.address)
            if (Array.isArray(t.address))
                for (const o of t.address)
                    a.push(this._getAddress(o));
            else
                a.push(this._getAddress(t.address));
        return "fromBlock"in t && (s = this._getBlockTag(t.fromBlock)),
        "toBlock"in t && (i = this._getBlockTag(t.toBlock)),
        a.filter((t => "string" != typeof t)).length || null != s && "string" != typeof s || null != i && "string" != typeof i ? Promise.all([Promise.all(a), s, i]).then((t => r(t[0], t[1], t[2]))) : r(a, s, i)
    }
    ...
    async getNetwork() {
        if (null == sn(this, ye)) {
            const t = (async () => {
                try {
                    ...
                    return this.emit("network", t, null),
                    t
                } catch (e) {
                    throw sn(this, ye) === t && on(this, ye, null),
                    e
                }
            }
            )();
        ...
        return e.chainId !== n.chainId && (sn(this, we) ? (this.emit("network", n, e),
        sn(this, ye) === t && on(this, ye, Promise.resolve(n))) : kn(!1, `network changed: ${e.chainId} => ${n.chainId} `, "NETWORK_ERROR", {
            event: "changed"
        })),
        e.clone()
    }
    async getFeeData() {
        const t = await this.getNetwork()
          , e = async () => {
            const {_block: e, gasPrice: n, priorityFee: r} = await yn({
            ...
            return a && a.baseFeePerGas && (i = null != r ? r : BigInt("1000000000"),
            s = a.baseFeePerGas * hl + i),
            new Zo(n,s,i)
        }
    ...
    async estimateGas(t) {
        ...
        return fl(e) && (e = await e),
        Vn(await cn(this, xe, Ne).call(this, {
            method: "estimateGas",
            transaction: e
        }), "%response")
    }
    ...
    async broadcastTransaction(t) {
        const {blockNumber: e, hash: n, network: r} = await yn({
    ...
    async lookupAddress(t) {
        ...
        try {
            ...
            if (bn(n, "BAD_DATA") && "0x" === n.value)
                return null;
            if (bn(n, "CALL_EXCEPTION"))
                return null;
            throw n
        }
        return null
    ...
    _forEachSubscriber(t) {
        for (const e of sn(this, pe).values())
            t(e.subscriber)
    }
    _getSubscriber(t) {
        switch (t.type) {
    ...
    _recoverSubscriber(t, e) {
        for (const n of sn(this, pe).values())
            if (n.subscriber === t) {
                ...
                n.subscriber = e,
                n.started && e.start(),
                null != sn(this, ge) && e.pause(sn(this, ge));
                break
            }
    }
    async on(t, e) {
        ...
        n.started || (n.subscriber.start(),
        n.started = !0,
        null != sn(this, ge) && n.subscriber.pause(sn(this, ge))),
        this
    }
    async once(t, e) {
        const n = await cn(this, xe, Ie).call(this, t);
    ...
    async emit(t, ...e) {
        ...
        0 === n.listeners.length && (n.started && n.subscriber.stop(),
        sn(this, pe).delete(n.tag)),
        r > 0
    }
    async listenerCount(t) {
        if (t) {
        ...
        let e = 0;
        for (const {listeners: n} of sn(this, pe).values())
            e += n.length;
        return e
    }
    async listeners(t) {
    ...
    async off(t, e) {
        ...
        return e && 0 !== n.listeners.length || (n.started && n.subscriber.stop(),
        sn(this, pe).delete(n.tag)),
        this
    }
    async removeAllListeners(t) {
        if (t) {
            const {tag: e, started: n, subscriber: r} = await cn(this, xe, Ie).call(this, t);
            n && r.stop(),
            sn(this, pe).delete(e)
        } else
            for (const [e,{started: n, subscriber: r}] of sn(this, pe))
                n && r.stop(),
                sn(this, pe).delete(e);
        return this
    }
    ...
    destroy() {
        ...
        for (const t of sn(this, Ee).keys())
    ...
    pause(t) {
        ...
        this._forEachSubscriber((e => e.pause(t))),
        on(this, ge, !!t);
        for (const e of sn(this, Ee).values())
            e.timer && clearTimeout(e.timer),
            e.time = yl() - e.time
    }
    resume() {
        if (null != sn(this, ge)) {
            this._forEachSubscriber((t => t.resume())),
            on(this, ge, null);
...
Re = async function(t, e, n) {
    ...
    await cn(this, xe, Oe).call(this, cn(this, xe, Ne).call(this, Object.assign(t, {
        address: r,
        blockTag: s
    })))
}
...
Be = async function(t, e) {
    if (Bn(t, 32))
        return await cn(this, xe, Ne).call(this, {
            method: "getBlock",
            blockHash: t,
            includeTransactions: e
        });
    let n = this._getBlockTag(t);
    return "string" != typeof n && (n = await n),
    await cn(this, xe, Ne).call(this, {
        method: "getBlock",
        blockTag: n,
        includeTransactions: e
    })
...
async function Ol(t, e) {
    let n = qo(e);
    if (null != n.to && (n.to = Cs(n.to, t)),
    null != n.from) {
        const e = n.from;
        n.from = Promise.all([t.getAddress(), Cs(e, t)]).then(( ([t,e]) => (Pn(t.toLowerCase() === e.toLowerCase(), "transaction from mismatch", "tx.from", e),
        t)))
    } else
        n.from = t.getAddress();
    return await yn(n)
...
class Rl {
    ...
    async populateTransaction(t) {
        ...
        if (null == n.gasPrice || 2 !== n.type && !s ? 0 !== n.type && 1 !== n.type || !s || Pn(!1, "pre-eip-1559 transaction do not support maxFeePerGas/maxPriorityFeePerGas", "tx", t) : Pn(!1, "eip-1559 transaction do not support gasPrice", "tx", t),
        2 !== n.type && null != n.type || null == n.maxFeePerGas || null == n.maxPriorityFeePerGas)
                ...
                if (null == n.type)
                    if (null != t.maxFeePerGas && null != t.maxPriorityFeePerGas)
                        ...
                        null != n.gasPrice) {
                            ...
                            null == n.maxPriorityFeePerGas && (n.maxPriorityFeePerGas = t.maxPriorityFeePerGas);
                    else
                        null != t.gasPrice ? (kn(!s, "network does not support EIP-1559", "UNSUPPORTED_OPERATION", {
                            operation: "populateTransaction"
                        }),
                        null == n.gasPrice && (n.gasPrice = t.gasPrice),
                        n.type = 0) : kn(!1, "failed to get consistent fee data", "UNSUPPORTED_OPERATION", {
                            operation: "signer.getFeeData"
                        });
                else
                    2 !== n.type && 3 !== n.type || (null == n.maxFeePerGas && (n.maxFeePerGas = t.maxFeePerGas),
                    null == n.maxPriorityFeePerGas && (n.maxPriorityFeePerGas = t.maxPriorityFeePerGas))
            }
        else
            n.type = 2;
...
class Bl {
    constructor(t) {
        ...
        on(this, Me, t),
        on(this, Fe, null),
        on(this, De, cn(this, Ge, Qe).bind(this)),
        on(this, Se, !1),
        on(this, Ue, null),
        on(this, Le, !1)
    }
    ...
    start() {
        sn(this, Se) || (on(this, Se, !0),
        cn(this, Ge, Qe).call(this, -2))
    }
    stop() {
        sn(this, Se) && (on(this, Se, !1),
        on(this, Le, !0),
        cn(this, Ge, He).call(this),
        sn(this, Me).off("block", sn(this, De)))
    }
    pause(t) {
        t && cn(this, Ge, He).call(this),
        sn(this, Me).off("block", sn(this, De))
    }
    resume() {
        this.start()
...
Qe = async function(t) {
    try {
        ...
        try {
            ...
            if (!bn(e, "UNSUPPORTED_OPERATION") || "eth_newFilter" !== e.operation)
                throw e
        }
        if (null == t)
            return on(this, Fe, null),
            void sn(this, Me)._recoverSubscriber(this, this._recover(sn(this, Me)));
        const n = await sn(this, Me).getNetwork();
        if (sn(this, Ue) || on(this, Ue, n),
        sn(this, Ue).chainId !== n.chainId)
...
class Tl extends Bl {
    ...
    async _emitResults(t, e) {
        for (const n of e)
            t.emit(sn(this, je), t._wrapLog(n, t._network))
    }
}
je = new WeakMap;
class Il extends Bl {
...
function Fl(t) {
    if (null == t || Ml.indexOf(typeof t) >= 0)
        return t;
    if ("function" == typeof t.getAddress)
        return t;
    if (Array.isArray(t))
        return t.map(Fl);
    if ("object" == typeof t)
    ...
    async sendUncheckedTransaction(t) {
        ...
        if (e.from) {
            ...
            n.push((async () => {
                ...
                Pn(null != n && n.toLowerCase() === this.address.toLowerCase(), "from address mismatch", "transaction", t),
                e.from = n
            }
            )())
        } else
        ...
        return await new Promise(( (t, r) => {
            ...
            const a = async () => {
                try {
                    ...
                    if (null != r)
                        return void t(r.replaceableTransaction(e))
                } catch (o) {
                    if (bn(o, "CANCELLED") || bn(o, "BAD_DATA") || bn(o, "NETWORK_ERROR"))
                        return null == o.info && (o.info = {}),
                        o.info.sendTransactionHash = n,
                        void r(o);
                    if (bn(o, "INVALID_ARGUMENT") && (i++,
                    null == o.info && (o.info = {}),
                    o.info.sendTransactionHash = n,
                    i > 10))
                        return void r(o);
    ...
    async signTypedData(t, e, n) {
        const r = Fl(n)
          , s = await Ga.resolveNames(t, e, r, (async t => {
            const e = await Cs(t);
            return Pn(null != e, "TypedData does not support null address", "value", t),
            e
        }
        ));
...
class Ql extends Al {
    constructor(t, e) {
        ...
        "boolean" == typeof n ? (Pn(!n || "any" !== t, "staticNetwork cannot be used on special network 'any'", "options", e),
        n && null != t && on(this, Ye, tl.from(t))) : n && (Pn(null == t || n.matches(t), "staticNetwork MUST match network object", "options", e),
        on(this, Ye, n))
    }
    _getOption(t) {
        return sn(this, We)[t]
    ...
    get _network() {
        return kn(sn(this, Ye), "network is not available yet", "NETWORK_ERROR"),
        sn(this, Ye)
    }
    async _perform(t) {
    ...
    async _detectNetwork() {
        ...
        return sn(this, Ze) ? await sn(this, Ze) : this.ready ? (on(this, Ze, (async () => {
            try {
                ...
                return on(this, Ze, null),
                t
            } catch (t) {
                throw on(this, Ze, null),
                t
            }
        }
        )()),
    ...
    _start() {
        null != sn(this, Ke) && null != sn(this, Ke).resolve && (sn(this, Ke).resolve(),
        on(this, Ke, null),
        (async () => {
            for (; null == sn(this, Ye) && !this.destroyed; )
                try {
                    ...
                    this.emit("error", En("failed to bootstrap network detection", "NETWORK_ERROR", {
    ...
    async _waitUntilReady() {
        if (null != sn(this, Ke))
            return await sn(this, Ke).promise
    }
    _getSubscriber(t) {
    ...
    getRpcTransaction(t) {
        ...
        t.accessList && (e.accessList = aa(t.accessList)),
        t.blobVersionedHashes && (e.blobVersionedHashes = t.blobVersionedHashes.map((t => t.toLowerCase()))),
        e
    }
    getRpcRequest(t) {
        switch (t.method) {
    ...
    getRpcError(t, e) {
        ...
        if ("eth_sendRawTransaction" === n || "eth_sendTransaction" === n) {
            ...
            if (s.match(/nonce/i) && s.match(/too low/i))
                return En("nonce has already been used", "NONCE_EXPIRED", {
                    transaction: e,
                    info: {
                        error: r
                    }
            ...
            if (s.match(/replacement transaction/i) && s.match(/underpriced/i))
                return En("replacement fee too low", "REPLACEMENT_UNDERPRICED", {
                    transaction: e,
                    info: {
                        error: r
                    }
        ...
        i ? En("unsupported operation", "UNSUPPORTED_OPERATION", {
            operation: t.method,
            info: {
                error: r,
                payload: t
    ...
    send(t, e) {
        if (this.destroyed)
            return Promise.reject(En("provider destroyed; cancelled request", "UNSUPPORTED_OPERATION", {
                operation: t
            }));
        ...
        return cn(this, qe, Xe).call(this),
        r
    }
    async getSigner(t) {
        null == t && (t = 0);
    ...
    destroy() {
        sn(this, ze) && (clearTimeout(sn(this, ze)),
        on(this, ze, null));
        for (const {payload: t, reject: e} of sn(this, Ve))
            e(En("provider destroyed; cancelled request", "UNSUPPORTED_OPERATION", {
                operation: t.method
            }));
        on(this, Ve, []),
        super.destroy()
...
class Hl extends Ql {
    constructor(t, e) {
        ...
        null == n && (n = Ll.pollingInterval),
        on(this, _e, n)
    }
    _getSubscriber(t) {
        const e = super._getSubscriber(t);
        return Ul(e) && (e.pollingInterval = sn(this, _e)),
        e
    }
    get pollingInterval() {
        return sn(this, _e)
...
function jl(t) {
    if (null == t)
        return null;
    if ("string" == typeof t.message && t.message.match(/revert/i) && Bn(t.data))
        return {
            message: t.message,
            data: t.data
        };
...
function Wl(t, e) {
    if (null != t) {
        if ("string" == typeof t.message && e.push(t.message),
        "object" == typeof t)
            for (const n in t)
                Wl(t[n], e);
        if ("string" == typeof t)
...
class Jl extends Hl {
    constructor(t, e, n) {
        ...
        Pn(t && t.request, "invalid EIP-1193 provider", "ethereum", t),
        super(e, r),
        an(this, $e),
        on(this, $e, (async (e, n) => {
            const r = {
    ...
    async hasSigner(t) {
        ...
        return "number" == typeof t ? e.length > t : (t = t.toLowerCase(),
        0 !== e.filter((e => e.toLowerCase() === t)).length)
    }
    async getSigner(t) {
        if (null == t && (t = 0),
        !(await this.hasSigner(t)))
            try {
...
$e = new WeakMap;
export {Jl as B, Tc as C, Nn as a, Pn as b, kn as c, wn as d, Vn as e, On as f, Zn as g, jn as h, Jn as m, Yn as t};
