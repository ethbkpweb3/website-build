    ...
    setup(e) {
        const t = e,
            ...
            d = p((() => {
                const e = {
                    ...
                    a = A(t.percentage);
                return a.includes("gradient") ? e.background = a : e.backgroundColor = a, e
            })),
            ...
            L = p((() => {
                let e;
                return e = t.color ? A(t.percentage) : l[t.status] || l.default, e
            })),
        ...
        const A = e => {
            ...
            if (F(s)) return s; {
                ...
                for (const a of t)
                    if (a.percentage > e) return a.color;
        ...
        return (e, t) => (f(), h("div", {
            ...
            style: v(y(d))
        }, [(e.showText || e.$slots.default) && e.textInside ? (f(), h("div", {
            key: 0,
            class: g(y(c).be("bar", "innerText"))
        }, [b(e.$slots, "default", {
            percentage: e.percentage
        }, (() => [k("span", null, m(y(z)), 1)]))], 2)) : x("v-if", !0)], 6)], 6)], 2)) : (f(), h("div", {
            key: 1,
            ...
            "stroke-width": y(I),
            style: v(y(_))
        }, null, 14, ["d", "stroke", "opacity", "stroke-linecap", "stroke-width"])]))], 6)), !e.showText && !e.$slots.default || e.textInside ? x("v-if", !0) : (f(), h("div", {
            key: 2,
            class: g(y(c).e("text")),
            style: v({
                fontSize: `${y(P)}px`
