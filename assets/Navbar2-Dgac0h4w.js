...
import {
    _ as N
} from "./VPlaceload-DxqS78UL.js";
import {
    F as $
} from "./browser-C4ms0c26.js";
import {
    E as G
} from "./index-_RxYNAvD.js";
import {
    _ as K
} from "./_plugin-vue_export-helper-BCo6x5W8.js";
import {
    _ as J
} from "./Button-pUu2E7zq.js";
import {
    _ as Y
} from "./AvatarSimple-BSG0UtmT.js";
import {
    _ as X
...
import {
    E as re
} from "./index-D8Bawvwf.js";
import {
    E as de
} from "./index-CwLe-SOY.js";
import {
    _ as ce
...
const be = {
    ...
    Oe = K(s({
        ...
        setup(e) {
            const {
                ...
                if (0 != b.allAnnouncement.length) return;
                const e = new $;
                e.append("pageNo", "1"), e.append("pageSize", "10"), a.getAnnouncement(e).then((e => {
                    const a = e.data;
                    if (0 == a.code) {
            ...
            return (e, a) => {
                ...
                return o(), r(p(G), {
                    ...
                    default: d((() => [c("div", be, [c("div", ye, [c("div", we, [a[1] || (a[1] = c("img", {
                        ...
                        src: he,
                        alt: ""
                    }, null, -1)), c("span", xe, u(p(s)("pga.notifications")), 1)]), c("div", ke, [c("a", _e, u(p(s)("pga.view-more")), 1)])]), c("div", Ae, [0 == b.allAnnouncement ? (o(), m(v, {
                        key: 0
                        ...
                        width: "90%",
                        height: "16px"
                    })])])]))), 64)) : f("", !0), (o(!0), m(v, null, g(b.allAnnouncement, ((e, s) => (o(), m("div", {
                        key: s,
                        class: "notify-item"
                    }, [a[2] || (a[2] = c("span", {
                        class: "notify-circle"
                        ...
                        onClick: a => {
                            return s = e.type, void((l = e.url) ? window.open(l) : w.push({
                                name: "announcements",
                                params: {
                                    tp: s
                                }
    ...
    Me = s({
        __name: "Toolbar",
        setup: e => (l(), b(), y(), t(), ge(), n({
            allAnnouncement: []
        }), (e, a) => (o(), m("div", Ve, [h(H), h(q), h(Oe), w(e.$slots, "default")])))
    }),
    Ue = ["href"],
    Fe = {
        class: "has-naver"
        ...
        setup(e) {
                ...
                x = () => {
                    s.logout().then((() => {
                        n(), g.update({
                            user_id: "",
                            user_hash: ""
                        }), y.success("Log Out"), f.meta.requiresAuth && b.push({
                            name: "index"
                        })
                    })).catch((e => {
                        console.log(e)
            ...
            return (e, s) => {
                ...
                return o(), r(p(G), {
                    ...
                    default: d((() => {
                        var e, i, v;
                        return [c("div", qe, [c("div", Ze, [c("div", Ne, [p(a).enabledData ? (o(), r(p(se), P({
                            key: 0
                        }, {
                            ...
                            size: "small"
                        }))]), c("span", $e, u((v = p(m).realName, (v && (v.trim().indexOf(" ") >= 0 ? v.trim().substring(0, v.trim().indexOf(" ")) : v.trim())) ? ? p(m).email ? p(m).email.substring(0, 20) + (p(m).email.length > 20 ? "..." : "") : (null == (e = p(m)) ? void 0 : e.mobile) ? ? "")), 1), c("span", Ge, "UID:" + u(null == (i = p(m)) ? void 0 : i.id), 1)]), h(t, {
                            to: {
        ...
        setup(e, {
            ...
            const n = S(),
                ...
                r = x({
                    ...
                    set: a => {
                        void 0 === e.collapseId && (i.value = a), e.collapseId === e.open ? s("update:open") : s("update:open", e.collapseId)
                    }
                });
            ...
            const c = null == (l = a.header) ? void 0 : l.call(a),
                ...
                m = u.map((e => {
                    var a, s;
                    return (null == (s = null == (a = e.props) ? void 0 : a.to) ? void 0 : s.name) && p === e.props.to.name && (o.value = !0), j("li", {}, e)
                }));
            return () => {
                const e = j("a", {
                        tabindex: 0,
                        ...
                        onKeydown(e) {
                            "Space" === e.code && (e.preventDefault(), e.stopPropagation(), d())
                        }
                    }, c),
                    a = j("div", {
                        class: "collapse-wrap"
    ...
    ca = K(s({
        ...
        setup(e) {
            ...
            return (e, l) => (o(), r(p(te), {
                ...
                loading: h.value,
                onFocus: l[1] || (l[1] = e => {
                    0 == b.coinList.length && (h.value = !0, y.getSymbol().then((e => {
                        b.coinList = e.data, h.value = !1
                    })))
                }),
                onChange: l[2] || (l[2] = e => {
                    s.value && (f.push({
                ...
                default: d((() => [(o(!0), m(v, null, g(b.coinList, (e => (o(), r(p(le), {
                    key: e.symbol,
                    label: e.symbol,
                    value: e.symbol
                }, {
    ...
    Aa = K(s({
        ...
        setup(e, {
            ...
            const y = a,
                ...
                D = L(""),
                I = () => {
                    A.value = "", D.value = "", y("update:modelValue", !1)
                },
                P = i();
            S();
            const j = () => {
                    E(), y("update:modelValue", !0);
                ...
                E = () => {
                    s.isLoggedIn ? (g.getAiWAit().then((({
                        data: e
                    }) => {
                        0 == e.code && !0 === e.data && (V.value = !0), M.value = !1
                    })), O.value = !0, U.value = !1) : (O.value = !1, U.value = !1)
                },
                W = e => {
                    e ? window.open("https://play.google.com/store/apps/details?id=com.opz.dev") : window.open("https://testflight.apple.com/join/Oxsd9WMO")
                };
            return b(), (e, a) => {
                ...
                return o(), m(v, null, [w.btn ? (o(), r(l, {
                    ...
                    default: d((() => [c("div", null, [c("div", fa, [a[19] || (a[19] = c("div", {
                    ...
                    }, " Our Automated AI Trading feature is at full capacity. New spots will be available soon. To secure your spot, join our exclusive waitlist on a first-come, first-served basis. ", -1)), O.value ? (o(), r(l, {
                        key: 0,
                    ...
                    }, null, -1)), !0 === U.value ? (o(), m("div", ya, [h(t, {
                        width: "330px",
                        height: "120px"
                    })])) : p(s).isLoggedIn && O.value ? (o(), m("div", wa, [c("div", xa, [a[11] || (a[11] = c("p", {
                        class: "help mb-2"
                        ...
                        suffix: d((() => [c("i", {
                            ...
                            onClick: a[1] || (a[1] = e => (e => {
                                try {
                                    navigator.clipboard.writeText(e), _.success(n("depwi.copied-successfully"))
                                } catch (a) {
    ...
    Ga = K(s({
        ...
        setup(e, {
            ...
            const s = L(!1),
                ...
                x = a,
                I = () => {
                    g.onChange(!1, 7), x("closeDash")
                },
                T = () => {
                    g.onChange(!0, 7), x("closeDash")
                };
            return (e, a) => {
                const t = J,
                    b = k("RouterLink"),
                    x = Ye,
                    C = _("preload-link");
                return o(), m(v, null, [c("div", Da, [c("div", Ca, [c("ul", Ia, [p(y).isLoggedIn ? f("", !0) : (o(), m("li", Sa, [h(t, {
                    to: "/auth",
                    color: "primary",
                    fullwidth: "",
                    bold: "",
                    ...
                    _: 1
                })) : f("", !0), p(y).isLoggedIn ? (o(), m("li", ja, [c("a", {
                    ...
                    class: "divider"
                }, null, -1)), n.value ? (o(), m("li", Ea, [c("div", Wa, [h(ca)])])) : f("", !0), c("li", null, [A((o(), r(b, {
                    to: {
                        name: "shop"
                    },
                    tabindex: "0"
                    ...
                    [C]
                ])]), c("li", null, [c("a", Na, [c("span", $a, u(p(l)("exh.white-paper")), 1)])])])])]), h(Aa, {
                    modelValue: w.value,
        ...
        setup(e) {
            ...
            return (e, s) => {
                const l = k("RouterLink"),
                    t = _("preload-link");
                return o(), m("div", Ka, [c("div", Ja, [c("div", Ya, [A((o(), r(l, {
                    to: {
    ...
    os = s({
        ...
        setup(e, {
            ...
            const s = a,
                l = e;
            return (e, a) => (o(), m(v, null, [c("div", {
                class: D([
                    [l.isOpen && "is-active"], "mobile-main-sidebar"
                ])
            ...
            })])], -1))]))]), c("ul", is, [w(e.$slots, "bottom-links")])])], 2), l.isOpen ? (o(), m("div", {
                key: 0,
    ...
    Is = K(s({
        ...
        setup(e) {
            ...
            const k = T(),
                ...
                M = L(!0),
                E = e => {
                    if (M.value = !0, !O.value || e) {
                        O.value = !0;
                        const e = new FormData;
                        e.append("pageNo", "1"), e.append("pageSize", "2" == $.value ? "20" : "10"), 0 != V.selectedAiData.id && e.append("botId", V.selectedAiData.id.toString()), "2" == $.value && e.append("memberId", y.id.toString()), P.allAi = [], a.getAllAi(e).then((e => {
                            if (200 == e.status) {
                                const s = e.data;
                                if (0 == s.code && s.data) {
                                    ...
                                    if (0 != V.selectedAiData.id && -1 == e.findIndex((e => e.id == V.selectedAiData.id))) {
                                        ...
                                        a.itemAi(s).then((a => {
                                            if (200 == a.status) {
                                                const s = a.data;
                                                0 == s.code && 200 == s.errCode && s.data && (e.push(s.data), V.updateSelectedAiHistory(s.data), l = !0)
                                            }
                                            l || (V.selectedAiData = z, W.value = 0)
                                        }))
                                    }
                                    P.allAi = R(e)
                                }
                ...
                R = e => {
                    let a = null;
                    const s = e.filter((e => e.id !== W.value || (a = e, !1)));
                    return s.sort(((e, a) => a.subscribers - e.subscribers)), a ? [a, ...s] : s
                },
                H = (e, s) => {
                    if (!x) return V.selectedAiData = z, void k.error(_("inx.please-login"));
                    W.value = e;
                    const l = new FormData;
                    l.append("botId", e.toString()), a.subscribeAi(l).then((a => {
                        if (200 == a.status) {
                            const l = a.data;
                            if (0 == l.code && 200 == l.errCode) {
                                const a = P.allAi.find((a => a.id == e));
                                V.selectedAiData = a, V.updateSelectedAiHistory(a), Z(s, !1), Z(e, !0)
                            }
                        }
                    }))
                },
                q = e => {
                    $.value = e, "0" == e || "2" == e ? E(!0) : P.allAi = R(V.selectedAiHistoryData)
                },
                Z = (e, a) => {
                    const s = P.allAi.find((a => a.id === e));
                    s ? a ? s.subscribers += 1 : s.subscribers -= 1 : console.error("AI with the specified ID not found"), P.allAi = [...P.allAi]
                };
            U((() => {
                var e;
                (null == (e = null == V ? void 0 : V.selectedAiData) ? void 0 : e.id) || (V.selectedAiData = z, W.value = 0), V.selectedAi ? 0 == V.selectedAiData.id ? W.value = 0 : (W.value = V.selectedAiData.id, P.allAi.push(z)) : (V.selectedAiData = z, W.value = z.id)
            })), L(!1);
            const $ = L("0");
            return (e, a) => {
                const s = N,
                ...
                return o(), r(p(G), {
                    ...
                    reference: d((() => {
                        var e, s, l, t;
                        return [(null == (s = null == (e = p(V)) ? void 0 : e.selectedAiData) ? void 0 : s.name) ? (o(), m("div", rs, [c("div", ds, [(null == (t = null == (l = p(V)) ? void 0 : l.selectedAiData) ? void 0 : t.logo) ? (o(), m("img", {
                            key: 0,
                    ...
                    default: d((() => [c("div", ms, [c("div", vs, [c("span", gs, [h(p(pe), {
                        ...
                        _: 1
                    }, 8, ["default-active"])]), "1" != $.value ? (o(), m("span", hs, u("Subscribers"))) : f("", !0)]), M.value ? (o(), m("div", fs, [h(s, {
                        class: "mt-1",
                        width: "240px",
                        height: "210px",
                        style: {
                        ...
                        default: d((() => [c("div", null, [(o(!0), m(v, null, g(P.allAi, ((e, s) => (o(), m("div", {
                            key: s,
                            class: "item-ai"
                            ...
                            class: "ml-2",
                            onClick: a => {
                                return s = e.id, void window.open("https://www.app.opz.com/agents/" + s + "?coin=bitcoin");
                                var s
                            }
                        }, a[7] || (a[7] = [c("i", {
                            class: "help fas fa-external-link"
                        }, null, -1)]), 8, As)]), 0 != e.id && "1" != $.value ? (o(), m("div", Ds, u(e.subscribers), 1)) : f("", !0)])))), 128))])])),
                        _: 1
                    })), c("div", Cs, [h(l, {
                        size: "small",
    ...
    el = K(s({
        ...
        setup(e) {
            const {
                t: a
            } = t(), s = C(), l = b(), v = e, g = L(!1), y = L(""), w = S(), I = i(), T = L(null), {
                y: P
            } = E(), j = x((() => P.value > 60)), O = (e = "") => {
                y.value = e
            }, U = () => {
                l.onChange(!1, 7)
            }, F = () => {
            ...
            return (e, l) => {
                ...
                return o(), m("nav", {
                    ...
                    links: d((() => [c("li", null, [c("div", {
                        ...
                        alt: "Home"
                    })], -1)]), 34)]), p(s).isLoggedIn ? (o(), m("li", Ss, [c("div", {
                        ...
                        src: He,
                        alt: "AI Radar"
                    })], -1)]), 34)])) : f("", !0), p(s).isLoggedIn ? (o(), m("li", Ts, [c("div", {
                    ...
                    default: d((() => [p(s).isLoggedIn && H.value && "layouts" === Z.value ? (o(), r(b, {
                        key: 0
                    })) : H.value && "dashboard" === Z.value ? (o(), r(y, {
                        key: 1,
                    ...
                    ismobile: !0
                })], 2), p(s).isLoggedIn ? (o(), m("div", js, [h(x)])) : f("", !0), c("div", {
                    class: "navbar-burger",
                    ...
                    [L]
                ]), N.value ? (o(), m("div", Js, [h(ca)])) : f("", !0)]), c("div", Ys, [c("div", Xs, [p(s).isLoggedIn ? f("", !0) : (o(), m("div", Qs, [h(n, {
                    to: {
                        name: "auth"
                    },
                    class: "login-button"
                    ...
                    _: 1
                })])), G.value || !(null == (t = p(w).fullPath) ? void 0 : t.startsWith("/trade")) ? (o(), m("div", {
                    key: 1,
                    class: D(p(s).isLoggedIn ? "pr-2" : "pl-2 pr-1")
                }, [h(Is, {
                    ismobile: !0
                })], 2)) : f("", !0), p(s).isLoggedIn ? (o(), r(x, {
                    key: 2,
                    right: ""
                })) : f("", !0), h(P, {
...
export {
    Is as A, ga as D, Aa as W, el as _, ha as a, la as b, He as c, Xe as d, ea as e, fe as f
};