import {R as a, z as e, cy as t, X as l, y as r, B as s, bM as n, bY as o, cq as i, F as c, I as u, M as w, ds as m, dy as v, dw as p, bD as h, m as g, o as f, j as d, l as x, dx as _, db as C, dv as M, be as z, h as L, r as y, bc as B} from "./index-N2rhOp93.js";
var b, V = Object.defineProperty, H = Object.defineProperties, O = Object.getOwnPropertyDescriptors, A = Object.getOwnPropertySymbols, j = Object.prototype.hasOwnProperty, P = Object.prototype.propertyIsEnumerable, S = (a, e, t) => e in a ? V(a, e, {
    enumerable: !0,
    configurable: !0,
    writable: !0,
    value: t
...
function k(l, r) {
    ...
    return e(( () => {
        ...
        for (var t in e || (e = {}))
            j.call(e, t) && S(a, t, e[t]);
        if (A)
            for (var t of A(e))
                P.call(e, t) && S(a, t, e[t]);
        return a
    }
    )({}, r),
    o = {
...
function Z(a, e) {
    ...
    return Object.isExtensible(m) && (m.trigger = c),
    m
}
function R(a) {
    return !!o() && (i(a),
    ...
    return function(a, e) {
        ...
        return n => {
            const o = I(a)
              , i = I(e.maxWait);
            return t && s(t),
            o <= 0 || void 0 !== i && i <= 0 ? (l && (s(l),
            l = null),
            Promise.resolve(n())) : new Promise(( (a, c) => {
                r = e.rejectOnCancel ? c : a,
                i && !l && (l = setTimeout(( () => {
                    t && s(t),
                    l = null,
                    a(n())
...
const qa = "__epPropKey"
  ...
  , Ta = (a, e) => {
    if (!p(a) || p(t = a) && t[qa])
        return a;
    var t;
    const {values: l, required: r, default: s, type: n, validator: o} = a
      , i = l || o ? t => {
        let r = !1
          , n = [];
        if (l && (n = Array.from(l),
        _(a, "default") && n.push(s),
        r || (r = n.includes(t))),
        o && (r || (r = o(t))),
        !r && n.length > 0) {
    ...
    return _(a, "default") && (c.default = s),
    c
}
  , Za = a => U(Object.entries(a).map(( ([a,e]) => [a, Ta(e, a)])))
  , Ra = (a, e) => {
    if (a.install = t => {
        for (const l of [a, ...Object.values(null != e ? e : {})])
