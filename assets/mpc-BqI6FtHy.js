import {A as e, a as t, b as a, c as s} from "./AiTradeItems2-CNJNdsPE.js";
import {f as i, _ as l} from "./index-B_Hz-fzE.js";
import {_ as n} from "./SectionTitle.vue_vue_type_script_setup_true_lang-BWlX4763.js";
import {_ as o} from "./CaseStudy-2bmZBwD0.js";
import {_ as r} from "./ButtonGR-BF9zAU5B.js";
import {_ as d} from "./Subtitle-ytb6lg8s.js";
import {_ as c} from "./_plugin-vue_export-helper-BCo6x5W8.js";
import {cD as p, o as u, j as m, l as v, P as f, cB as g, dg as y, ck as h, t as b, bh as w, H as x, m as _, h as j, y as k, I as z, N as O, cC as A, p as C, n as S, w as T, q as I, s as B, X as P, v as V, r as N, u as E, Y as L, dm as D, a as W, G as Z, dp as M, dn as F, k as G, dD as $, K as q} from "./index-jdACH0Rc.js";
import {_ as H} from "./Title-ChmnbwlA.js";
import {P as Y, S as X, C as J} from "./carousel.es-cLcmNbI1.js";
import {_ as U} from "./VPlaceload-jGgmcTFZ.js";
import {a as R, _ as K} from "./Navbar2-DVEXcHRs.js";
import {_ as Q, a as ee} from "./google-play-0W6tGWt8.js";
import "./index-Dwv4qbXN.js";
import {E as te} from "./index-DBFvTDaE.js";
import {E as ae} from "./index-C8W9xb4z.js";
import {_ as se} from "./Section-fdq8wkjz.js";
import {_ as ie} from "./Hero.vue_vue_type_style_index_0_lang-BzZhUp93.js";
import {_ as le, a as ne} from "./google-play-BbEUCb8h.js";
import {E as oe, a as re} from "./index-BZssNWJT.js";
import {c as de} from "./index-BSBG2tux.js";
import {V as ce} from "./vue3-lottie.es-S_sZ807A.js";
import {M as pe} from "./vue3-markdown-it.umd.min--TOU0B4Y.js";
import {s as ue} from "./sleep-MiAo3PcT.js";
import {b as me} from "./index-cRGdv3RN.js";
import {E as ve} from "./index-CSGGFzQh.js";
import {m as fe} from "./index-CaRD-WAZ.js";
import {b as ge} from "./route-block-B_A1xBdJ.js";
...
const Oe = c({
    ...
    const n = p("motion");
    return u(),
    m("div", ye, [v("div", he, [v("div", be, [v("div", we, [(u(!0),
    m(f, null, g(i.links, ( (e, t) => y((u(),
    m("div", {
        key: t,
    ...
    }, [v("div", null, [v("span", ze, b(e.title), 1)])], 8, ke)), [[n]])], 8, xe)), [[n]]))), 128))])])])])
}
]]);
var Ae = function(e) {
    var t = typeof e;
...
var rt = function(e, t, a) {
    var s, i, l, n, o, r, d = 0, c = !1, p = !1, u = !0;
    ...
    return t = lt(t) || 0,
    st(a) && (c = !!a.leading,
    l = (p = "maxWait"in a) ? nt(lt(a.maxWait) || 0, t) : l,
    u = "trailing"in a ? !!a.trailing : u),
    y.cancel = function() {
...
const ct = x((function(e, t, a) {
    ...
    if ("function" != typeof e)
        throw new TypeError("Expected a function");
    return dt(a) && (s = "leading"in a ? !!a.leading : s,
  ...
  , vt = c(_({
    ...
    setup(e) {
        ...
        return (e, l) => {
            ...
            }, b(t.content), 3), !e.isAppOn && e.cta ? (u(),
            S(f, {
                key: 0,
                to: t.to
            }, {
        ...
        return (e, t) => {
            ...
            S(P(ae), {
                ...
                m("div", yt, [V(d, {
                    width: "330px",
                    height: "120px"
                })])) : P(a).isLoggedIn && w.value ? (u(),
                m("div", ht, [v("div", bt, [t[11] || (t[11] = v("p", {
                    class: "help mb-2"
                    ...
                    suffix: T(( () => [v("i", {
                        ...
                        onClick: t[1] || (t[1] = e => (e => {
                            try {
                                ...
                                o.success(s("depwi.copied-successfully"))
                            } catch (t) {
  ...
  , Gt = c(_({
    ...
    setup(e) {
        ...
        return j(( () => [t.animated && "animated", !t.horizontal && "has-text-centered p-4 large:p-10"])),
        j(( () => [t.size && `is-${t.size}`])),
        j(( () => ["small" === t.size && "rem-90", t.links && "mb-4", !t.horizontal && "mx-auto max-w-2"])),
        (e, s) => {
            const i = p("motion");
            return u(),
            m("div", It, [v("div", Bt, [(u(!0),
            m(f, null, g(t.features.slice(0, t.limit), ( (e, t) => y((u(),
            m("div", {
                key: t,
                ...
                src: e.imageSmall,
                alt: e.title
            }, null, 8, Wt), v("p", Zt, b(e.title), 1)]), v("div", Mt, [v("p", Ft, b(e.text), 1)])])]), s[0] || (s[0] = G('<div class="card-arrow" data-v-b3d2654a><div class="card-arrow-top-left" data-v-b3d2654a></div><div class="card-arrow-top-right" data-v-b3d2654a></div><div class="card-arrow-bottom-left" data-v-b3d2654a></div><div class="card-arrow-bottom-right" data-v-b3d2654a></div></div>', 1))])], 10, Pt)), [[i]]))), 128))])])
        }
    }
  ...
  , ta = c(_({
    ...
    setup(e) {
        ...
        ;
        return k(window.innerWidth <= 767),
        (e, a) => {
            const s = H
              , o = ie
              , r = p("motion");
            ...
            S(o, {
                ...
                body: T(( () => [v("div", $t, [V(P(oe), {
                    ...
                    S(P(re), {
                        ...
                        default: T(( () => [v("div", qt, [v("div", Ht, [V(s, {
                            ...
                            m("span", {
                                ...
                                "data-content": "Secure."
                            }, a[5] || (a[5] = [I(" Secure. ")]), 2)), [[r]])])),
                            _: 1
                        }), y((u(),
                        m("h2", Yt, a[6] || (a[6] = [I(" Revolutionizing Self-Custody with Advanced AI Technology ")]))), [[r]])]), a[9] || (a[9] = v("div", {
                            style: {
                                position: "absolute",
                                inset: "0",
                                "z-index": "0",
                        ...
                        })], -1)), P(i).isAppOn ? B("", !0) : y((u(),
                        m("div", Xt, [v("div", Jt, [v("div", {
                            onClick: a[0] || (a[0] = e => n()),
                    ...
                    S(P(re), {
                        ...
                        m("div", Kt, [v("div", Qt, [a[14] || (a[14] = v("a", {
                            target: "_blank",
        ...
        const c = () => {
          ...
          , x = () => {
            ...
            ( () => {
                ...
                let t = 0;
                o = setInterval(( () => {
                    n.value = "Generating " + i.symbol + `  Analysis${e[t % e.length]}`,
                    t++
                }
                ), 500)
            }
            ...
            (async () => {
                const e = Date.now();
                "BTC" === i.symbol ? a.getBTCQuery().then((async ({data: t}) => {
                    if (500 == t.code)
                        w.error(t.message),
                        l.value = !1;
                    else if (0 == t.code) {
                        if ("" === h.value) {
                            const a = Date.now() - e;
                            a < 2e3 && await ue(2e3 - a),
                            h.value = t.data,
                            g.value = !1
                        } else
                            h.value != t.data && (h.value = t.data,
                            g.value = !1);
                        d()
                    }
                }
                )) : a.getETHQuery().then((async ({data: t}) => {
                    if (500 == t.code)
                        w.error(t.message),
                        l.value = !1;
                    else if (0 == t.code) {
        ...
        return (e, t) => {
            ...
            S(a, {
                ...
                default: T(( () => [v("div", null, [v("div", aa, [t[13] || (t[13] = v("div", {
                    ...
                    width: "21"
                }, null, 8, na), v("p", oa, b("BTC" === i.symbol ? "Bitcoin" : "Ethereum") + " Technical Analysis Demo: ", 1)]), g.value ? (u(),
                m("div", ra, [y((u(),
                m("div", da, [V(P(ce), {
                    class: "fbz-img-lt",
                ...
                }), v("div", ca, [v("p", pa, b(n.value), 1)])])), [[o]])])) : (u(),
                m("div", ua, [v("div", ma, [v("div", va, [V(P(pe), {
                    source: h.value,
                    breaks: !0,
                    style: {
                        "padding-bottom": "18px"
  ...
  , za = _({
    ...
    setup(c) {
        const g = k(!1)
          ...
          , j = e => {
            _.targetX = e.clientX / window.innerWidth - .5,
            _.targetY = e.clientY / window.innerHeight - .5
        }
          , A = (e, t, a) => (1 - a) * e + a * t
          , C = () => {
            _.currentX = A(_.currentX, _.targetX, .1),
            _.currentY = A(_.currentY, _.targetY, .1),
            ( () => {
                if (x.value) {
                    const e = 20;
        ...
        ;
        return z(( () => {
            window.fbq2opz("trackCustom", "VisitHome"),
            h.event("VisitHome"),
            requestAnimationFrame(C)
        }
        )),
        ...
        (c, h) => {
            ...
            m(f, null, [V(_), v("div", {
            ...
            }, null, 512), [[G]]), V(k)], 32), v("div", null, [V(z), V(N, {
                color: "grey",
                "bottom-narrow": "",
                "bottom-narrow-mobile": ""
            }, {
                default: T(( () => [v("div", ga, [y((u(),
                m("div", ya, [v("div", ha, [V(O, {
                    tag: "h3",
                    size: 5,
                    weight: "bold",
                    class: "pb-3",
                ...
                default: T(( () => [v("div", ba, [y((u(),
                m("div", wa, [v("div", xa, [V(e, {
                    maxItems: 3
                })]), v("div", _a, [V(O, {
                    tag: "h3",
                    size: 5,
                    ...
                    class: "paragraph rem-115 mb-4 text-white"
                }, " Superintelligence Trader is an AI-driven system that automates crypto trades, optimizing strategies with real-time analysis. ", -1))])])), [[G, b]])])])),
                _: 1
            }), V(N, {
...
const Oa = c(za, [["__scopeId", "data-v-4f3299d6"]]);
