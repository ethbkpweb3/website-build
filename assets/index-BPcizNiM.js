...
import {
    u as p
} from "./use-global-config-Dr4Fo486.js";
import {
    h as b,
    Q as g,
    y as v,
    ...
    setup(o, {
        ...
        const s = o,
            r = function(o) {
                ...
                return b((() => {
                    ...
                    if (s) {
                        ...
                        if (o.plain) a = t.cssVarBlock({
                        ...
                        }), e.value && (a[t.cssVarBlockName("disabled-bg-color")] = o.dark ? K(l, 90) : l.tint(90).toString(), a[t.cssVarBlockName("disabled-text-color")] = o.dark ? K(l, 50) : l.tint(50).toString(), a[t.cssVarBlockName("disabled-border-color")] = o.dark ? K(l, 80) : l.tint(80).toString());
                        else {
                            ...
                            if (a = t.cssVarBlock({
                                ...
                                a[t.cssVarBlockName("disabled-bg-color")] = e, a[t.cssVarBlockName("disabled-text-color")] = o.dark ? "rgba(255, 255, 255, 0.5)" : `var(${t.cssVarName("color-white")})`, a[t.cssVarBlockName("disabled-border-color")] = e
                            }
                        }
                    }
                    return a
            ...
            l = y("button"),
            {
                ...
                return {
                    ...
                    shouldAddSpace: S,
                    handleClick: t => {
                        l.value || o.loading ? t.stopPropagation() : ("reset" === o.nativeType && (null == s || s.resetFields()), e("click", t))
                    }
                }
            })(s, t),
        ...
        return e({
            ...
            default: S((() => [o.loading ? (x(), B(N, {
                ...
                default: S((() => [(x(), h($(o.loadingIcon)))])),
                _: 1
            }, 8, ["class"]))], 64)) : o.icon || o.$slots.icon ? (x(), h(V(a), {
                key: 1
            }, {
                default: S((() => [o.icon ? (x(), h($(o.icon), {
                    key: 0
                })) : _(o.$slots, "icon", {
                    key: 1
                })])),
                _: 3
            })) : z("v-if", !0), o.$slots.default ? (x(), B("span", {
                key: 2,
                class: w({
