...
function s(n, t, e) {
    return e ? t ? t(n) : n : (n && n.then || (n = Promise.resolve(n)),
    t ? n.then(t) : n)
}
function c() {}
var u = {
...
var v = function(r) {
    function c(n, t) {
        ...
        e.cn = function() {
            var n = e.fn
              , t = n.installing;
            e.tn > 0 || !i(t.scriptURL, e.sn.toString()) || performance.now() > e.un + 6e4 ? (e.vn = t,
            n.removeEventListener("updatefound", e.cn)) : (e.hn = t,
            e.an.add(t),
            e.rn.resolve(t)),
            ++e.tn,
        ...
        e.ln = function(n) {
            ...
            "installed" === o ? e.wn = self.setTimeout((function() {
                "installed" === o && t.waiting === r && e.dispatchEvent(new a("waiting",s))
            }
            ), 200) : "activating" === o && (clearTimeout(e.wn),
            i || e.en.resolve(r))
        }
        ,
        e.yn = function(n) {
    ...
    return g.register = function(n) {
        var t, e, r = (void 0 === n ? {} : n).immediate, o = void 0 !== r && r;
        try {
            var c = this;
            return s((t = function() {
                return c.mn = Boolean(navigator.serviceWorker.controller),
                c.dn = c.pn(),
                s(c.bn(), (function(n) {
                    c.fn = n,
                    c.dn && (c.hn = c.dn,
                    ...
                    var t = c.fn.waiting;
                    return t && i(t.scriptURL, c.sn.toString()) && (c.hn = t,
