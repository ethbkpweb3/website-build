...
import {
    u as et
} from "./index-DP_x0l5O.js";
import {
    f as nt
} from "./index-B_GYtH8g.js";
import {
    E as ot
...
import {
    g as lt,
    b as rt
} from "./_baseClone-BHsCAS1S.js";
import {
    c as it
} from "./_initCloneObject-CjiI1zRU.js";
import {
    i as at
} from "./isPlainObject-B7ZirgRB.js";
...
function st(e, n) {
    return n.length < 2 ? e : t(e, function(t, e, n) {
        ...
        for (var r = Array(l); ++o < l;) r[o] = t[o + e];
        return r
    }(n, 0, -1))
}

function ut(t, o) {
    return null == (t = st(t, o = e(o, t))) || delete t[n((l = o, r = null == l ? 0 : l.length, r ? l[r - 1] : void 0))];
    var l, r
}
...
var ft = o((function(t, n) {
    ...
    var r = !1;
    n = l(n, (function(n) {
        return n = e(n, t), r || (r = n.length > 1), n
    })), it(t, lt(t), o), r && (o = rt(o, 7, ct));
    for (var i = n.length; i--;) ut(o, n[i]);
    return o
}));
...
async function wt(t, e) {
    ...
    const {
        ...
        altBoundary: d = !1,
        padding: p = 0
    } = e, v = gt(p), h = a[d ? "floating" === f ? "reference" : "floating" : f], m = yt(await r.getClippingRect({
    ...
    return void 0 === t && (t = {}), {
        ...
        async fn(e) {
            ...
            const {
                ...
                flipAlignment: p = !0,
                ...v
            } = t, h = dt(o), m = [i, ...f || (h !== i && p ? function(t) {
                const e = Ct(t);
                return [$t(t), e, $t(e)]
            }(i) : [Ct(i)])], g = await wt(e, v), y = [];
            ...
            if (w = [...w, {
                ...
                switch (d) {
                    case "bestFit":
                        {
                            var R;
                            const t = null == (R = w.map((t => [t, t.overflows.filter((t => t > 0)).reduce(((t, e) => t + e), 0)])).sort(((t, e) => t[1] - e[1]))[0]) ? void 0 : R[0].placement;t && (n = t);
                            break
                        }
...
function Nt(t, e, n) {
    ...
    let s = 1,
        u = 1;
    e && St(t) && (s = t.offsetWidth > 0 && Mt(a.width) / t.offsetWidth || 1, u = t.offsetHeight > 0 && Mt(a.height) / t.offsetHeight || 1);
...
function Ft(t) {
    return (e = t, (e instanceof At(e).Node ? t.ownerDocument : t.document) || window.document).documentElement;
    var e
}
            ...
            if (t) {
                ...
                if ("contents" === Ot(t).display) {
                    const e = t.hasAttribute("style"),
                        o = t.style.display;
                    t.style.display = Ot(n).display, l = t.offsetParent, t.style.display = o, e || t.removeAttribute("style")
                }
                n = t, e !== l && (e = l, o = !0)
            } else if (It(n) && n.host && o) break;
...
function Yt(t) {
    const e = At(t);
    let n = Ut(t);
    for (; n && Wt(n) && "static" === Ot(n).position;) n = Ut(n);
...
function te(t, e, n) {
    return "viewport" === e ? yt(function(t, e) {
        ...
        if (l) {
            ...
            const t = _t();
            (t || !t && "fixed" === e) && (a = l.offsetLeft, s = l.offsetTop)
        }
        return {
            width: r,
            height: i,
...
const ne = {
    getClippingRect: function(t) {
        ...
        const r = [..."clippingAncestors" === n ? ee(e) : [].concat(n), o],
            ...
            a = r.reduce(((t, n) => {
                const o = te(e, n, l);
                return t.top = Ht(o.top, t.top), t.right = Dt(o.right, t.right), t.bottom = Dt(o.bottom, t.bottom), t.left = Ht(o.left, t.left), t
            }), te(e, i, l));
        return {
    ...
    convertOffsetParentRelativeRectToViewportRelativeRect: function(t) {
        ...
        if ((l || !l && "fixed" !== o) && (("body" !== Bt(n) || zt(r)) && (i = qt(n)), St(n))) {
            const t = Nt(n, !0);
...
const oe = (t, e, n) => (async (t, e, n) => {
        const {
            ...
            middleware: r = [],
            platform: i
        } = n, a = await (null == i.isRTL ? void 0 : i.isRTL(e));
        ...
        for (let v = 0; v < r.length; v++) {
            ...
            u = null != m ? m : u, c = null != g ? g : c, d = { ...d,
                [n]: { ...d[n],
                    ...y
                }
            }, w && p <= 50 && (p++, "object" == typeof w && (w.placement && (f = w.placement), w.rects && (s = !0 === w.rects ? await i.getElementRects({
                reference: t,
                floating: e,
                strategy: l
            }) : w.rects), ({
    ...
    re = (t, e, n, o, l) => {
        const r = x(null),
            i = () => {
                let e;
                return e = E(t.value) ? document.querySelector(t.value) : $(t.value) ? t.value() : t.value, e
            },
            a = () => {
                const t = i();
                if (!t || !e.value) return void(r.value = null);
                ! function(t) {
...
const ae = (t, e, n, o, l, r, i, a) => {
                ...
                const t = [(o = T(r), void 0 === o && (o = 0), {
                    ...
                    async fn(t) {
                        const {
                            x: e,
                            y: n
                        } = t, l = await async function(t, e) {
                            const {
                                placement: n,
                                platform: o,
                                elements: l
                            } = t, r = await (null == o.isRTL ? void 0 : o.isRTL(l.floating)), i = dt(n), a = pt(n), s = "x" === vt(n), u = ["left", "top"].includes(i) ? -1 : 1, c = r && s ? -1 : 1, f = "function" == typeof e ? e(t) : e;
                            let {
                                mainAxis: d,
                                crossAxis: p,
                                alignmentAxis: v
                    ...
                    async fn(t) {
                        const {
                            ...
                            x: n,
                            y: o
                        }, c = await wt(t, s), f = vt(dt(l)), d = "x" === f ? "y" : "x";
                        let p = u[f],
                            v = u[d];
                        if (r) {
        ...
        return b((() => {
            ...
            n && o && (g = function(t, e, n, o) {
                ...
                const {
                    ...
                    elementResize: i = !0,
                    animationFrame: a = !1
                } = o, s = l && !a, u = r && !a, c = s || u ? [...jt(t) ? Qt(t) : [], ...Qt(e)] : [];
                c.forEach((t => {
                ...
                if (i) {
                    ...
                    d = new ResizeObserver((() => {
                        o || n(), o = !1
                    })), jt(t) && !a && d.observe(t), d.observe(e)
                }
                let p = a ? Nt(t) : null;
                return a && function e() {
                    const o = Nt(t);
                    !p || o.x === p.x && o.y === p.y && o.width === p.width && o.height === p.height || n(), p = o, f = requestAnimationFrame(e)
                }(), n(), () => {
                    var t;
                    c.forEach((t => {
                        s && t.removeEventListener("scroll", n), u && t.removeEventListener("resize", n)
                    })), null == (t = d) || t.disconnect(), d = null, a && cancelAnimationFrame(f)
                }
            }(n, o, v)), A((() => {
                v()
            }))
    ...
    se = () => ({
        ...
        async fn(t) {
            const e = await wt(t);
            let n = 0;
            e.left > 0 && (n = e.left), e.right > 0 && (n = e.right);
            return {
                data: {
...
var pe = v(O({ ...de,
        ...
        setup(t, {
            ...
            const {
                contentStyle: s,
                arrowStyle: u
            } = ae(P(n, "reference"), i, a, o, l, P(n, "offset"), P(n, "zIndex"), P(n, "showArrow")), c = C((() => o.value.split("-")[0])), {
                ns: f
            } = B(ie), d = () => {
                e("close")
            }, p = t => {
            ...
            return (t, e) => (S(), j("div", {
                ...
                _: 3
            }, 8, ["focus-trap-el"]), t.showArrow ? (S(), j("span", {
                key: 0,
                ref_key: "arrowRef",
                ref: a,
                style: W(T(u)),
    ...
    ve = O({
        ...
        setup(t, {
            ...
            return () => {
                ...
                let s = 0;
                var u;
                return i.length && (u = nt(null == (r = i[0]) ? void 0 : r.children), L(u) && u.forEach((t => {
                    var e;
                    "ElTourStep" === (null == (e = (null == t ? void 0 : t.type) || {}) ? void 0 : e.name) && (a.push(t), s += 1)
                }))), o !== s && (o = s, n("update-total", s)), a.length ? a[t.current] : null
            }
        }
    });
const he = f({
    ...
    setup(t, {
        ...
        const n = t,
            ...
            })),
            {
                mergedPosInfo: L,
                triggerTarget: A
            } = re(c, P(n, "modelValue"), P(n, "gap"), v, w);
        R((() => n.modelValue), (t => {
            t || (i.value = 0)
        }));
        const O = () => {
                n.closeOnPressEscape && (e("update:modelValue", !1), e("close", i.value))
            },
            B = t => {
                l.value = t
            },
        ...
        return q(ie, {
            ...
            default: H((() => {
                ...
                }, null, 8, ["visible", "fill", "style", "pos", "z-index", "target-area-clickable"]), t.modelValue ? (S(), X(pe, {
                    key: T(i),
                    reference: T(A),
                    placement: T(d),
                    "show-arrow": T(y),
...
var be = v(O({ ...xe,
    ...
    setup(t, {
        ...
        const w = C((() => {
            ...
            b = t => {
                if (t) return ft(t, ["children", "onClick"])
            },
            k = () => {
                var t, e;
                i.value -= 1, (null == (t = n.prevButtonProps) ? void 0 : t.onClick) && (null == (e = n.prevButtonProps) || e.onClick()), y()
            },
            E = () => {
                var t;
                i.value >= a.value - 1 ? $() : i.value += 1, (null == (t = n.nextButtonProps) ? void 0 : t.onClick) && n.nextButtonProps.onClick(), y()
            },
            $ = () => {
                L(), m()
            },
        ...
        return (t, e) => (S(), j(J, null, [T(w) ? (S(), j("button", {
            key: 0,
            "aria-label": "Close",
        ...
        }, [T(p).indicators ? (S(), X(K(T(p).indicators), {
            key: 0,
            current: T(i),
            total: T(a)
        }, null, 8, ["current", "total"])) : (S(!0), j(J, {
            key: 1
        }, Y(T(a), ((t, e) => (S(), j("span", {
            key: t,
            ...
            _: 1
        }, 16, ["type"])) : _("v-if", !0), T(i) <= T(a) - 1 ? (S(), X(T(ot), V({
            key: 1,
            size: "small",
