import {h as e, F as t, ds as a, m as o, cW as n, W as l, be as s, R as i, y as r, B as u, M as p, I as d, cS as c, o as f, j as v, s as m, P as x, p as y, X as h, r as g, l as b, n as w, w as S, cE as C, bc as k, v as z, dj as E, dv as I, t as $, ck as j, dw as B} from "./index-N2rhOp93.js";
import {a as F, j as P, m as M, k as N, V} from "./index-jFhAlE56.js";
import {f as _, z as R, i as A, b as H, d as L, E as O, j as W, A as T, B as K, C as U, _ as X, w as Y} from "./index-DXzVhuRT.js";
import {i as Z, U as q, b as D, f as G, d as J, g as Q, j as ee, m as te} from "./index-B6QNixY4.js";
import {m as ae} from "./typescript-CRqm1_SZ.js";
...
function re(e, t=1, a) {
    ...
    const {paddingSize: n, borderSize: l, boxSizing: s, contextStyle: i} = function(e) {
    ...
    le.setAttribute("style", `${i};${se}`),
    le.value = e.value || e.placeholder || "";
    let r = le.scrollHeight;
    const u = {};
    "border-box" === s ? r += l : "content-box" === s && (r -= n),
    le.value = "";
    const p = le.scrollHeight - n;
    if (A(t)) {
        let e = p * t;
        "border-box" === s && (e = e + n + l),
        r = Math.max(e, r),
        u.minHeight = `${e}px`
    }
    if (A(a)) {
    ...
    return u.height = `${r}px`,
    null == (o = le.parentNode) || o.removeChild(le),
    le = void 0,
    u
}
const ue = H({
...
const ce = Y(X(o({
    ...
    setup(a, {expose: o, emit: F}) {
        const P = a
          ...
          , L = e(( () => {
            const e = {};
            return "combobox" === P.containerRole && (e["aria-haspopup"] = A["aria-haspopup"],
          ...
          , Z = ( (a={}) => {
            const {excludeListeners: o=!1, excludeKeys: n} = a
              , l = e(( () => ((null == n ? void 0 : n.value) || []).concat(oe)))
              , s = t();
            return e(s ? () => {
                var e;
          ...
          , {wrapperRef: ge, isFocused: be, handleFocus: we, handleBlur: Se} = ee(he, {
          ...
          , [_e,Re] = function(e) {
            ...
            return [function() {
                if (null == e.value)
                    return;
                const {selectionStart: a, selectionEnd: o, value: n} = e.value;
                if (null == a || null == o)
                    return;
            ...
            , function() {
                if (null == e.value || null == t)
                    return;
                const {value: a} = e.value
                  , {beforeTxt: o, afterTxt: n, selectionStart: l} = t;
                if (null == o || null == n || null == l)
                    return;
                let s = a.length;
                if (a.endsWith(n))
                    s = a.length - n.length;
        ...
        M(fe, (e => {
            if (He(),
            !Pe.value || "both" !== P.resize)
                return;
            const t = e[0]
              , {width: a} = t.contentRect;
            xe.value = {
        ...
        const Ae = () => {
          ...
          , He = (e => {
            ...
            return () => {
                ...
                if (t || !P.autosize)
                    return;
                null === (null == (a = fe.value) ? void 0 : a.offsetParent) || (e(),
                t = !0)
            }
        }
        )(Ae)
          ...
          , Oe = async e => {
            ...
            P.formatter && (t = P.parser ? P.parser(t) : t),
            Te.value || (t !== je.value ? (F(q, t),
            F("input", t),
            await p(),
            Le(),
            Re()) : Le())
          ...
          , {isComposing: Te, handleCompositionStart: Ke, handleCompositionUpdate: Ue, handleCompositionEnd: Xe} = te({
            emit: F,
            afterComposition: Oe
        })
          , Ye = () => {
        ...
        return u(( () => P.modelValue), ( () => {
            var e;
            p(( () => Ae())),
            P.validateEvent && (null == (e = null == le ? void 0 : le.validate) || e.call(le, "change").catch((e => N())))
        }
        )),
        u(je, ( () => Le())),
        u(( () => P.type), (async () => {
        ...
        v("div", k(h(L), {
            ...
            onMouseenter: De,
            onMouseleave: qe
        }), [m(" input "), "textarea" !== e.type ? (f(),
        v(x, {
            key: 0
        }, [m(" prepend slot "), e.$slots.prepend ? (f(),
        v("div", {
            key: 0,
            ...
            ref: ge,
            class: y(h(Y))
        }, [m(" prefix slot "), e.$slots.prefix || e.prefixIcon ? (f(),
        v("span", {
            key: 0,
            class: y(h(pe).e("prefix"))
        }, [b("span", {
            class: y(h(pe).e("prefix-inner"))
        }, [g(e.$slots, "prefix"), e.prefixIcon ? (f(),
        w(h(O), {
            key: 0,
            class: y(h(pe).e("icon"))
        }, {
            ...
            onChange: We,
            onKeydown: Ge
        }), null, 16, ["id", "minlength", "maxlength", "type", "disabled", "readonly", "autocomplete", "tabindex", "aria-label", "placeholder", "form", "autofocus", "onCompositionstart", "onCompositionupdate", "onCompositionend"]), m(" suffix slot "), h(Ve) ? (f(),
        v("span", {
            key: 1,
            class: y(h(pe).e("suffix"))
        }, [b("span", {
            class: y(h(pe).e("suffix-inner"))
        }, [h(Be) && h(Fe) && h(Pe) ? m("v-if", !0) : (f(),
        v(x, {
            key: 0
        }, [g(e.$slots, "suffix"), e.suffixIcon ? (f(),
        w(h(O), {
            key: 0,
            class: y(h(pe).e("icon"))
        }, {
        ...
        w(h(O), {
            ...
            default: S(( () => [z(h(W))])),
            _: 1
        }, 8, ["class", "onMousedown"])) : m("v-if", !0), h(Fe) ? (f(),
        w(h(O), {
            key: 2,
            ...
            w(C(h(Ee))))])),
            _: 1
        }, 8, ["class"])) : m("v-if", !0), h(Pe) ? (f(),
        v("span", {
            key: 3,
            class: y(h(pe).e("count"))
        }, [b("span", {
            class: y(h(pe).e("count-inner"))
        }, $(h(Me)) + " / " + $(e.maxlength), 3)], 2)) : m("v-if", !0), h(ke) && h(ze) && h(Ce) ? (f(),
        w(h(O), {
            key: 4,
            ...
            w(C(h(ze))))])),
            _: 1
        }, 8, ["class"])) : m("v-if", !0)], 2)], 2)) : m("v-if", !0)], 2), m(" append slot "), e.$slots.append ? (f(),
        v("div", {
            key: 1,
            class: y(h(pe).be("group", "append"))
        }, [g(e.$slots, "append")], 2)) : m("v-if", !0)], 64)) : (f(),
        v(x, {
            key: 1
            ...
            onChange: We,
            onKeydown: Ge
        }), null, 16, ["id", "minlength", "maxlength", "tabindex", "disabled", "readonly", "autocomplete", "aria-label", "placeholder", "form", "autofocus", "rows", "onCompositionstart", "onCompositionupdate", "onCompositionend", "onFocus", "onBlur"]), h(Pe) ? (f(),
        v("span", {
            key: 0,
            style: j(xe.value),
            class: y(h(pe).e("count"))
