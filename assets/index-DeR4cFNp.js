import {_ as t} from "./Subtitle-C6WMT3xu.js";
import {_ as e} from "./ButtonGR-CwZN5Zti.js";
import {_ as a} from "./Title-BBFGXJPy.js";
import {m as l, G as s, Y as o, cD as i, dg as n, o as c, j as r, l as p, v as d, w as m, t as f, q as u, X as b, P as g, cB as h, h as k, cC as v, n as y, s as _, p as w} from "./index-N2rhOp93.js";
import {_ as x} from "./_plugin-vue_export-helper-BCo6x5W8.js";
import {_ as O} from "./AppPop-BHeufWtp.js";
const P = {
  ...
  , Z = x(l({
    ...
    setup(l) {
        ...
        return (l, s) => {
            ...
            r(g, null, h(y.content.benefits, ( (t, e) => (c(),
            r("div", {
                key: e,
                class: "control"
            }, [s[4] || (s[4] = p("i", {
            ...
            }, null, -1)), p("span", A, f(t.label), 1)])))), 128))])])])])])), [[O]])
        }
    }
  ...
  , et = x(l({
    ...
    setup(e) {
        ...
        return (e, o) => {
            ...
            }, [d(i), a.cta && a.content.cta ? (c(),
            y(n, {
                key: 0,
                content: a.content.cta
            }, null, 8, ["content"])) : _("", !0), p("div", M, [p("div", G, [(c(!0),
            r(g, null, h(a.content.columns, ( (t, e) => (c(),
            r("div", {
                key: e,
            ...
            r("a", q, f(b(l)(t.label)), 1))])))), 128))])])])))), 128)), p("div", F, [p("div", R, [p("div", W, [(c(!0),
            r(g, null, h(a.content.socials, ( (t, e) => (c(),
            r("a", {
                href: t.link,
                key: e,
                target: "_blank",
            ...
            r(g, null, h(e.content.links, ( (t, e) => (c(),
            r("li", {
                key: e,
                class: "inline-block px-2"
            }, [d(x, {
...
export {et as _, S as a, D as b, at as f};
