import {m as e, h as o, o as s, j as n, p as a, y as l, cB as t, r as i, l as c, q as r, t as p, n as d, s as u, dh as v, dj as h, P as m} from "./index-jdACH0Rc.js";
  ...
  , g = e({
    ...
    setup(e) {
        ...
        return (e, l) => {
            const f = _;
            return s(!0),
            n(m, null, t(e.items, ( (l, t) => (s(),
            n("div", {
                key: t,
                class: a([[e.withChevron && "has-chevron", !e.withChevron && "has-plus"], "collapse"]),
                ...
                index: t,
                toggle: y
            }, ( () => [r(p(l.title), 1)]))]), c("div", w, [e.withChevron ? (s(),
            d(f, {
                key: 0,
