import {y as e, F as a, Q as l, h as n, be as u, bf as s, X as r, bg as o, L as v} from "./index-N2rhOp93.js";
import {u as t, l as i, S as d, e as c, k as m} from "./index-B6QNixY4.js";
import {u as f, d as p, z} from "./index-jFhAlE56.js";
const x = Symbol()
  , b = e();
...
const I = (e, l, u=!1) => {
    ...
    return m(x, f),
    m(i, n(( () => f.value.locale))),
    m(o, n(( () => f.value.namespace))),
    m(z, n(( () => f.value.zIndex))),
    m(d, {
        size: n(( () => f.value.size || ""))
    }),
    m(c, n(( () => ({
  ...
  , S = (e, a) => {
    const l = [...new Set([...m(e), ...m(a)])]
      , n = {};
    for (const u of l)
        n[u] = void 0 !== a[u] ? a[u] : e[u];
    return n
}
;
export {j as a, y as u};
