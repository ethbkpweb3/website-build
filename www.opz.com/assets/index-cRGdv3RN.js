...
const Ke = Ie(ke(l({ ...We,
        ...
        setup(e, {
            ...
            return (e, l) => e.disableTransitions ? (o(), s("span", {
                key: 0,
                class: r(u(S)),
                style: m({
            ...
            }, [i(e.$slots, "default")], 2), e.closable ? (o(), p(u(Ve), {
                key: 0,
                class: r(u(y).e("close")),
                onClick: v(C, ["stop"])
            }, {
                default: c((() => [d(u(we))])),
                _: 1
            }, 8, ["class", "onClick"])) : f("v-if", !0)], 6)) : (o(), p(b, {
                key: 1,
...
var je = ke(l({
        ...
        const l = t("select"),
            ...
            }),
            {
                ...
                return S((() => i.value), (() => {
                    ...
                    if (l !== a && (t.onOptionDestroy(a, p.proxy), t.onOptionCreate(p.proxy)), !e.created && !o) {
                        if (s && g(l) && g(a) && l[s] === a[s]) return;
                        t.setSelected()
                    }
                })), S((() => o.disabled), (() => {
    ...
    ["render", function(e, l, t, a, u, p) {
        ...
        }, [i(e.$slots, "default", {}, (() => [n("span", null, E(e.currentLabel), 1)]))], 42, ["id", "aria-disabled", "aria-selected", "onMouseenter", "onClick"])), [
            [T, e.visible]
        ])
    }],
    ["__file", "option.vue"]
...
var He = ke(l({
    ...
    ["render", function(e, l, t, a, n, u) {
        ...
        }, [e.$slots.header ? (o(), s("div", {
            key: 0,
            class: r(e.ns.be("dropdown", "header"))
        }, [i(e.$slots, "header")], 2)) : f("v-if", !0), i(e.$slots, "default"), e.$slots.footer ? (o(), s("div", {
            key: 1,
...
const Ae = (e, l) => {
    const {
        t: o
    } = ue(), s = x(), n = t("select"), i = t("input"), r = O({
        inputValue: "",
        options: new Map,
        ...
        isBeforeHide: !1
    }), u = R(null), p = R(null), c = R(null), d = R(null), v = R(null), f = R(null), m = R(null), b = R(null), h = R(null), C = R(null), w = R(null), V = R(null), {
        isComposing: I,
        ...
        valueOnClear: H,
        isEmptyValue: A
    } = fe(e), U = a((() => e.disabled || (null == P ? void 0 : P.disabled))), X = a((() => M(e.modelValue) ? e.modelValue.length > 0 : !A(e.modelValue))), Y = a((() => e.clearable && !U.value && r.inputHovering && X.value)), Z = a((() => e.remote && e.filterable && !e.remoteShowSuffix ? "" : e.suffixIcon)), ee = a((() => n.is("reverse", Z.value && W.value))), le = a((() => (null == N ? void 0 : N.validateState) || "")), te = a((() => Q[le.value])), ae = a((() => e.remote ? 300 : 0)), se = a((() => e.loading ? e.loadingText || o("el.select.loading") : !(e.remote && !r.inputValue && 0 === r.options.size) && (e.filterable && r.inputValue && r.options.size > 0 && 0 === Se.value ? e.noMatchText || o("el.select.noMatch") : 0 === r.options.size ? e.noDataText || o("el.select.noData") : null))), Se = a((() => Ce.value.filter((e => e.visible)).length)), Ce = a((() => {
    ...
    })), xe = a((() => Array.from(r.cachedOptions.values()))), Oe = a((() => {
    ...
    }, Ve = ne(), ke = a((() => ["small"].includes(Ve.value) ? "small" : "default")), Ie = a({
        get: () => W.value && !1 !== se.value,
        set(e) {
            W.value = e
        }
    }), Me = a((() => {
        if (e.multiple && !Te(e.modelValue)) return 0 === ie(e.modelValue).length && !r.inputValue;
    ...
    S((() => e.modelValue), ((l, t) => {
        e.multiple && e.filterable && !e.reserveKeyword && (r.inputValue = "", De("")), _e(), !me(l, t) && e.validateEvent && (null == N || N.validate("change").catch((e => q())))
    }), {
        flush: "post",
        deep: !0
    }), S((() => W.value), (e => {
        e ? De(r.inputValue) : (r.inputValue = "", r.previousQuery = null, r.isBeforeHide = !0), l("visible-change", e)
    })), S((() => r.options.entries()), (() => {
        var l;
        if (!Re) return;
        const t = (null == (l = u.value) ? void 0 : l.querySelectorAll("input")) || [];
        (e.filterable || e.defaultFirstOption || Te(e.modelValue)) && Array.from(t).includes(document.activeElement) || _e(), e.defaultFirstOption && (e.filterable || e.remote) && Se.value && ze()
    }), {
        flush: "post"
    }), S((() => r.hoveringIndex), (e => {
        Be(e) && e > -1 ? K.value = Ce.value[e] || {} : K.value = {}, Ce.value.forEach((e => {
            e.hover = K.value === e
        }))
    })), L((() => {
        r.isBeforeHide || we()
    ...
    const De = l => {
            r.previousQuery === l || I.value || (r.previousQuery = l, e.filterable && $(e.filterMethod) ? e.filterMethod(l) : e.filterable && e.remote && $(e.remoteMethod) && e.remoteMethod(l), e.defaultFirstOption && (e.filterable || e.remote) && Se.value ? k(ze) : k(We))
        },
        ze = () => {
        ...
        _e = () => {
            if (!e.multiple) {
                const l = M(e.modelValue) ? e.modelValue[0] : e.modelValue,
                    t = Fe(l);
                return r.selectedLabel = t.currentLabel, void(r.selected = [t])
            }
            r.selectedLabel = "";
            const l = [];
        ...
        je = () => {
            r.inputValue.length > 0 && !W.value && (W.value = !0), De(r.inputValue)
        },
        He = l => {
            if (r.inputValue = l.target.value, !e.remote) return je();
            Ae()
        },
        Ae = be((() => {
            je()
        ...
        Qe = t => {
            ...
            if (e.multiple)
                for (const e of r.selected) e.isDisabled && a.push(e.value);
            l(he, a), Ue(a), r.hoveringIndex = -1, W.value = !1, l("clear"), Ze()
        },
        qe = t => {
            var a;
            if (e.multiple) {
                const o = ie(null != (a = e.modelValue) ? a : []).slice(),
                    s = Je(o, t.value);
                s > -1 ? o.splice(s, 1) : (e.multipleLimit <= 0 || o.length < e.multipleLimit) && o.push(t.value), l(he, o), Ue(o), t.created && De(""), e.filterable && !e.reserveKeyword && (r.inputValue = "")
            } else l(he, t.value), Ue(t.value), W.value = !1;
            Ze(), W.value || k((() => {
                Xe(t)
            }))
        },
        Je = (l = [], t) => {
            if (!g(t)) return l.indexOf(t);
            const a = e.valueKey;
            let o = -1;
            return l.some(((e, l) => y(re(e, a)) === re(t, a) && (o = l, !0))), o
        },
        Xe = e => {
            var l, t, a, o, s;
            const i = M(e) ? e[0] : e;
        ...
        ll = () => {
            U.value || (Ee && (r.inputHovering = !0), r.menuVisibleOnFocus ? r.menuVisibleOnFocus = !1 : W.value = !W.value)
        },
        ...
        nl = e => {
            if (W.value) {
                if (0 !== r.options.size && 0 !== r.filteredOptionsCount && !I.value && !al.value) {
                    "next" === e ? (r.hoveringIndex++, r.hoveringIndex === r.options.size && (r.hoveringIndex = 0)) : "prev" === e && (r.hoveringIndex--, r.hoveringIndex < 0 && (r.hoveringIndex = r.options.size - 1));
                    const l = Ce.value[r.hoveringIndex];
                    !0 !== l.disabled && !0 !== l.states.groupDisabled && l.visible || nl(e), k((() => Xe(K.value)))
                }
            } else W.value = !0
        },
        il = a((() => {
    ...
    return G(p, (() => {
    ...
    })), G(f, Ke), G(h, Pe), G(_, Pe), G(C, Ne), G(w, (() => {
        ...
        deletePrevTag: t => {
            if (e.multiple && t.code !== J.delete && t.target.value.length <= 0) {
                ...
                if (a < 0) return;
                const o = t[a];
                t.splice(a, 1), l(he, t), Ue(t), l("remove-tag", o)
            }
        },
        deleteTag: (t, a) => {
            ...
            if (o > -1 && !U.value) {
                const t = ie(e.modelValue).slice();
                t.splice(o, 1), l(he, t), Ue(t), l("remove-tag", a.value)
            }
        ...
        handleCompositionEnd: z,
        onOptionCreate: e => {
            r.options.set(e.value, e), r.cachedOptions.set(e.value, e), e.disabled && r.disabledOptions.set(e.value, e)
        },
        onOptionDestroy: (e, l) => {
            r.options.get(e) === l && r.options.delete(e)
        },
        handleMenuEnter: () => {
            r.isBeforeHide = !1, k((() => Xe(r.selected)))
        },
        focus: Ze,
        blur: el,
        handleClearClick: e => {
...
var Ue = l({
    ...
    setup(e, {
        ...
        return () => {
            ...
            }(null == (o = s[0]) ? void 0 : o.children), me(n, a) || (a = n, t && (t.states.optionValues = n)), s
        }
    }
});
const Ge = Oe({
        ...
        return I((o(), s("div", {
            ...
            default: c((() => {
                ...
                return [n("div", {
                    ...
                    key: 0
                }, (() => [(o(!0), s(K, null, P(e.showTagList, (l => (o(), s("div", {
                    key: e.getValueKey(l),
                    ...
                    _: 2
                }, 1032, ["closable", "size", "type", "effect", "style", "onClose"])], 2)))), 128)), e.collapseTags && e.states.selected.length > e.maxCollapseTags ? (o(), p(g, {
                    key: 0,
                    ref: "tagTooltipRef",
                    ...
                    }, [(o(!0), s(K, null, P(e.collapseTagList, (l => (o(), s("div", {
                        key: e.getValueKey(l),
                        class: r(e.nsSelect.e("selected-item"))
                    }, [d(h, {
                        class: "in-tooltip",
                    ...
                    _: 3
                }, 8, ["disabled", "effect", "teleported"])) : f("v-if", !0)])) : f("v-if", !0), e.selectDisabled ? f("v-if", !0) : (o(), s("div", {
                    key: 1,
                    ...
                    [H, e.states.inputValue]
                ]), e.filterable ? (o(), s("span", {
                    key: 0,
                    ref: "calculatorRef",
                    "aria-hidden": "true",
                    class: r(e.nsSelect.e("input-calculator")),
                    textContent: E(e.states.inputValue)
                }, null, 10, ["textContent"])) : f("v-if", !0)], 2)), e.shouldShowPlaceholder ? (o(), s("div", {
                    key: 2,
                    ...
                    value: e.modelValue
                }, (() => [n("span", null, E(e.currentPlaceholder), 1)])) : (o(), s("span", {
                    key: 1
                }, E(e.currentPlaceholder), 1))], 2)) : f("v-if", !0)], 2), n("div", {
                    ref: "suffixRef",
                    class: r(e.nsSelect.e("suffix"))
                }, [e.iconComponent && !e.showClose ? (o(), p(y, {
                    key: 0,
                    class: r([e.nsSelect.e("caret"), e.nsSelect.e("icon"), e.iconReverse])
                }, {
                    default: c((() => [(o(), p(A(e.iconComponent)))])),
                    _: 1
                }, 8, ["class"])) : f("v-if", !0), e.showClose && e.clearIcon ? (o(), p(y, {
                    key: 1,
                    class: r([e.nsSelect.e("caret"), e.nsSelect.e("icon"), e.nsSelect.e("clear")]),
                    onClick: e.handleClearClick
                }, {
                    default: c((() => [(o(), p(A(e.clearIcon)))])),
                    _: 1
                }, 8, ["class", "onClick"])) : f("v-if", !0), e.validateState && e.validateIcon ? (o(), p(y, {
                    key: 2,
                    class: r([e.nsInput.e("icon"), e.nsInput.e("validateIcon")])
                }, {
                    default: c((() => [(o(), p(A(e.validateIcon)))])),
                    _: 1
            ...
            content: c((() => [d(O, {
                ...
                default: c((() => [e.$slots.header ? (o(), s("div", {
                    key: 0,
                    ...
                    default: c((() => [e.showNewOption ? (o(), p(S, {
                        key: 0,
                ...
                ]), e.$slots.loading && e.loading ? (o(), s("div", {
                    key: 1,
                    class: r(e.nsSelect.be("dropdown", "loading"))
                }, [i(e.$slots, "loading")], 2)) : e.loading || 0 === e.filteredOptionsCount ? (o(), s("div", {
                    key: 2,
                    class: r(e.nsSelect.be("dropdown", "empty"))
                }, [i(e.$slots, "empty", {}, (() => [n("span", null, E(e.emptyText), 1)]))], 2)) : f("v-if", !0), e.$slots.footer ? (o(), s("div", {
                    key: 3,
            ...
            _: 3
        }, 8, ["visible", "placement", "teleported", "popper-class", "popper-options", "fallback-placements", "effect", "transition", "persistent", "append-to", "onBeforeShow", "onHide"])], 16, ["onMouseleave"])), [
...
De(Je);
export {
    Xe as E, Ye as a, Ke as b, ze as c
};